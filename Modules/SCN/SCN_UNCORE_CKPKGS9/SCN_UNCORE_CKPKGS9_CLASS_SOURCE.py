...
LOCAL_PARAM_VMINTC_VoltageTargets = "CCF1,CCF"
LOCAL_PARAM_NOM_LevelsTc = ""
LOCAL_PARAM_MIN_LevelsTc = "SCN_UNCORE_CKPKGS9::cpu_all_bf_x_x_pkg_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_max"
LOCAL_PARAM_MAX_LevelsTc = ""
LOCAL_PARAM_POR_TimingsTc = "IPC::SCN_UNCORE_CXPKGS9::cpu_fun_timing_mts800_tstprtclk400_tck100_OVERRIDE_PKG"
...
MODULE = "SCN_UNCORE_CKPKGS9"  # You can change this as needed
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_stuckat_occ = \
        VminTC(name=f"STUCKAT_UNCORE_SB_K_{flow}_X_X_MAX_X_ALL",
               Patlist = 'IPC::scn_cdie_begin_atpg_edt_classhvm_all_list',
               TimingsTc = Spec(f'SCN_UNCORE_CKPKGS9_Specs.timingRules'),
               LevelsTc = 'SCN_UNCORE_CKPKGS9::cpu_all_bf_x_x_pkg_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_max',
               StartVoltages = '0.9',
...
def get_occ_mtt_kill_test_atspeed_raw(
    ...
    NativeMultiTrial(name = f"ATSPEED_UNCORE_VMIN_K_{flow.upper()}_X_{VOLTAGE_DOMAIN.upper()}_{corner.upper()}_ALLCORE_MTT_RAW",
                ...
                LevelsTc = 'SCN_UNCORE_CKPKGS9::cpu_all_bf_x_x_pkg_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_max',
                TimingsTc = 'IPC::SCN_UNCORE_CXPKGS9::cpu_fun_timing_mts800_tstprtclk400_tck100_OVERRIDE_PKG',
                PreInstance = '',
                PostInstance = '',
                LogLevel = '',
                VminResult = '',
...
def get_shmoo_test_stuckat(flow, corner, testinput):
    ...
    return DDGShmooTC(name = f"STUCKAT_UNCORE_SHMOO_E_{flow}_X_X_NOM_X",
                Patlist = 'IPC::scn_cdie_begin_atpg_edt_classhvm_list',
                TimingsTc = Spec(f'SCN_UNCORE_CKPKGS9_Specs.timingRules'),
                LevelsTc = 'SCN_UNCORE_CKPKGS9::cpu_all_bf_x_x_pkg_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_max', 
                SetPointsPlistParamName = "Patlist",
                SetPointsPlistMode = "Local",
...
BEGINCPUPKG_VMINTC_STUCKAT_OCC_TLI = {"Bypassport": -1, "Testmode": "Scoreboard", "ISEDC": False}
...
BEGINCPUPKG_OCC = Flow("BEGINCPUPKG_SCN_UNCORE", BEGINCPUPKG_VMINTC_STUCKAT_OCC,BEGINCPUPKG_VMINTC_ATSPEED_OCC, BEGINCPUPKG_VMINTC_CHAIN_OCC )
...
BEGINCPUPKG_SUBFLOW = Flow(f'{MODULE}_BEGINCPUPKG',
                                        ...
                                        Fitem("SAME", BEGINCPUPKG_PATCONFIG[0], r0=pFail(ret=0), r1=pPass(ret=1)),
