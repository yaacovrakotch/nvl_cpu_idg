...
from pymtpl.por_methods import VminTC,DDGShmooTC, PrimeHvqkTestMethod, MbistVminTC, AuxiliaryTC, ScreenTC,PrimeVirtualFuseExportToSharedStorageTestMethod,PrimePatConfigTestMethod,PrimeSampleRateTestMethod,MbistRasterRepairTC,PrimeScanHRYSSNTestMethod,PrimeScanSPOFITestMethod,PrimeShmooTestMethod, RunCallback, ApexTC
from pymtpl.core import Flow, Fitem, pPass, pFail, Initialize, NativeMultiTrial, AUTO, MTLdefault, InitializeNVLClass, Import, TrialParamSpec, Spec, MConfig, NVLClass8dig
...
MODULE = "SCN_UNCORE_CX48"  # You can change this as needed
VOLTAGE_DOMAIN = "CCF"
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_stuckat_occ = \
        VminTC(name=f"STUCKAT_UNCORE_SB_K_{flow}_X_X_NOM_X_ALL",
               Patlist = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("scn_cdie_begin_full_atpg_all_edt_classhvm_list","scn_cdie_begin_atpg_edt_classhvm_all_list","scn_cdie_begin_full_atpg_all_edt_classhvm_list","scn_cdie_begin_atpg_edt_classhvm_all_list")'),
               TimingsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDEDS","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE")'),
               LevelsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom")'),
               StartVoltages = '0.9',
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_stuckat_occ = \
        VminTC(name=f"STUCKAT_UNCORE_SB_K_{flow}_X_X_NOM_X_REC",
               ...
               _fitem=Fitem('SAME',
               edc=testinput.get("ISEDC"),
               r0=pFail(setbin = -42, goto="CHAIN_UNCORE_SB_K_BEGINCPU_X_X_NOM_X_ALL"),
               r1=pPass(goto="ATSPEED_UNCORE_SB_K_BEGINCPU_X_X_NOM_X_ALL"),
               r2=pFail(setbin = -42, goto="CHAIN_UNCORE_SB_K_BEGINCPU_X_X_NOM_X_ALL"),
               r3=pPass(goto="ATSPEED_UNCORE_SB_K_BEGINCPU_X_X_NOM_X_ALL"),
               r4=pFail(setbin = -42, goto="CHAIN_UNCORE_SB_K_BEGINCPU_X_X_NOM_X_ALL"),
               r5=pFail(setbin = -42, goto="CHAIN_UNCORE_SB_K_BEGINCPU_X_X_NOM_X_ALL")))
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_stuckat_vmax_occ = \
        VminTC(name=f"STUCKAT_UNCORE_SB_K_{flow}_X_{VOLTAGE_DOMAIN.upper()}_MAX_X_ALL",
               Patlist = f"scn_cdie_{flow.lower()}_full_atpg_all_edt_classhvm_list",
               TimingsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDEDS","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE")'),
               LevelsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom")'),
...
def get_test_list_atspeed_vmax_occ_mtt (
    ...
    NativeMultiTrial(name = f"ATSPEED_UNCORE_SB_K_{flow.upper()}_X_{VOLTAGE_DOMAIN.upper()}_MAX_{frequency_value}_F5_F7",
               ...
               exitaction = "Continue",
                ...
                template = VminTC(name = f'"ATSPEED_UNCORE_SB_K_{flow.upper()}_X_{VOLTAGE_DOMAIN.upper()}_MAX" + ' + Spec(f"__shared__::Corners.CCF_{corner_id}") + '+ "_" +' + Spec(f"__shared__::FreqInMHZ.CCF_{corner_id}")  ,
                Patlist = f"scn_cdie_{flow.lower()}_trans_edt_classhvm_list",
                LevelsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom")'),
                TimingsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDEDS","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE")'),
                PreInstance = '',
                PostInstance = '',
               ...
               # DtsConfiguration = Spec(f'SCN_UNCORE_CX48_Specs.CCF_VMINTC_DtsConfiguration_{corner.upper()}'),
                EndVoltageLimits = Spec(f"__shared__::FlowMatrixSingular.CCF_VMAX_VALUE"),
                ExecutionMode = "SearchWithScoreboard",
                LogLevel = 'Disabled',
                SetPointsPlistMode = "Local",
               ...
               # StartVoltagesForRetry= "",
                ...
                VoltageConverter =Spec(f'"--dlvrpins VCCIA --railconfigurations CDIE_CCF_NBLCTRL --expressions "' + f' + DROPOUT.CLR_F5'),
                #VoltagesOffset = 'GBVars.VoltageOffset',
                VoltageTargets = testinput.get("Voltagetarget", "CCF"),
                BypassPort = testinput.get("Bypassport", -1),
                DtsConfiguration = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("ALL_CDIE_C48_N2P_NONE_CORE","ALL_CDIE_S52C","ALL_CDIE_C48_N2P_NONE_CORE","ALL_CDIE_C48_N2P_NONE_CORE")'),
                ...
                r4 = pFail(setbin= -47, ret= 4, trialaction = "Exit"),
    ...
    sample_test_atspeed_occ = \
        VminTC(name=f"ATSPEED_UNCORE_SB_K_{flow}_X_X_NOM_X_ALL",
              ...
              # FailCaptureCount = 999,
               ...
               _fitem=Fitem('SAME',
               edc=testinput.get("ISEDC"),
               r0=pFail(setbin = -47, goto="CHAIN_UNCORE_SB_K_BEGINCPU_X_X_NOM_X_ALL"),
               r1=pPass(ret=1),
               r2=pFail(setbin = -47, goto="CHAIN_UNCORE_SB_K_BEGINCPU_X_X_NOM_X_ALL"),
               r3=pPass(ret=1),
               r4=pFail(setbin = -47, goto="CHAIN_UNCORE_SB_K_BEGINCPU_X_X_NOM_X_ALL"),
               r5=pFail(setbin = -47, goto="CHAIN_UNCORE_SB_K_BEGINCPU_X_X_NOM_X_ALL")))
...
def get_test_list_atspeed_occ_f1f4_mtt (
    ...
    NativeMultiTrial(name = f"ATSPEED_UNCORE_VMIN_K_{flow.upper()}_X_X_{corner.upper()}_{frequency_value}",
                ...
                DtsConfiguration = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("ALL_CDIE_C48_N2P_NONE_CORE","ALL_CDIE_S52C","ALL_CDIE_C48_N2P_NONE_CORE","ALL_CDIE_C48_N2P_NONE_CORE")'),
                #DtsConfiguration = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("ALL_CDIE_C48_N2P_NONE_CORE","ALL_CDIE_S52C","ALL_CDIE_C48_N2P_NONE_CORE","ALL_CDIE_C48_N2P_NONE_CORE")') if "F4XCCF" in flow else '',
               ...
               #StartVoltagesForRetry = "",
                StepSize = Spec(f'toDouble(__shared__::FlowMatrixSingular.CR_SEARCH_RESOLUTION)'),
                VoltageConverter = Spec(f'"--dlvrpins VCCIA --railconfigurations CDIE_CCF_NBLCTRL --expressions "' + f' + DROPOUT.CLR_{corner}'),
               # VoltagesOffset = 'GBVars.VoltageOffset',
                VoltageTargets = testinput.get("Voltagetarget", "CCF"),
                BypassPort = testinput.get("Bypassport", -1),
                ), # The close bracket here indicates that we are done defining VminTC params
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_stuckat = \
        VminTC(name=f"STUCKAT_UNCORE{dcm}_SB_K_{flow}_X_{VOLTAGE_DOMAIN.upper()}_NOM_{corner}",
               Patlist = "scn_cdie_begin_full_atpg_all_edt_classhvm_list", 
               TimingsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDEDS","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE")'), 
               LevelsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom")'),
               ExecutionMode = 'SearchWithScoreboard',
               FailCaptureCount = Spec("toInteger(999)"),
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_atspeed_fmin_failflow = \
        VminTC(name=f"ATSPEED_UNCORE_SB_K_{flow}_X_{VOLTAGE_DOMAIN.upper()}_NOM_X_{corner}_FF_SEARCH",
               Patlist = f"scn_cdie_{corner.lower()}xccf_trans_edt_classhvm_list",
               TimingsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDEDS","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE")'),
               LevelsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom")'),
               #StartVoltages = '0.9',
...
def get_test_list_atspeed_fmin_mtt(
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_atspeed_fmin_mtt = \
        VminTC(name=f"ATSPEED_UNCORE_VMIN_K_{flow.upper()}_X_{VOLTAGE_DOMAIN.upper()}_{corner.upper()}_0400_MTT",
               Patlist = f"scn_cdie_{corner.lower()}xccf_trans_edt_classhvm_list",
               TimingsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDEDS","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE")'),
               LevelsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom")'),
               #StartVoltages = '0.9',
...
def get_test_list_atspeed_fmin_edc_mtt(
    flow, 
    corner, 
    testinput,
    FlowMatrix,
    ...
    recoverytestflag=False
      ...
      # decode MTT test name
    test_listt_atspeed_fmin_edc_mtt = []
    
    # Get the frequency value from FlowMatrixRule
    frequency_value = FlowMatrixRule[f"{FlowMatrix}_MHz"]
    
    sample_test_atspeed_fmin_edc_mtt = \
    NativeMultiTrial(name = f"ATSPEED_UNCORE_VMIN_E_{flow.upper()}_X_{VOLTAGE_DOMAIN.upper()}_{corner.upper()}_{frequency_value}_MTT",
                # ATSPEED_CORE{dcm}_VMIN_K_F1XCR_X_VCCIA_F1_1200_ALLCORE_MTT - this naming convention passed QG_239 (Q-Gate checker)
                # name = f"ATSPEED_CORE_VMIN_K_{flow.upper()}_X_{VOLTAGE_DOMAIN.upper()}_{corner.upper()}_{FlowMatrix}_ALLCORE_MTT", this triggers QG_239 error during PR, so we have to sorta manually code in the freq value
                # ATSPEED_CORE_VMIN_K_F1XCR_X_VCCIA_F1_CR_F1_FREQ_ALLCORE_MTT - expected the freq would be autopopulated by flowmatrix but that's not happening yet in ww20.1 
                ...
                _comment = f"KILL ATSPEED {flow.upper()}",
                trialvar = "CPU_TRIALS::FlowDomain.RING",
                template = VminTC(name = f'"ATSPEED_UNCORE_VMIN_E_{flow.upper()}_X_{VOLTAGE_DOMAIN.upper()}_{corner.upper()}_" + ' + Spec(f"__shared__::CustomFlowMatrixSpecs.{FlowMatrix}_MHz") ,
                Patlist = f"scn_cdie_{corner.lower()}xccf_trans_edt_classhvm_list",
                LevelsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom")'),
                TimingsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDEDS","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE")'),
                PreInstance = '',
    ...
    test_listt_atspeed_fmin_edc_mtt.append(sample_test_atspeed_fmin_edc_mtt)

    return test_listt_atspeed_fmin_edc_mtt    
    ...
    sample_test_atspeed_f5f6_apexmtt = ApexTC(
        ...
        #template=ApexTC(
           # name=f'"ATSPEED_VMIN_K_{flow.upper()}_X_{VOLTAGE_DOMAIN.upper()}_{corner.upper()}_" + ' + Spec(f"__shared__::Corners.CCF_C5") + f' + "_APEX_MTT"',
            Patlist=f"scn_cdie_{flow.lower()}_trans_edt_classhvm_list_apex",
            LevelsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom")'),
            TimingsTc=Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE")'),
            InitialMaskBits='',
            ForwardingMode= "None",
            PinMap='',
            RecoveryOptions= '',
            ...
            SetPointsPreInstance =  Spec(f'PSPRE.CLR_F5+' f'","+' f'"MCdrv:ringfreq_0:"' +Spec(f"+__shared__::FlowMatrixSingular.CCF_F5_FREQ+")+'"GHz," 'f'+' f'"CCF:nblctrl_ccf:ccfnbloff"'),
            SetPointsPostInstance= Spec(f'PSPOST.CLR_F5+' f'","+' f'"CCF:nblctrl_ccf:ccfnblon"'),
            FivrCondition= "NOM_CCF",
            ...
            Targets='SCCF',
            DtsConfiguration = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("ALL_CDIE_C48_N2P_NONE_CORE","ALL_CDIE_S52C","ALL_CDIE_C48_N2P_NONE_CORE","ALL_CDIE_C48_N2P_NONE_CORE")'),
			BypassPort = Spec('__shared__::TpRule.If_C48_DS_AX_M(1, 1, 1, 1)'),
        #),
...
def get_test_list_stuckat_shmoo(
    ...
    sample_test_stuckat_shmoo = DDGShmooTC(name = f"STUCKAT_UNCORE_SHMOO_E_{flow}_X_X_NOM_X",
                ...
                XAxisParam =Spec(f'__shared__::TpRule.If_C48_DS_AX_M("all_mts","all_mts","all_mts","all_mts")'),
...
def get_test_list_atspeed_fmin_shmoodata(
    ...
    sample_test_atspeed_fmin_shmoo = DDGShmooTC(name = f"ATSPEED_UNCORE_SHMOO_E_{subflow}_X_X_NOM_X_{corner.upper()}_SHMOODATA",
                _comment=["NOCLEAN", "PATLIST_NOCLEAN : Due to needing this plist for PO shmoo", "TCG_NOCLEAN : Due to needing it"],
                Patlist = f"scn_cdie_fminxccf_trans_edt_classhvm_list",
                LevelsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom")'),
                TimingsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDEDS","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE")'),
                SetPointsPlistParamName = "Patlist",
                SetPointsPlistMode = "Local",
...
def get_test_list_chain_shmoodata_margincheck_drv(
    flow, 
    corner, 
    testtype, 
    testinput 
    ...
    # Create an empty list that will contain the final list of the test
    test_listt_chain_shmoo_margincheck_drv = []
    sample_test_chain_shmoo_margincheck_drv = PrimeShmooTestMethod(name = f"CHAIN_UNCORE_SHMOO_E_{flow}_X_CR_NOM_X_{corner}_{testtype}_SHMOODATA",
                Patlist = f'scn_cdie_begin_chain_edt_classhvm_all_list',
                LevelsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","MIO_HPTP_CXPKGS9::hptp_timing_cal_nom_lvl","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","MIO_HPTP_CXPKGHX::hptp_timing_cal_nom_lvl")'),
                TimingsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDEDS","MIO_HPTP_CXPKGS9::cpu_fun_timing_mts1500_tstprtclk750_tck93p75","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","MIO_HPTP_CXPKGHX::cpu_fun_timing_hptp_scn_tuned_mts1500_tstprtclk750_tck93p75")'),
                ...
                XAxisParam =Spec(f'__shared__::TpRule.If_C48_DS_AX_M("cpu_tstprt_i_drv_mul","p_cpu_tstprt_i_drv_mul","cpu_tstprt_i_drv_mul","p_cpu_tstprt_i_drv_mul")'),
    ...
    test_listt_chain_shmoo_margincheck_drv.append(sample_test_chain_shmoo_margincheck_drv)
    
    return test_listt_chain_shmoo_margincheck_drv

def get_test_list_chain_shmoodata_margincheck_stb(
    flow, 
    corner, 
    testtype, 
    testinput 
    ...
    # Create an empty list that will contain the final list of the test
    test_listt_chain_shmoo_margincheck_stb = []
    sample_test_chain_shmoo_margincheck_stb = PrimeShmooTestMethod(name = f"CHAIN_UNCORE_SHMOO_E_{flow}_X_CR_NOM_X_{corner}_{testtype}_SHMOODATA",
                Patlist = f'scn_cdie_begin_chain_edt_classhvm_all_list',
                LevelsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","MIO_HPTP_CXPKGS9::hptp_timing_cal_nom_lvl","SCN_UNCORE_CX48::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","MIO_HPTP_CXPKGHX::hptp_timing_cal_nom_lvl")'),
                TimingsTc = Spec(f'__shared__::TpRule.If_C48_DS_AX_M("SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDEDS","MIO_HPTP_CXPKGS9::cpu_fun_timing_mts1500_tstprtclk750_tck93p75","SCN_UNCORE_CX48::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","MIO_HPTP_CXPKGHX::cpu_fun_timing_hptp_scn_tuned_mts1500_tstprtclk750_tck93p75")'),
                #ApplyEndSequence = 'DISABLED',
                ...
                #XAxisType = "SpecSetVariable",
                XAxisDatalogPrefix = 'Base',
                XAxisParam =Spec(f'__shared__::TpRule.If_C48_DS_AX_M("cpu_tstprt_o_stb_mul","p_cpu_tstprt_o_stb_mul","cpu_tstprt_o_stb_mul","p_cpu_tstprt_o_stb_mul")'),
                XAxisParamType = 'TimingTestCondition',
                XAxisRange = testinput.get("xaxisrange", ""),
                #YAxisType = 'FIVR',
                #YAxisDatalogPrefix = 'Base',
    ...
    test_listt_chain_shmoo_margincheck_stb.append(sample_test_chain_shmoo_margincheck_stb)
    
    return test_listt_chain_shmoo_margincheck_stb
...
begincpu_vmintc_stuckat_occ_rec_tli = {"Bypassport": -1, "Testmode": "Scoreboard", "ISEDC": False}
begincpu_vmintc_stuckat_occ = get_test_list_stuckat_occ(begincpu_flow, begincpu_corner, begincpu_vmintc_stuckat_occ_tli)
begincpu_vmintc_stuckat_occ_rec = get_test_list_stuckat_occ_rec(begincpu_flow, begincpu_corner, begincpu_vmintc_stuckat_occ_rec_tli)
...
#begincpu_occ = Flow("BEGINCPU_UNCORE", begincpu_vmintc_stuckat_occ,begincpu_vmintc_atspeed_occ,begincpu_vmintc_chain_occ)
...
#begincpu_occ = Flow("BEGINCPU_UNCORE", begincpu_vmintc_stuckat_occ,begincpu_shmoo_chain,begincpu_vmintc_atspeed_occ,begincpu_vmintc_chain_occ)
...
begin_cpushmoo_drv_tli = {"Bypassport": -1, "ISEDC": True, "xaxisrange": "0:0.1:21"}
begincpu_shmoo_drv_margin = get_test_list_chain_shmoodata_margincheck_drv(begincpu_flow, begincpu_corner, begin_cpu_testype, begin_cpushmoo_drv_tli)

begin_cpu_testype = "MARGIN_CHECK_1P5_STB"
begin_cpushmoo_stb_tli = {"Bypassport": -1, "ISEDC": True, "xaxisrange": "0:0.1:21"}
begincpu_shmoo_stb_margin = get_test_list_chain_shmoodata_margincheck_stb(begincpu_flow, begincpu_corner, begin_cpu_testype, begin_cpushmoo_stb_tli)
#SPOFI
...
begincpu_occ = Flow("BEGINCPU_UNCORE", begincpu_vmintc_stuckat_occ,begincpu_vmintc_atspeed_occ,begincpu_vmintc_stuckat_occ_rec,begincpu_vmintc_chain_occ)
...
subflow = "BEGINCPU"
f1xccf_corner = "F1"
SHMOO_F1_ATSPEED_TLI = {"Bypassport": -1, "ISEDC": True}
atspeed_shmoo_f1 = [
   get_test_list_atspeed_shmoodata(f1xccf_flow,subflow, f1xccf_corner,SHMOO_F1_ATSPEED_TLI)
...
def create_subflow(flow_name, corner, module_name, flow_matrix):
    ...
    # OCC COMPOSITE TEST LIST
    vmintc_atspeed_edc_occ_tli = {"Bypassport": -1, "Testmode": "SingleVmin", "ISEDC": True}
    vmintc_atspeed_edc_occ = get_test_list_atspeed_fmin_edc_mtt(flow_name, corner, vmintc_atspeed_edc_occ_tli, flow_matrix, corner_id)
    vmintc_atspeed_occ_tli = {"Bypassport": -1, "Testmode": "SingleVmin", "ISEDC": False}
    vmintc_atspeed_occ = get_test_list_atspeed_fmin_mtt(flow_name, corner, vmintc_atspeed_occ_tli)
    vmintc_atspeed_failflow_tli = {"Bypassport": -1, "Testmode": "SingleVmin", "ISEDC": True}
    vmintc_atspeed_failflow = get_test_list_atspeed_fmin_failflow(flow_name, corner, vmintc_atspeed_failflow_tli)
    occ = Flow(f"{flow_name}", vmintc_atspeed_edc_occ,vmintc_atspeed_occ,vmintc_atspeed_failflow)
...
vmaxxccf_vmintc_stuckat_occ_tli = {"Bypassport": -1, "Testmode": "Scoreboard", "ISEDC": False}
...
vmaxxccf_vmintc_atspeed_occ_tli = {"Bypassport": -1, "Testmode": "SingleVmin", "ISEDC": False}
