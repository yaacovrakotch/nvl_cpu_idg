...
MODULE = "SCN_ATOM_CX816"  # You can change this as needed
VOLTAGE_DOMAIN = "AT"
...
Import("SCN_ATOM_CX816_Specs.usrv")
Import("SCN_ATOM_CX816_Levels.tcg")
Import("SCN_ATOM_CX816_Timing.tcg")
#Import("VminTC.xml")
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_stuckat_spofi_occ = \
        PrimeScanSPOFITestMethod(name=f"STUCKAT_ATOM_SPOFI_K_{flow}_X_X_NOM_OCC",
               ...
               TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM","SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMHXB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM")'),
               LevelsTc = 'SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom',
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_stuckat_spofi = \
        PrimeScanSPOFITestMethod(name=f"STUCKAT_ATOM_SPOFI_K_{flow}_X_X_NOM_{corner}_M{atom}",
               ...
               LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
               TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM","SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMHXB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM")'),
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_chain_spofi = \
        PrimeScanSPOFITestMethod(name=f"CHAIN_ATOM_SPOFI_K_{flow}_X_X_NOM_{corner}_M{atom}",
               Patlist = Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_chain_hptp1600_4r4t_edt_chain_m{atom}_classhvm_list","scn_arw_chain_hptp800_4r4t_edt_chain_m{atom}_classhvm_list","scn_arw_chain_hptp800_4r4t_edt_chain_m{atom}_classhvm_list","scn_arw_chain_hptp800_4r4t_edt_chain_m{atom}_classhvm_list")'),
               LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
               TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM","SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMHXB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM")'),
               PerPatternFailCaptureCount = 100000,
               TotalFailCaptureCount = 100000,
...
def get_shmoo_test_occstuckat(flow, corner, testinput):
    ...
    return DDGShmooTC(
        ...
        _comment=["NOCLEAN", "PATLIST_NOCLEAN : Due to needing this plist for PO shmoo", "TCG_NOCLEAN : Due to needing it"],
        Patlist= Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_{flow.lower()}_hptp1600_12r4t_edt_stuckat_occ_classhvm_list","scn_arw_{flow.lower()}_hptp800_4r4t_edt_stuckat_occ_classhvm_list","scn_arw_{flow.lower()}_hptp1600_12r4t_edt_stuckat_occ_classhvm_list","scn_arw_{flow.lower()}_hptp800_4r4t_edt_stuckat_occ_classhvm_list")'),
        LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
        TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM","SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMHXB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM")'),
        SetPointsPlistParamName="Patlist",
        SetPointsPlistMode="Local",
        PrePointExecMode= "Never",
        SetPointsPreInstance= Spec(f'__shared__::TpRule.If_DS0_DS1_M(SCN_ATOM_CX816_Specs.S28_ShmooPreInst_F1,SCN_ATOM_CX816_Specs.S52_ShmooPreInst_F1,SCN_ATOM_CX816_Specs.HX28_ShmooPreInst_F1,SCN_ATOM_CX816_Specs.S28_ShmooPreInst_F1)'),
        ...
        XAxisParam=Spec(f'__shared__::TpRule.If_DS0_DS1_M("all_mts","p_all_mts","all_mts","p_all_mts")'),
        XAxisParamType="UserDefined",
        XAxisRange= Spec(f'__shared__::TpRule.If_DS0_DS1_M("1100e6:100e6:5","600e6:100e6:5","1100e6:100e6:5","600e6:100e6:5")'),
        YAxisType="FIVR",
        YAxisParam= 'ATOM3,ATOM2,ATOM1,ATOM0',
...
def get_shmoo_test_f1f4occatspeed(flow, corner, testinput, FlowMatrix):
    ...
    return DDGShmooTC(
        ...
        _comment=["NOCLEAN", "PATLIST_NOCLEAN : Due to needing this plist for PO shmoo", "TCG_NOCLEAN : Due to needing it"],
        Patlist= Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_vmaxf5xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list_f5_master","scn_arw_{flow.lower()}_hptp800_4r4t_edt_atspeed_occ_classhvm_list_fmin_master","scn_arw_vmaxf5xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list_f5_master","scn_arw_{flow.lower()}_hptp800_4r4t_edt_atspeed_occ_classhvm_list_fmin_master")') if "FMINXAT" in flow else Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_vmaxf5xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list_f5_master","scn_arw_{flow.lower()}_hptp800_4r4t_edt_atspeed_occ_classhvm_list_{corner.lower()}_master","scn_arw_vmaxf5xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list_f5_master","scn_arw_{flow.lower()}_hptp800_4r4t_edt_atspeed_occ_classhvm_list_{corner.lower()}_master")'),
        LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
        TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck50_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck50_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck50_SCNATOMHXB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck50_SCNATOMB0")') if "FMINXAT" in flow else Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM","SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMHXB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM")'),
        SetPointsPlistParamName="Patlist",
        SetPointsPlistMode="Local",
        #PrePointExecMode= "Never",
        SetPointsPreInstance= testinput.get("setpointpre", Spec(f'__shared__::TpRule.If_DS0_DS1_M(SCN_ATOM_CX816_Specs.S28_ShmooPreInst_{corner.upper()},SCN_ATOM_CX816_Specs.S52_ShmooPreInst_{corner.upper()},SCN_ATOM_CX816_Specs.HX28_ShmooPreInst_{corner.upper()},SCN_ATOM_CX816_Specs.S28_ShmooPreInst_{corner.upper()})'),),
        VoltageConverter = Spec(f'"--dlvrpins VCCIA --expressions ATOM --fivrcondition NOM"'),
        #ExecutionMode="AllPin",
        PrintFormat='ShmooHub',
        XAxisType="SpecSetVariable",
        XAxisDatalogPrefix = 'Base',
        XAxisParam=Spec(f'__shared__::TpRule.If_DS0_DS1_M("p_all_mts","p_all_mts","p_all_mts","p_all_mts")') if "FMINXAT" in flow else Spec(f'__shared__::TpRule.If_DS0_DS1_M("all_mts","p_all_mts","all_mts","p_all_mts")'),
        XAxisParamType="UserDefined",
        XAxisRange=Spec(f'__shared__::TpRule.If_DS0_DS1_M("600e6:100e6:5","200e6:100e6:5","600e6:100e6:5","200e6:100e6:5")')  if "FMINXAT" in flow else Spec(f'__shared__::TpRule.If_DS0_DS1_M("1100e6:100e6:5","600e6:100e6:5","1100e6:100e6:5","600e6:100e6:5")'),
        YAxisType="FIVR",
        YAxisParam='ATOM3,ATOM2,ATOM1,ATOM0',
        YAxisParamType="UserDefined",
        YAxisDatalogPrefix = 'Base',
...
def get_shmoo_test_f5occatspeed(flow, corner, testinput, FlowMatrix):
    ...
    return DDGShmooTC(
        name=f"ATSPEED_ATOM_SHMOO_E_BEGINCPU_X_X_NOM_X_{flow}_OCC",
        _comment=["NOCLEAN", "PATLIST_NOCLEAN : Due to needing this plist for PO shmoo", "TCG_NOCLEAN : Due to needing it"],
        Patlist = Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_vmaxf5xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list_f5_master","scn_arw_f5xat_hptp800_4r4t_edt_atspeed_occ_classhvm_list_f5_master","scn_arw_vmaxf5xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list_f5_master","scn_arw_f5xat_hptp800_4r4t_edt_atspeed_occ_classhvm_list_f5_master")'), 
        LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
        TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM","SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMHXB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM")'),
        SetPointsPlistParamName="Patlist",
        SetPointsPlistMode="Local",
...
def get_shmoo_test_vmaxoccatspeed(flow, corner, testinput, FlowMatrix):
    ...
    return DDGShmooTC(
        ...
        Patlist = Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_vmaxf5xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list_f5_master","scn_arw_vmaxf5xat_hptp800_4r4t_edt_atspeed_occ_classhvm_list_f5_master","scn_arw_vmaxf5xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list_f5_master","scn_arw_vmaxf5xat_hptp800_4r4t_edt_atspeed_occ_classhvm_list_f5_master")'), 
        LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
        TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM","SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMHXB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM")'),
        SetPointsPlistParamName="Patlist",
        SetPointsPlistMode="Local",
...
def get_test_list_iochain(flow, corner, atom, testinput, atom_module):
    ...
    return DDGShmooTC(
        ...
        _comment=["NOCLEAN", "PATLIST_NOCLEAN : Due to needing this plist for PO shmoo", "TCG_NOCLEAN : Due to needing it"],
        Patlist = Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_chain_hptp1600_4r4t_edt_chain_m{atom}_classhvm_list","scn_arw_chain_hptp800_4r4t_edt_chain_m{atom}_classhvm_list","scn_arw_chain_hptp1600_4r4t_edt_chain_m{atom}_classhvm_list","scn_arw_chain_hptp800_4r4t_edt_chain_m{atom}_classhvm_list")'),
        LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
        TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM","SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMHXB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM")'),
        SetPointsPlistParamName="Patlist",
        SetPointsPlistMode="Local",
        PrePointExecMode= "Never",
        SetPointsPreInstance=Spec(f'__shared__::TpRule.If_DS0_DS1_M(SCN_ATOM_CX816_Specs.S28_ShmooPreInst_chain,SCN_ATOM_CX816_Specs.S52_ShmooPreInst_chain,SCN_ATOM_CX816_Specs.HX28_ShmooPreInst_chain,SCN_ATOM_CX816_Specs.S28_ShmooPreInst_chain)'),
        VoltageConverter = Spec(f'"--dlvrpins VCCIA --expressions ATOM --fivrcondition NOM"'),
        #ExecutionMode="AllPin",
        PrintFormat='ShmooHub',
        XAxisType="SpecSetVariable",
...
def get_shmoo_test_f1f4ioatspeed(flow, corner, atom, testinput, FlowMatrix):
    ...
    return DDGShmooTC(
        ...
        LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
        TimingsTc = testinput.get("timingstc", 'SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0'),
        SetPointsPlistParamName="Patlist",
        SetPointsPlistMode="Local",
        #PrePointExecMode= "Never",
...
def get_test_list_chain_shmoodata_margincheck(
    ...
    sample_test_chain_shmoo_margincheck = PrimeShmooTestMethod(name = f"CHAIN_ATOM_SHMOO_E_{flow}_X_AT_NOM_X_{corner}_{testtype}_IOSHMOODATA",
                Patlist = Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_chain_hptp1600_4r4t_edt_chain_m0_classhvm_list","scn_arw_chain_hptp1600_4r4t_edt_chain_m0_classbbs_list","scn_arw_chain_hptp1600_4r4t_edt_chain_m0_classhvm_list","scn_arw_chain_hptp1600_4r4t_edt_chain_m0_classbbs_list")'),
                LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","MIO_HPTP_CXPKGS9::hptp_timing_cal_nom_lvl","MIO_HPTP_CXPKGHX::hptp_timing_cal_nom_lvl","MIO_HPTP_CXPKGHX::hptp_timing_cal_nom_lvl")'),
                TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0","MIO_HPTP_CXPKGS9::cpu_fun_timing_mts1500_tstprtclk750_tck93p75","MIO_HPTP_CXPKGHX::cpu_fun_timing_hptp_scn_tuned_mts1500_tstprtclk750_tck93p75","SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0")'),
                #ApplyEndSequence = 'DISABLED',
                #ExecutionMode = 'Allpin',
                #SetPointsPlistParamName = "Patlist",
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_callback = \
        RunCallback(name=f"CTRL_X_UF_E_{flow}_X_X_X_X_PINMAP_SCN_PRIME_DIERECOVERY",
               ...
               Parameters = "--decoder AnyFailSingleSliceDecoder --file ./Modules/SCN/SCN_ATOM_CX816/InputFiles/DieRecoveryPinMaps_IO_NVL_SCNATOM.json",
               BypassPort = testinput.get("Bypassport", -1),
               _fitem=Fitem('SAME',
               edc=testinput.get("ISEDC"),
               r0=pFail(setbin = -41, goto="NEXT"),
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_callback = \
        RunCallback(name=f"CTRL_X_UF_E_{flow}_X_X_X_X_PINMAP_SCN_PRIME_DIERECOVERY_OCC",
               Callback = "LoadPinMapFile",
               Parameters = Spec(f'__shared__::TpRule.If_DS0_DS1_M("--decoder FailDataDecoder --file ./Modules/SCN/SCN_ATOM_CX816/InputFiles/N2P_DieRecoveryPinMaps_OCC_NVL_SCANATOM.json", "--decoder FailDataDecoder --file ./Modules/SCN/SCN_ATOM_CX816/InputFiles/DieRecoveryPinMaps_OCC_NVL_SCANATOM.json", "--decoder FailDataDecoder --file ./Modules/SCN/SCN_ATOM_CX816/InputFiles/DieRecoveryPinMaps_OCC_NVL_SCANATOM.json", "--decoder FailDataDecoder --file ./Modules/SCN/SCN_ATOM_CX816/InputFiles/N2P_DieRecoveryPinMaps_OCC_NVL_SCANATOM.json")'),
               BypassPort = testinput.get("Bypassport", -1),
               _fitem=Fitem('SAME',
               edc=testinput.get("ISEDC"),
               r0=pFail(setbin = -41, goto="NEXT"),
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_apex_callback = \
        RunCallback(name=f"CTRL_X_UF_E_{flow}_X_X_X_X_SCN_PRIME_APEX",
               ...
               Parameters = Spec(f'__shared__::TpRule.If_DS0_DS1_M(GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "./Modules/SCN/SCN_ATOM_CX816/InputFiles/N2P_ApexTC_Input_Config.json", GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "./Modules/SCN/SCN_ATOM_CX816/InputFiles/ApexTC_Input_Config.json", GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "./Modules/SCN/SCN_ATOM_CX816/InputFiles/ApexTC_Input_Config.json", GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "./Modules/SCN/SCN_ATOM_CX816/InputFiles/N2P_ApexTC_Input_Config.json")'),
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_stuckat_occ = \
        VminTC(name=f"STUCKAT_ATOM_SB_K_{flow}_X_AT_NOM_X_F1_OCC", 
               ...
               LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
               TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM","SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMHXB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM")'),
               StartVoltages = Spec("SCN_ATOM_CX816_Specs.ATPG_StartVoltage"),
               EndVoltageLimits = Spec("SCN_ATOM_CX816_Specs.ATPG_EndVoltage"),
               VoltageTargets = testinput.get("Voltagetarget", "ATOM3,ATOM2,ATOM1,ATOM0"),
               ...
               SetPointsPlistParamName = 'Patlist',
               SetPointsPreInstance = Spec(f'__shared__::TpRule.If_DS0_DS1_M(SCN_ATOM_CX816_Specs.S28_PreInst_F1,SCN_ATOM_CX816_Specs.S52_PreInst_F1,SCN_ATOM_CX816_Specs.HX28_PreInst_F1,SCN_ATOM_CX816_Specs.S28_PreInst_F1)'),
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_stuckat = \
        VminTC(name=f"STUCKAT_ATOM_SB_K_{flow}_X_AT_NOM_X_F1_M{atom}",
               ...
               StartVoltages = Spec("SCN_ATOM_CX816_Specs.ATPG_StartVoltage"),
               EndVoltageLimits = Spec("SCN_ATOM_CX816_Specs.ATPG_EndVoltage"),
               VoltageTargets = f'ATOM{atom}', #testinput.get("Voltagetarget", "ATOM3,ATOM2,ATOM1,ATOM0"),
               ExecutionMode = 'SearchWithScoreboard',
               TestMode = testinput.get("Testmode", ""),
               VoltageConverter = Spec(f'"--dlvrpins VCCIA --expressions "' + f' + DROPOUT.AT_F1'),
               BaseNumbers = AUTO,
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_chain = \
        VminTC(name=f"CHAIN_ATOM_SB_K_{flow}_X_AT_NOM_X_F1_M{atom}",
               ...
               MaxFailsNum = Spec("toInteger(__shared__::Specs.VMX_MAX_FAILS)"),
               SetPointsPlistParamName = 'Patlist',
               SetPointsPreInstance= Spec(f'__shared__::TpRule.If_DS0_DS1_M(SCN_ATOM_CX816_Specs.S28_PreInst_F1_chain,SCN_ATOM_CX816_Specs.S52_PreInst_F1_chain,SCN_ATOM_CX816_Specs.HX28_PreInst_F1_chain,SCN_ATOM_CX816_Specs.S28_PreInst_F1_chain)'),
...
def get_test_list_atspeed_occ_f1f4_mtt (
    ...
    NativeMultiTrial(name = f"ATSPEED_ATOM_{testtype}_K_{flow.upper()}_X_AT_{corner.upper()}_X_FREQ_OCC",
                ...
                Patlist = Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_{flow.lower()}_hptp1600_12r4t_edt_atspeed_occ_classhvm_list_{corner.lower()}_master","scn_arw_{flow.lower()}_hptp800_4r4t_edt_atspeed_occ_classhvm_list_{corner.lower()}_master","scn_arw_{flow.lower()}_hptp1600_12r4t_edt_atspeed_occ_classhvm_list_{corner.lower()}_master","scn_arw_{flow.lower()}_hptp800_4r4t_edt_atspeed_occ_classhvm_list_{corner.lower()}_master")'),
                LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
                TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM","SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMHXB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM")'),
                PreInstance = '',
                PostInstance = '',
                ...
                DtsConfiguration = Spec(f'__shared__::TpRule.If_DS0_DS1_M("ALL_CDIE_S28C_N2P","ALL_CDIE_S52C","ALL_CDIE_S28C_N2P","ALL_CDIE_S28C")') if "F4XAT" in flow else Spec(f'__shared__::TpRule.If_DS0_DS1_M("ALL_CDIE_S28C_N2P","ALL_CDIE_S52C","ALL_CDIE_S28C_N2P","ALL_CDIE_S28C")'),
                ...
                SetPointsPlistParamName = 'Patlist',
                SetPointsPreInstance = Spec(f'__shared__::TpRule.If_DS0_DS1_M(SCN_ATOM_CX816_Specs.S28_PreInst_{corner.upper()},SCN_ATOM_CX816_Specs.S52_PreInst_{corner.upper()},SCN_ATOM_CX816_Specs.HX28_PreInst_{corner.upper()},SCN_ATOM_CX816_Specs.S28_PreInst_{corner.upper()})'),
                ...
                VoltageConverter = Spec(f'"--railconfigurations CDIE_L2_NBLCTRL3 CDIE_L2_NBLCTRL2 CDIE_L2_NBLCTRL1 CDIE_L2_NBLCTRL0 --dlvrpins VCCIA --expressions "' + f' + DROPOUT.AT_{corner}'),
...
def get_test_list_atspeed_f1f4_io_mtt(
    ...
    sample_test_atspeed_f1f4_io_mtt = \
        NativeMultiTrial(name = f"ATSPEED_ATOM_{testtype}_K_{flow.upper()}_X_AT_{corner.upper()}_X_FREQ_M{atom}",
                ...
                LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
                TimingsTc = 'SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck50_SCNATOMB0' if "FMINXAT" in flow else 'SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0',
                PreInstance = '',
                PostInstance = '',
                BaseNumbers = AUTO,
...
def get_test_list_atspeed_occ_f5f6_mtt (
    ...
    NativeMultiTrial(name = f"ATSPEED_ATOM_{testtype}_K_{flow.upper()}_X_AT_{corner.upper()}_X_FREQ_OCC",
                ...
                DtsConfiguration = Spec(f'__shared__::TpRule.If_DS0_DS1_M("ALL_CDIE_S28C_N2P","ALL_CDIE_S52C","ALL_CDIE_S28C_N2P","ALL_CDIE_S28C")'),
                EndVoltageLimits = Spec(f'__shared__::FlowMatrixSingular.AT_HIGH_SEARCH_VALUE'),
                ExecutionMode = testinput.get("executionmode", "SearchWithScoreboard"),
		        #FailCaptureCount = Spec("SCN_ATOM_CX816_Specs.Fail_Capture_Count"),
                FeatureSwitchSettings = 'fivr_mode_on,disable_masked_targets,print_per_target_increments,print_scoreboard_counters',
                LogLevel = "Disabled",
				SetPointsPlistMode = "Local",
                FivrCondition = 'NOM',
                ...
                MaxFailsNum = Spec("toInteger(__shared__::Specs.CHK_MAX_FAILS)"),
                SetPointsPlistParamName = 'Patlist',
                SetPointsPreInstance= TrialParamSpec(f'__shared__::TpRule.If_DS0_DS1_M(SCN_ATOM_CX816_Specs.S28_PreInst_F5,SCN_ATOM_CX816_Specs.S52_PreInst_F5,SCN_ATOM_CX816_Specs.HX28_PreInst_F5,SCN_ATOM_CX816_Specs.S28_PreInst_F5)'),
                ...
                VoltageConverter = Spec(f'"--railconfigurations CDIE_L2_NBLCTRL3 CDIE_L2_NBLCTRL2 CDIE_L2_NBLCTRL1 CDIE_L2_NBLCTRL0 --dlvrpins VCCIA --expressions "' + f' + DROPOUT.AT_{corner}'),
                VoltagesOffset = 'GBVars.VoltageOffset',
                VoltageTargets = "ATOM3,ATOM2,ATOM1,ATOM0",
                BypassPort = testinput.get("Bypassport", -1),
                ), # The close bracket here indicates that we are done defining VminTC params
...
def get_test_list_atspeed_f5f6_io_mtt(
    ...
    sample_test_atspeed_f5f6_io_mtt = \
        NativeMultiTrial(name = f"ATSPEED_ATOM_{testtype}_K_{flow.upper()}_X_AT_{corner.upper()}_X_FREQ_M{atom}",
                ...
                #PostInstance = '',
                BaseNumbers = AUTO,
                CornerIdentifiers = TrialParamSpec(f'SCN_ATOM_CX816_corneridentifier.AT_C5_M{atom}'),
                DtsConfiguration = Spec(f'__shared__::TpRule.If_DS0_DS1_M("ALL_CDIE_S28C_N2P","ALL_CDIE_S52C","ALL_CDIE_S28C_N2P","ALL_CDIE_S28C")'),
                EndVoltageLimits = Spec(f'__shared__::FlowMatrixSingular.AT_HIGH_SEARCH_VALUE'),
                ExecutionMode = testinput.get("executionmode", "SearchWithScoreboard"),
                #FailCaptureCount = Spec("SCN_ATOM_CX816_Specs.Fail_Capture_Count"),
...
def get_test_list_atspeed_f5f6_occapex(    
    ...
    sample_test_atspeed_f5f6_occapex = \
        ApexTC(name = f"ATSPEED_ATOM_APEX_K_{flow.upper()}_X_AT_F5_X_APEX_OCC",
                ...
                Patlist = testinput.get("Patlist", Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_vmaxf5xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_vmaxf5xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_vmaxf5xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_vmaxf5xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list")')),
                LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
                TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM","SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMHXB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM")'),
                #InitialMaskBits = '0', 
                DtsConfiguration = Spec(f'__shared__::TpRule.If_DS0_DS1_M("ALL_CDIE_S28C_N2P","ALL_CDIE_S52C","ALL_CDIE_S28C_N2P","ALL_CDIE_S28C")'),
	            ...
	            RecoveryTracking= 'ACRM3,ACRM2,ACRM1,ACRM0',
                #ScoreboardEdgeTicks = Spec("toInteger(__shared__::Specs.CHK_EDGE_TICK)"),
                #MaxFailsNum = Spec("toInteger(__shared__::Specs.CHK_MAX_FAILS)"),
	            End= Spec('__shared__::FlowMatrixSingular.APEX_ATOM_MIN'),
                Start=Spec('__shared__::FlowMatrixSingular.APEX_ATOM_MAX'),
                SetPointsPreInstance= Spec(f'__shared__::TpRule.If_DS0_DS1_M(SCN_ATOM_CX816_Specs.S28_PreInst_F5_APEX,SCN_ATOM_CX816_Specs.S52_PreInst_F5_APEX,SCN_ATOM_CX816_Specs.HX28_PreInst_F5_APEX,SCN_ATOM_CX816_Specs.S28_PreInst_F5_APEX)'),
                #SetPointsPostInstance= '',
                ...
                #PatternNameCounterIndexes = '1,2,3,4,5,6,7',
                VoltageConverter = Spec(f'"--overrides ATOM3:"+' +Spec(f"__shared__::FlowMatrixSingular.AT_VMAX_VALUE")+ f'+",ATOM2:"+' +Spec(f"__shared__::FlowMatrixSingular.AT_VMAX_VALUE")+ f'+",ATOM1:"+' +Spec(f"__shared__::FlowMatrixSingular.AT_VMAX_VALUE")+ f'+",ATOM0:"+' +Spec(f"__shared__::FlowMatrixSingular.AT_VMAX_VALUE")+ f'+ " --dlvrpins VCCIA --expressions "' + f' + DROPOUT.AT_F5'),            
	            ...
	            Targets= f'SATOM3,SATOM2,SATOM1,SATOM0',
	            BypassPort = Spec(f'__shared__::TpRule.If_DS0_DS1_M(-1, -1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)'),
                #), # The close bracket here indicates that we are done defining VminTC params     
                #  r0=pFail(setbin=-47, ret=0, trialaction=Spec('__shared__::TpRule.MTT_Rule("Next","Exit")')),
...
def get_test_list_atspeed_lttcf5_occ_mtt(
    ...
    sample_test_atspeed_lttcf5_occ_mtt = \
        NativeMultiTrial(name = f"ATSPEED_ATOM_{testtype}_K_{flow.upper()}_X_AT_{corner.upper()}_X_FREQ_OCC",
                ...
                trialvar = "CPU_TRIALS::FlowDomain.ATOM_TOP",
                template = VminTC(name = f'"ATSPEED_ATOM_{testtype}_K_{flow.upper()}_X_AT_" + ' + Spec(f"__shared__::Corners.AT_{corner_id}") + '+ "_" +' + Spec(f"__shared__::FreqInMHZ.AT_{corner_id}") + f' + "_OCC"',
                Patlist = Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_f5lttc_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_f5lttc_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_f5lttc_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_f5lttc_hptp1600_12r4t_edt_atspeed_occ_classhvm_list")'),
                LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
                TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM","SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMHXB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM")'),
                #PreInstance = '',
                #PostInstance = '',
                ...
                VoltageConverter = Spec('"--railconfigurations CDIE_L2_NBLCTRL3 CDIE_L2_NBLCTRL2 CDIE_L2_NBLCTRL1 CDIE_L2_NBLCTRL0 --dlvrpins VCCIA --expressions " + DROPOUT.AT_F5 + " --overrides CCF:"+' + Spec(f"__shared__::FlowMatrixSingular.CCF_VMAX_VALUE")),
                #VoltagesOffset = 'GBVars.VoltageOffset',
                VoltageTargets = "ATOM3,ATOM2,ATOM1,ATOM0",
...
def get_test_list_sa_f1vmax_occ_mtt(
    ...
    sample_test_sa_f1vmax_occ_mtt = \
        VminTC(name = f"STUCKAT_ATOM_SB_K_{flow.upper()}_X_AT_MAX_X_F1_OCC",
                ...
                Patlist = testinput.get("Patlist", Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_vmax{corner.lower()}xat_hptp1600_12r4t_edt_stuckat_occ_classhvm_list","scn_arw_vmax{corner.lower()}xat_hptp1600_12r4t_edt_stuckat_occ_classhvm_list","scn_arw_vmax{corner.lower()}xat_hptp1600_12r4t_edt_stuckat_occ_classhvm_list","scn_arw_vmax{corner.lower()}xat_hptp1600_12r4t_edt_stuckat_occ_classhvm_list")')),
                LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
                TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM","SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMHXB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM")'),
                PreInstance = '',
                PostInstance = '',
                ...
                MaxFailsNum = Spec("toInteger(__shared__::Specs.VMX_MAX_FAILS)"),
                SetPointsPlistParamName = 'Patlist',
                SetPointsPreInstance= Spec(f'__shared__::TpRule.If_DS0_DS1_M(SCN_ATOM_CX816_Specs.S28_PreInst_F1_VMAX,SCN_ATOM_CX816_Specs.S52_PreInst_F1_VMAX,SCN_ATOM_CX816_Specs.HX28_PreInst_F1_VMAX,SCN_ATOM_CX816_Specs.S28_PreInst_F1_VMAX)'),
                #SetPointsPostInstance= Spec(f'PSPOST.AT_{corner}'),
                ...
                VoltagesOffset = 'GBVars.VoltageOffset',
                VoltageTargets = "ATOM3,ATOM2,ATOM1,ATOM0",
                BypassPort = testinput.get("Bypassport", Spec('__shared__::TpRule.If_DS0_DS1_M(-1, -1, -1, -1)')),
                #), # The close bracket here indicates that we are done defining VminTC params     
                #r0=pFail(setbin=-47, ret=0, trialaction=Spec('__shared__::TpRule.MTT_Rule("Next","Exit")')),
                #r1 = pPass(ret = 1, trialaction = "Exit"),
...
def get_test_list_atspeed_f5vmax_occ_mtt(
    ...
    sample_test_atspeed_f5vmax_occ_mtt = \
        NativeMultiTrial(name = f"ATSPEED_ATOM_{testtype}_K_{flow.upper()}_X_AT_MAX_X_F5_FREQ_OCC",
                ...
                Patlist = testinput.get("Patlist", Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_vmax{corner.lower()}xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_vmax{corner.lower()}xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_vmax{corner.lower()}xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_vmax{corner.lower()}xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list")')),
                LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
                TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM","SCN_ATOM_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_SCNATOMHXB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_SCNATOM")'),
                #PreInstance = '',
                #PostInstance = '',
                ...
                MaxFailsNum = Spec("toInteger(__shared__::Specs.VMX_MAX_FAILS)"),
                SetPointsPlistParamName = 'Patlist',
                SetPointsPreInstance= TrialParamSpec(f'__shared__::TpRule.If_DS0_DS1_M(SCN_ATOM_CX816_Specs.S28_PreInst_F5_VMAX,SCN_ATOM_CX816_Specs.S52_PreInst_F5_VMAX,SCN_ATOM_CX816_Specs.HX28_PreInst_F5_VMAX,SCN_ATOM_CX816_Specs.S28_PreInst_F5_VMAX)'),
...
def get_test_list_atspeed_fmin_occ_mtt(
    ...
    sample_test_atspeed_fmin_occ_mtt = \
        NativeMultiTrial(name = f"ATSPEED_ATOM_{testtype}_K_{flow.upper()}_X_AT_{corner.upper()}_X_FREQ_OCC",
                ...
                trialvar = "CPU_TRIALS::FlowDomain.ATOM",
                template = VminTC(name = f'"ATSPEED_ATOM_{testtype}_K_{flow.upper()}_X_AT_{corner.upper()}_" + ' + Spec(f"__shared__::CustomFlowMatrixSpecs.{FlowMatrix}_MHz") + f' + "_OCC"',
                Patlist = Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_{flow.lower()}_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_{flow.lower()}_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_{flow.lower()}_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_{flow.lower()}_hptp1600_12r4t_edt_atspeed_occ_classhvm_list")'),
                LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
                TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck50_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck50_SCNATOMB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck50_SCNATOMHXB0","SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck50_SCNATOMB0")'),
                PreInstance = '',
                PostInstance = '',
                BaseNumbers = AUTO,
                CornerIdentifiers = 'AT3@F1,AT2@F1,AT1@F1,AT0@F1',
                DtsConfiguration = Spec(f'__shared__::TpRule.If_DS0_DS1_M("ALL_CDIE_S28C_N2P","ALL_CDIE_S52C","ALL_CDIE_S28C_N2P","ALL_CDIE_S28C")'),
                ...
                MaxFailsNum = Spec("toInteger(__shared__::Specs.CHK_MAX_FAILS)"),
                SetPointsPlistParamName = 'Patlist',
                SetPointsPreInstance= Spec(f'__shared__::TpRule.If_DS0_DS1_M(SCN_ATOM_CX816_Specs.S28_PreInst_FMIN,SCN_ATOM_CX816_Specs.S52_PreInst_FMIN,SCN_ATOM_CX816_Specs.HX28_PreInst_FMIN,SCN_ATOM_CX816_Specs.S28_PreInst_FMIN)'),
                SetPointsPostInstance= Spec(f'PSPOST.AT_{corner}'),
                StartVoltagesForRetry = Spec(f'__shared__::QNRTpRuleShared.If_PseudoVminForwarding(__shared__::QNRUsrvShared.StartVoltagesForRetry , "")'),
			    StartVoltagesOffset = Spec(f'__shared__::QNRTpRuleShared.If_PseudoVminForwarding(__shared__::QNRUsrvShared.StartVoltagesOffset , "")'),
                StartVoltages = Spec(f'__shared__::FlowMatrixSingular.AT_LOW_SEARCH_VALUE'),
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_fminffio = \
        VminTC(name=f"ATSPEED_ATOM_SB_K_{flow}_X_AT_NOM_X_M{atom}_FF_SEARCH",
               ...
               LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom","SCN_ATOM_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNATOM_OVERRIDE_nom")'),
               TimingsTc = 'SCN_ATOM_CX816::cpu_fun_timing_mts800_tstprtclk400_tck50_SCNATOMB0',
               PreInstance = '',
               PostInstance = '',
               BaseNumbers = AUTO,
               CornerIdentifiers = '',
...
begin_cpushmoo_drv_tli = {"Bypassport": 1, "ISEDC": True, "xaxisparam": Spec(f'__shared__::TpRule.If_DS0_DS1_M("cpu_tstprt_i_drv_mul","p_cpu_tstprt_i_drv_mul","cpu_tstprt_i_drv_mul","p_cpu_tstprt_i_drv_mul")'), "xaxisrange": "0:0.1:21"}
...
begin_cpushmoo_stb_tli = {"Bypassport": 1, "ISEDC": True, "xaxisparam": Spec(f'__shared__::TpRule.If_DS0_DS1_M("cpu_tstprt_o_stb_mul","p_cpu_tstprt_o_stb_mul","cpu_tstprt_o_stb_mul","p_cpu_tstprt_o_stb_mul")'), "xaxisrange": "0:0.1:21"}
...
#SHMOO_ATSPEED_TLI = {"Bypassport": 1, "ISEDC": True, "timingstc": "cpu_fun_timing_mts800_tstprtclk400_tck50_SCNATOMB0", "setpointpre": Spec(f'PSPRE.AT_FMIN+' f'","+' f'"MCdrv:atomfreq_0:"' +Spec(f"+__shared__::FlowMatrixSingular.AT_FMIN+")+'"GHz"'),}
#atspeed_shmoo = [
...
fminxat_flow = "FMINXAT"
SHMOO_ATSPEED_TLI = {"Bypassport": 1, "ISEDC": True, "setpointpre": Spec(f'__shared__::TpRule.If_DS0_DS1_M(SCN_ATOM_CX816_Specs.S28_ShmooPreInst_Fmin,SCN_ATOM_CX816_Specs.S52_ShmooPreInst_Fmin,SCN_ATOM_CX816_Specs.HX28_ShmooPreInst_Fmin,SCN_ATOM_CX816_Specs.S28_ShmooPreInst_Fmin)'),}
...
def create_subflow(testtype, flow_name, corner, module_name, flow_matrix, corner_id):
    ...
    testtype = "VMIN"
    vmintc_apexatspeed_occ_tli = {"Bypassport": -1, "Testmode": "MultiVmin", "ISEDC": True, "Patlist": Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_vmaxf5xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_vmaxf5xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_vmaxf5xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_vmaxf5xat_hptp1600_12r4t_edt_atspeed_occ_classhvm_list")')}
...
#SA_F1 test list
vmaxxat_vmintc_sa_occ_tli = {"Testmode": "MultiVmin", "ISEDC": False,}
vmaxxat_vmintc_sa_occ = get_test_list_sa_f1vmax_occ_mtt(testtype, flow_name, cornerf1, vmaxxat_vmintc_sa_occ_tli, flow_matrix)
vmintc_sa_tli_0 = {"Bypassport": 1, "Testmode": "Scoreboard", "ISEDC": True, "initialmaskbit": "1110", "Patlist": "scn_arw_vmaxf1xat_hptp1600_4r4t_edt_stuckat_m0_classhvm_list_f1_master",}
vmintc_sa_0 = get_test_list_sa_f1vmax_io_mtt(testtype, flow_name, cornerf1, atom0, vmintc_sa_tli_0, flow_matrix)
vmintc_sa_tli_1 = {"Bypassport": 1, "Testmode": "Scoreboard", "ISEDC": True, "initialmaskbit": "1101", "Patlist": "scn_arw_vmaxf1xat_hptp1600_4r4t_edt_stuckat_m1_classhvm_list_f1_master",}
vmintc_sa_1 = get_test_list_sa_f1vmax_io_mtt(testtype, flow_name, cornerf1, atom1, vmintc_sa_tli_1, flow_matrix)
vmintc_sa_tli_2 = {"Bypassport": 1, "Testmode": "Scoreboard", "ISEDC": True, "initialmaskbit": "1011", "Patlist": "scn_arw_vmaxf1xat_hptp1600_4r4t_edt_stuckat_m2_classhvm_list_f1_master",}
vmintc_sa_2 = get_test_list_sa_f1vmax_io_mtt(testtype, flow_name, cornerf1, atom2, vmintc_sa_tli_2, flow_matrix)
vmintc_sa_tli_3 = {"Bypassport": 1, "Testmode": "Scoreboard", "ISEDC": True, "initialmaskbit": "0111", "Patlist": "scn_arw_vmaxf1xat_hptp1600_4r4t_edt_stuckat_m3_classhvm_list_f1_master",}
...
vmaxxat_vmintc_atspeed_occ_tli = {"Testmode": "MultiVmin", "ISEDC": False,}
...
#SA_F1 test list
vmaxxat_vmintc_sa_occ_tli = {"Bypassport": 1, "Testmode": "MultiVmin", "ISEDC": False,}
vmaxxat_vmintc_sa_occ = get_test_list_sa_f1vmax_occ_mtt(testtype, flow_name, cornerf1, vmaxxat_vmintc_sa_occ_tli, flow_matrix)
vmintc_sa_tli_0 = {"Bypassport": 1, "Testmode": "Scoreboard", "ISEDC": True, "initialmaskbit": "1110", "Patlist": "scn_arw_vmaxf1xat_hptp1600_4r4t_edt_stuckat_m0_classhvm_list_f1_master",}
vmintc_sa_0 = get_test_list_sa_f1vmax_io_mtt(testtype, flow_name, cornerf1, atom0, vmintc_sa_tli_0, flow_matrix)
vmintc_sa_tli_1 = {"Bypassport": 1, "Testmode": "Scoreboard", "ISEDC": True, "initialmaskbit": "1101", "Patlist": "scn_arw_vmaxf1xat_hptp1600_4r4t_edt_stuckat_m1_classhvm_list_f1_master",}
...
#ATSPEED_F5 test list
vmaxxat_vmintc_atspeed_occ_tli = {"Bypassport": 1, "Testmode": "MultiVmin", "ISEDC": False,}
vmaxxat_vmintc_atspeed_occ = get_test_list_atspeed_f5vmax_occ_mtt(testtype, flow_name, cornerf5, vmaxxat_vmintc_atspeed_occ_tli, flow_matrix, corner_id)
vmintc_atspeed_tli_0 = {"Bypassport": 1, "Testmode": "SingleVmin", "ISEDC": True, "initialmaskbit": "1110", "Patlist": "scn_arw_vmaxf5xat_hptp800_4r4t_edt_atspeed_m0_classhvm_list_f5_master",}
vmintc_atspeed_0 = get_test_list_atspeed_f5vmax_io_mtt(testtype, flow_name, cornerf5, atom0, vmintc_atspeed_tli_0, flow_matrix, corner_id)
vmintc_atspeed_tli_1 = {"Bypassport": 1, "Testmode": "SingleVmin", "ISEDC": True, "initialmaskbit": "1101", "Patlist": "scn_arw_vmaxf5xat_hptp800_4r4t_edt_atspeed_m1_classhvm_list_f5_master",}
...
#SA_F1 test list
vmaxxat_vmintc_sa_occ_tli = {"Testmode": "MultiVmin", "ISEDC": False, "Patlist": Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_vmaxf1xatlo_hptp1600_12r4t_edt_stuckat_occ_classhvm_list","scn_arw_vmaxf1xatlo_hptp1600_12r4t_edt_stuckat_occ_classhvm_list","scn_arw_vmaxf1xatlo_hptp1600_12r4t_edt_stuckat_occ_classhvm_list","scn_arw_vmaxf1xatlo_hptp1600_12r4t_edt_stuckat_occ_classhvm_list")')}
vmaxxat_vmintc_sa_occ = get_test_list_sa_f1vmax_occ_mtt(testtype, flow_name, cornerf1, vmaxxat_vmintc_sa_occ_tli, flow_matrix)
vmintc_sa_tli_0 = {"Bypassport": 1, "Testmode": "Scoreboard", "ISEDC": True, "initialmaskbit": "1110", "Patlist": "scn_arw_vmaxf1xat_hptp1600_4r4t_edt_stuckat_m0_classhvm_list_f1_master",}
vmintc_sa_0 = get_test_list_sa_f1vmax_io_mtt(testtype, flow_name, cornerf1, atom0, vmintc_sa_tli_0, flow_matrix)
vmintc_sa_tli_1 = {"Bypassport": 1, "Testmode": "Scoreboard", "ISEDC": True, "initialmaskbit": "1101", "Patlist": "scn_arw_vmaxf1xat_hptp1600_4r4t_edt_stuckat_m1_classhvm_list_f1_master",}
...
vmaxxat_f1 = Flow("VMAXXATLO_F1", vmaxxat_vmintc_sa_occ)

#ATSPEED_F5 test list
vmaxxat_vmintc_atspeed_occ_tli = {"Testmode": "MultiVmin", "ISEDC": False, "Patlist": Spec(f'__shared__::TpRule.If_DS0_DS1_M("scn_arw_vmaxf5xatlo_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_vmaxf5xatlo_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_vmaxf5xatlo_hptp1600_12r4t_edt_atspeed_occ_classhvm_list","scn_arw_vmaxf5xatlo_hptp1600_12r4t_edt_atspeed_occ_classhvm_list")')}
vmaxxat_vmintc_atspeed_occ = get_test_list_atspeed_f5vmax_occ_mtt(testtype, flow_name, cornerf5, vmaxxat_vmintc_atspeed_occ_tli, flow_matrix, corner_id)
vmintc_atspeed_tli_0 = {"Bypassport": 1, "Testmode": "SingleVmin", "ISEDC": True, "initialmaskbit": "1110", "Patlist": "scn_arw_vmaxf5xat_hptp800_4r4t_edt_atspeed_m0_classhvm_list_f5_master",}
vmintc_atspeed_0 = get_test_list_atspeed_f5vmax_io_mtt(testtype, flow_name, cornerf5, atom0, vmintc_atspeed_tli_0, flow_matrix, corner_id)
vmintc_atspeed_tli_1 = {"Bypassport": 1, "Testmode": "SingleVmin", "ISEDC": True, "initialmaskbit": "1101", "Patlist": "scn_arw_vmaxf5xat_hptp800_4r4t_edt_atspeed_m1_classhvm_list_f5_master",}
...
vmaxxat_f5 = Flow("VMAXXATLO_F5", vmaxxat_vmintc_atspeed_occ)
