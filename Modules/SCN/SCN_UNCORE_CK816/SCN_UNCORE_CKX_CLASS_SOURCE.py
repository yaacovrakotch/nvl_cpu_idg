...
LOCAL_PARAM_SHMOO_XAxisParam = "all_mts"
...
LOCAL_PARAM_MIN_LevelsTc = "SCN_UNCORE_CK816::cpu_all_bf_x_x_pkg_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_max"
LOCAL_PARAM_MAX_LevelsTc = ""
LOCAL_PARAM_POR_TimingsTc = "IPC::SCN_UNCORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_OVERRIDEPKG"
   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_stuckat_occ = \
        VminTC(name=f"STUCKAT_UNCORE_SB_K_{flow}_X_X_MAX_X_ALL",
               ...
               TimingsTc = Spec(f'SCN_UNCORE_CK816_Specs.timingRules'),
               LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_UNCORE_CK816::cpu_all_bf_x_x_pkg_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_max","SCN_UNCORE_CK816::cpu_all_bf_x_x_pkg_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_max","SCN_UNCORE_CK816::cpu_all_bf_x_x_pkg_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_max","SCN_UNCORE_CK816::cpu_all_bf_x_x_pkg_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_max")'),
               StartVoltages = '0.9',
...
def get_shmoo_test_stuckat(flow, corner, testinput):
    ...
    return DDGShmooTC(name = f"STUCKAT_UNCORE_SHMOO_E_{flow}_X_X_NOM_X",
                ...
                XAxisRange = Spec(f'__shared__::TpRule.If_DS0_DS1_M("1100e6:100e6:5","1100e6:100e6:5","1100e6:100e6:5","1100e6:100e6:5")'),
                YAxisType = "SpecSetVariable",
                YAxisParamType = "UserDefined",
