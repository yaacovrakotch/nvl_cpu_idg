   ...
   # Create an empty list that will contain the final list of the test
    ...
    sample_test_stuckat_occ = \
        VminTC(name=f"STUCKAT_UNCORE_SB_K_{flow}_X_X_NOM_X_ALL",
               ...
               TimingsTc =  Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_UNCORE_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_HXB0OVERRIDE1500","SCN_UNCORE_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_HXB0OVERRIDE1500")'),
               LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_UNCORE_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom","SCN_UNCORE_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom")'),
               StartVoltages = '0.9',
...
def get_test_list_atspeed_vmax_occ_mtt (
    ...
    NativeMultiTrial(name = f"ATSPEED_UNCORE_SB_K_{flow.upper()}_X_{VOLTAGE_DOMAIN.upper()}_MAX_{frequency_value}_F5_F7",
               ...
               # DtsConfiguration = Spec(f'SCN_UNCORE_CX816_Specs.CCF_VMINTC_DtsConfiguration_{corner.upper()}'),
                EndVoltageLimits = Spec(f"__shared__::FlowMatrixSingular.CCF_VMAX_VALUE"),
                ExecutionMode = "SearchWithScoreboard",
                LogLevel = 'Disabled',
                SetPointsPlistMode = "Local",
               ...
               # StartVoltagesForRetry= "",
                ...
                VoltageTargets = testinput.get("Voltagetarget", "CCF"),
                BypassPort = testinput.get("Bypassport", -1),
                DtsConfiguration = Spec(f'__shared__::TpRule.If_DS0_DS1_M("ALL_CDIE_S28C_N2P","ALL_CDIE_S52C","ALL_CDIE_S28C_N2P","ALL_CDIE_S28C_N2P")'),
    ...
    sample_test_atspeed_f5f6_apexmtt = ApexTC(
        ...
        #template=ApexTC(
           # name=f'"ATSPEED_VMIN_K_{flow.upper()}_X_{VOLTAGE_DOMAIN.upper()}_{corner.upper()}_" + ' + Spec(f"__shared__::Corners.CCF_C5") + f' + "_APEX_MTT"',
            ...
            LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_UNCORE_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCORE_OVERRIDE_nom","SCN_UNCORE_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","SCN_UNCORE_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom")'),
            TimingsTc=Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_UNCORE_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","SCN_UNCORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_OVERRIDEHX","SCN_UNCORE_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE")'),
            InitialMaskBits='',
            ForwardingMode= "None",
            PinMap='',
            RecoveryOptions= '',
...
def get_test_list_stuckat_shmoo(
    ...
    sample_test_stuckat_shmoo = DDGShmooTC(name = f"STUCKAT_UNCORE_SHMOO_E_{flow}_X_X_NOM_X",
                ...
                XAxisParam =Spec(f'__shared__::TpRule.If_DS0_DS1_M("all_mts","all_mts","all_mts","all_mts")'),
                XAxisRange = Spec(f'__shared__::TpRule.If_DS0_DS1_M("1100e6:100e6:5","600e6:100e6:5","600e6:100e6:5","600e6:100e6:5")'),
                YAxisType = "FIVR",
...
def get_test_list_chain_shmoodata_margincheck_drv(
    ...
    sample_test_chain_shmoo_margincheck_drv = PrimeShmooTestMethod(name = f"CHAIN_UNCORE_SHMOO_E_{flow}_X_CR_NOM_X_{corner}_{testtype}_SHMOODATA",
                ...
                LevelsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_UNCORE_CX816::cpu_all_bf_x_x_ipc_lvl_CPU_BFUNC_SCNUNCOREB0_OVERRIDE_nom","MIO_HPTP_CXPKGS9::hptp_timing_cal_nom_lvl","MIO_HPTP_CXPKGHX::hptp_timing_cal_nom_lvl","MIO_HPTP_CXPKGHX::hptp_timing_cal_nom_lvl")'),
                TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("SCN_UNCORE_CX816::cpu_hvm_timing_mts1500_tstprtclk750_tck93p75_OVERRIDE","MIO_HPTP_CXPKGS9::cpu_fun_timing_mts1500_tstprtclk750_tck93p75","MIO_HPTP_CXPKGHX::cpu_fun_timing_hptp_scn_tuned_mts1500_tstprtclk750_tck93p75","MIO_HPTP_CXPKGHX::cpu_fun_timing_hptp_scn_tuned_mts1500_tstprtclk750_tck93p75")'),
                ...
                XAxisParam =Spec(f'__shared__::TpRule.If_DS0_DS1_M("cpu_tstprt_i_drv_mul","p_cpu_tstprt_i_drv_mul","p_cpu_tstprt_i_drv_mul","p_cpu_tstprt_i_drv_mul")'),
...
def get_test_list_chain_shmoodata_margincheck_stb(
    ...
    sample_test_chain_shmoo_margincheck_stb = PrimeShmooTestMethod(name = f"CHAIN_UNCORE_SHMOO_E_{flow}_X_CR_NOM_X_{corner}_{testtype}_SHMOODATA",
                ...
                #XAxisType = "SpecSetVariable",
                XAxisDatalogPrefix = 'Base',
                XAxisParam =Spec(f'__shared__::TpRule.If_DS0_DS1_M("cpu_tstprt_o_stb_mul","p_cpu_tstprt_o_stb_mul","p_cpu_tstprt_o_stb_mul","p_cpu_tstprt_o_stb_mul")'),
                XAxisParamType = 'TimingTestCondition',
                XAxisRange = testinput.get("xaxisrange", ""),
                #YAxisType = 'FIVR',
                #YAxisDatalogPrefix = 'Base',
