...
def get_test_pattern_wto(content_list):
   ...
   for test_type, test_parms in content_list.items():
      test_list_pattern_wto.append(PatternDelayOptimizer(name=f'SBFT_CORE_VMIN_E_FMINXCR_X_CR_F1_X_MLC_WTO',
         ...
         #TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core_n2p","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core")'),
         TimingsTc = "FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core_n2p",
...
####################################################################################
def get_test_apextc_1100(corner, FlowMatrix, subflow, hptp, content_list):
     
   test_list_apextcflow1100 = []
  
   for test_type, test_parms in content_list.items():
      test_list_apextcflow1100.append(ApexTC(name=f'SBFT_CORE_VMIN_E_{subflow}_X_CR_{corner}_1100_{test_type}_APEX_FMAX',
         #InitialMaskBits = TrialParamSpec(f'FUN_CORE_{sku}_Specs.Apex_Multipass'),
         StepSize = 1,
         InitialMaskBits = "1100",
         #ExecutionMaxFailMode = "AbortOnFail",
         DtsConfiguration = test_parms.get("DtsConfiguration", Spec(f'__shared__::TpRule.If_DS0_DS1_M(FUN_CORE_{sku}_Specs.dtsconfig_s28cn2p, FUN_CORE_{sku}_Specs.dtsconfig_s52c, FUN_CORE_{sku}_Specs.dtsconfig_hx28c, FUN_CORE_{sku}_Specs.dtsconfig_hx28c)')),
         BypassPort = test_parms["Bypass"],
         Targets = "FCORE3,FCORE2,FCORE1,FCORE0",
         ForwardingMode = "Input",
         PinMap = test_parms.get("PinMap", Spec(f'FUN_CORE_{sku}_Specs.PinMap_FREQ_NONMISR')),
         FailCaptureCount = test_parms.get("FailCaptureCount", Spec(f'FUN_CORE_{sku}_Specs.FailCaptureCount_Stagger')),
         #SetPointsPostInstance = "MCdrv:R1_SET",
         SetPointsPreInstance = test_parms.get("SetPointsPreInstance", Spec(f'PSPRE.CR_F5+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{FlowMatrix}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F1_FREQ")+f'+"GHz,CORE:nblctrl_core_l2:nbloff,MCfun:DBGCNTR:FMAX,MCfun:ratio_modify:"'+f'+FUN_CORE_{sku}_Specs.{test_type}_FMAX')),
   ...
   return test_list_apextcflow1100

####################################################################################
def get_test_apextc_0011(corner, FlowMatrix, subflow, hptp, content_list):
     
   test_list_apextcflow0011 = []
  
   for test_type, test_parms in content_list.items():
      test_list_apextcflow0011.append(ApexTC(name=f'SBFT_CORE_VMIN_E_{subflow}_X_CR_{corner}_0011_{test_type}_APEX_FMAX',
         #InitialMaskBits = TrialParamSpec(f'FUN_CORE_{sku}_Specs.Apex_Multipass'),
         StepSize = 1,
         ...
         PinMap = test_parms.get("PinMap", Spec(f'FUN_CORE_{sku}_Specs.PinMap_FREQ_NONMISR')),
         #SetPointsPostInstance = "MCdrv:R1_SET",
         SetPointsPreInstance = test_parms.get("SetPointsPreInstance", Spec(f'PSPRE.CR_F5+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{FlowMatrix}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F1_FREQ")+f'+"GHz,CORE:nblctrl_core_l2:nbloff,MCfun:DBGCNTR:FMAX"')),
         SetPointsPostInstance = test_parms.get("SetPointsPostInstance", Spec(f'PSPOST.CR_F5+''",CORE:nblctrl_core_l2:nblon"')),
         LevelsTc = "CPU_IP_BASE::cpu_all_bf_x_x_ipc_lvl_min",
         #TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core_n2p","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core")'),
         TimingsTc = "FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core_n2p",
   ...
   return test_list_apextcflow0011
...
def get_test_list_fmin(flow, corner, FlowMatrix, subflow, hptp, content_list):
   ...
   for test_type, test_parms in content_list.items():
      test_list_fminflow.append(NativeMultiTrial(name=f"SBFT_CORE_VMIN_K_{subflow}_X_CR_{corner}_X_{test_type}",
         ...
         LevelsTc = "CPU_IP_BASE::cpu_all_bf_x_x_ipc_lvl_min",
         TimingsTc = "FUN_CORE_CX816::cpu_fun_timing_mts400_tstprtclk200_tck50_i_drv_mul_fun_CORE",
         Patlist = test_parms.get("Patlist", 'IPC::'f"fun_cdie_{subflow.lower()}_{test_type.lower()}_{hptp.lower()}_list"),
         #BaseNumbers = None if test_parms["IS_EDC"] else -44,
         BaseNumbers = -44,
         ...
         RecoveryTrackingIncoming = Spec(f'FUN_CORE_{sku}_Specs.CDIE0_Recovery_Tracking'),
         #RecoveryTrackingOutgoing = Spec(f'FUN_CORE_{sku}_Specs.CDIE0_Recovery_Tracking'),
         SetPointsPlistParamName = "Patlist",
         ...
         VminResult = Spec(f'"SBFT_{test_type}_CR3_FMIN_FF_SEARCH,SBFT_{test_type}_CR2_FMIN_FF_SEARCH,SBFT_{test_type}_CR1_FMIN_FF_SEARCH,SBFT_{test_type}_CR0_FMIN_FF_SEARCH"'),
         FlowIndex = TrialParamSpec(f"__shared__::FlowMatrix.FlowIndex"),
         SetPointsPreInstance = test_parms.get("SetPointsPreInstance", Spec(f'PSPRE.CR_{corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{FlowMatrix}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_{corner}")+f'+"GHz,MCfun:DBGCNTR:FMIN,"+'+Spec(f'FUN_CORE_{sku}_Specs.MCfun_FMIN_MASK_CR'))),
...
def get_test_list_f1_f4(flow, corner, corner_id, FlowMatrix, subflow, hptp, content_list):
   ...
   for test_type, test_parms in content_list.items():
      test_list_funflow.append(NativeMultiTrial(name=f"SBFT_CORE_VMIN_K_{subflow}_X_CR_{corner}_X_{test_type}",
         ...
         BaseNumbers = None if "SCR" in flow else -44,
         #CornerIdentifiers = f"CR3@{corner},CR2@{corner},CR1@{corner},CR0@{corner}",
...
####################################################################################
def get_test_list_f4M0M1(flow, corner, corner_id, FlowMatrix, subflow, hptp, content_list):
   ...
   for test_type, test_parms in content_list.items():
      test_list_funflowf4M0M1.append(NativeMultiTrial(name=f"SBFT_CORE_VMIN_K_{subflow}_X_CR_{corner}_X_{test_type}_M0M1",
         ...
         VoltageConverter = test_parms.get("VoltageConverter", Spec(f'FUN_CORE_{sku}_Specs.VoltageConverter_NBLRail' + f' + DROPOUT.CR_{corner}')),
         FlowIndex = TrialParamSpec(f"__shared__::FlowMatrix.FlowIndex"),
         SetPointsPreInstance = test_parms.get("SetPointsPreInstance", Spec(f'PSPRE.CR_{corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{FlowMatrix}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F1_FREQ")+f'+"GHz,MCfun:DBGCNTR:{corner},MCfun:ratio_modify:"'+Spec(f"+ FUN_CORE_{sku}_Specs.{test_type}_{corner}"))),
         SetPointsPostInstance = test_parms.get("SetPointsPostInstance", Spec(f'PSPOST.CR_{corner}')),
                        ), # Close the braces for the MTT Template
         r0=pFail(setbin=-44, ret=0, trialaction = Spec('__shared__::TpRule.MTT_Rule("Next","Exit")')),
         r1=pPass(setbin=-44, ret=1, trialaction = "Exit"),
...
####################################################################################
def get_test_list_f4M2M3(flow, corner, corner_id, FlowMatrix, subflow, hptp, content_list):
   ...
   for test_type, test_parms in content_list.items():
      test_list_funflowf4M2M3.append(NativeMultiTrial(name=f"SBFT_CORE_VMIN_K_{subflow}_X_CR_{corner}_X_{test_type}_M2M3",
         ...
         VoltageConverter = test_parms.get("VoltageConverter", Spec(f'FUN_CORE_{sku}_Specs.VoltageConverter_NBLRail' + f' + DROPOUT.CR_{corner}')),
         FlowIndex = TrialParamSpec(f"__shared__::FlowMatrix.FlowIndex"),
         SetPointsPreInstance = test_parms.get("SetPointsPreInstance", Spec(f'PSPRE.CR_{corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{FlowMatrix}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F1_FREQ")+f'+"GHz,MCfun:DBGCNTR:{corner}"')),
         SetPointsPostInstance = test_parms.get("SetPointsPostInstance", Spec(f'PSPOST.CR_{corner}')),
                        ), # Close the braces for the MTT Template
         r0=pFail(setbin=-44, ret=0, trialaction = Spec('__shared__::TpRule.MTT_Rule("Next","Exit")')),
         r1=pPass(setbin=-44, ret=1, trialaction = "Exit"),
...
def get_test_list(flow, corner, FlowMatrix, corner_id, subflow, hptp, content_list):
   ...
   for test_type, test_parms in content_list.items():
      test_list.append(NativeMultiTrial(name=f"SBFT_CORE_VMIN_K_{subflow}_X_CR_{FlowMatrix}_X_{test_type}", 
         ...
         template=VminTC(name=f'"SBFT_CORE_VMIN_K_{subflow}_X_CR_" + ' + Spec(f"__shared__::Corners.CR_{corner_id}") + f' + "_X_{test_type}"',
         BypassPort = test_parms["Bypass"],
...
def get_test_listM0M1(flow, corner, FlowMatrix, corner_id, subflow, hptp, content_list):
   ...
   for test_type, test_parms in content_list.items():
      test_list_M0M1.append(NativeMultiTrial(name=f"SBFT_CORE_VMIN_K_{subflow}_X_CR_{FlowMatrix}_X_{test_type}_M0M1", 
         ...
         trialvar = "CPU_TRIALS::FlowDomain.CORE_TOP",
         _comment='SpeedFlow F5_F7 VminTC test with MTT',
         template=VminTC(name=f'"SBFT_CORE_VMIN_K_{subflow}_X_CR_" + ' + Spec(f"__shared__::Corners.CR_{corner_id}") + '+ "_" +' + Spec(f"__shared__::FreqInMHZ.CR_{corner_id}") + f' + "_{test_type}_M0M1"',
         BypassPort = test_parms["Bypass"],
         #MultiPassMasks = Spec(f'FUN_CORE_{sku}_Specs.MultiPass'),
         InitialMaskBits = Spec(f'FUN_CORE_{sku}_Specs.InitialMaskEnM0M1'),
         ExecutionMode = "Search" if "SCR" in flow else "SearchWithScoreboard",
         ...
         LevelsTc = "CPU_IP_BASE::cpu_all_bf_x_x_ipc_lvl_min",
         #TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core_n2p","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core")'),
         #TimingsTc = Spec(f'__shared__::TpRule.If_PHMHOT(__shared__::TpRule.If_DS0_DS1_M("FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core_n2pphm","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core_n2pphm","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core"),__shared__::TpRule.If_DS0_DS1_M("FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core_n2p","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core"))'),
         TimingsTc = Spec(f'FUN_CORE_{sku}_Rules.If_PHMHOT(__shared__::TpRule.If_DS0_DS1_M("FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core_n2pphm","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core_n2pphm","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core"),__shared__::TpRule.If_DS0_DS1_M("FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core_n2p","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core_n2p","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core"))'),
         Patlist = test_parms.get("Patlist", 'IPC::'f"fun_cdie_{subflow.lower()}_{test_type.lower()}_{hptp.lower()}_list_master"),
         BaseNumbers = None if "SCR" in flow else -44,
         CornerIdentifiers = TrialParamSpec(Spec(f"__shared__::CornerIdentifiers.CR_{corner_id}")),
         EndVoltageLimits = Spec(f"__shared__::FlowMatrixSingular.CR_HIGH_SEARCH_VALUE"),
         ...
         #StartVoltagesForRetry = Spec(f'__shared__::QNRTpRuleShared.If_PseudoVminForwarding(__shared__::QNRUsrvShared.StartVoltagesForRetry , "")'),
         #StartVoltagesOffset = Spec(f'__shared__::QNRTpRuleShared.If_PseudoVminForwarding(__shared__::QNRUsrvShared.StartVoltagesOffset , "")'),
         LimitGuardband = "" if test_parms["IS_EDC"] else Spec(f'FUN_CORE_{sku}_Rules.If_PHMHOT("",toString(__shared__::GBVars.LimitGuardband))'),
         StepSize = Spec(f'toDouble(__shared__::FlowMatrixSingular.CR_SEARCH_RESOLUTION)'),
         PinMap = test_parms.get("PinMap", Spec(f'FUN_CORE_{sku}_Specs.PinMap_FREQ_NONMISR')),
         PatternNameCounterIndexes = Spec(f'FUN_CORE_{sku}_Specs.PatNameIndex'),
         RecoveryMode = Spec(f'FUN_CORE_{sku}_Specs.CORE_RecoveryMode_MTT'),
         ...
         VoltageConverter = test_parms.get("VoltageConverter", Spec(f'FUN_CORE_{sku}_Specs.VoltageConverter_NBLRail' + f' + DROPOUT.CR_{corner}')),
         FlowIndex = Spec(f"__shared__::FlowMatrixSingular.FlowIndex"),
         SetPointsPreInstance = test_parms.get("SetPointsPreInstance", TrialParamSpec(f'PSPRE.CR_{corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FreqValues.CR_{corner_id}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F1_FREQ")+f'+"GHz,MCfun:ratio_modify:"'+Spec(f"+ FUN_CORE_{sku}_Specs.{test_type}_{XCRF5_CornerID}")+f'+",MCfun:DBGCNTR:"'+Spec(f"+ __shared__::Corners.CR_{corner_id}"))),
         SetPointsPostInstance = test_parms.get("SetPointsPostInstance", Spec(f'PSPOST.CR_{corner}')),
                        ), # Close the braces for the MTT Template
         r0=pFail(setbin=-44, ret=0, trialaction = Spec('__shared__::TpRule.MTT_Rule("Next","Exit")')),
         r1=pPass(setbin=-44, ret=1, trialaction = "Exit"),
...
def get_test_listM2M3(flow, corner, FlowMatrix, corner_id, subflow, hptp, content_list):
   ...
   for test_type, test_parms in content_list.items():
      test_list_M2M3.append(NativeMultiTrial(name=f"SBFT_CORE_VMIN_K_{subflow}_X_CR_{FlowMatrix}_X_{test_type}_M2M3", 
         ...
         trialvar = "CPU_TRIALS::FlowDomain.CORE_TOP",
         _comment='SpeedFlow F5_F7 VminTC test with MTT',
         template=VminTC(name=f'"SBFT_CORE_VMIN_K_{subflow}_X_CR_" + ' + Spec(f"__shared__::Corners.CR_{corner_id}") + '+ "_" +' + Spec(f"__shared__::FreqInMHZ.CR_{corner_id}") + f' + "_{test_type}_M2M3"',
         BypassPort = test_parms["Bypass"],
         #MultiPassMasks = Spec(f'FUN_CORE_{sku}_Specs.MultiPass'),
         InitialMaskBits = Spec(f'FUN_CORE_{sku}_Specs.InitialMaskEnM2M3'),
         ExecutionMode = "Search" if "SCR" in flow else "SearchWithScoreboard",
         ...
         VoltageConverter = test_parms.get("VoltageConverter", Spec(f'FUN_CORE_{sku}_Specs.VoltageConverter_NBLRail' + f' + DROPOUT.CR_{corner}')),
         FlowIndex = Spec(f"__shared__::FlowMatrixSingular.FlowIndex"),
         SetPointsPreInstance = test_parms.get("SetPointsPreInstance", TrialParamSpec(f'PSPRE.CR_{corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FreqValues.CR_{corner_id}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F1_FREQ")+f'+"GHz,MCfun:funcore_corefreq0:0.8GHz,MCfun:funcore_corefreq1:0.8GHz,MCfun:DBGCNTR:"'+Spec(f"+ __shared__::Corners.CR_{corner_id}"))),
         SetPointsPostInstance = test_parms.get("SetPointsPostInstance", Spec(f'PSPOST.CR_{corner}')),
                        ), # Close the braces for the MTT Template
         r0=pFail(setbin=-44, ret=0, trialaction = Spec('__shared__::TpRule.MTT_Rule("Next","Exit")')),
         r1=pPass(setbin=-44, ret=1, trialaction = "Exit"),
...
def get_test_vmax(flow, corner, FlowMatrix, subflow, hptp, content_list, freq):
   ...
   for test_type, test_parms in content_list.items():
      test_list_vmaxflow.append(VminTC(name=f'SBFT_CORE_VMAX_K_{subflow}_X_CR_{corner}_X_{test_type}_{freq}',
         ...
         DtsConfiguration = test_parms.get("DtsConfiguration", Spec(f'__shared__::TpRule.If_DS0_DS1_M(FUN_CORE_{sku}_Specs.dtsconfig_s28cn2p, FUN_CORE_{sku}_Specs.dtsconfig_s52c, FUN_CORE_{sku}_Specs.dtsconfig_hx28c, FUN_CORE_{sku}_Specs.dtsconfig_hx28c)')),
         VoltageConverter = test_parms.get("VoltageConverter", Spec(f'"--overrides CORE3:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE2:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE1:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE0:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+ " --dlvrpins VCCIA --expressions "' + f' + DROPOUT.CR_F5')),
         SetPointsPreInstance = test_parms.get("SetPointsPreInstance", Spec(f'PSPRE.CR_F5+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{FlowMatrix}_FREQ+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F1_FREQ")+f'+"GHz,CORE:nblctrl_core_l2:nbloff,MCfun:DBGCNTR:{freq},MCfun:ratio_modify:"+FUN_CORE_{sku}_Specs.{test_type}_{freq}')),
         SetPointsPostInstance = test_parms.get("SetPointsPostInstance", Spec(f'PSPOST.CR_F5+''",CORE:nblctrl_core_l2:nblon"')),
         _fitem=Fitem('SAME', edc = test_parms["IS_EDC"],
                        r0 = pFail(setbin=-44),
                        r1 = pPass(setbin=-44, goto="NEXT"),
...
def get_test_vmaxf5M0M1(flow, corner, FlowMatrix, corner_id, subflow, hptp, content_list):
   ...
   for test_type, test_parms in content_list.items():
      test_list_vmaxflowf5M0M1.append(NativeMultiTrial(name=f'SBFT_CORE_VMAX_K_{subflow}_X_CR_{FlowMatrix}_{test_type}_M0M1',
		 ...
		 template=VminTC(name=f'"SBFT_CORE_VMAX_K_{subflow}_X_CR_" + ' + Spec(f"__shared__::Corners.CR_{corner_id}") + '+ "_" +' + Spec(f"__shared__::FreqInMHZ.CR_{corner_id}") + f' + "_{test_type}_M0M1"',
         BypassPort = test_parms["Bypass"],
         ExecutionMode = "Search" if "SCR" in flow else "SearchWithScoreboard",
         FlowIndex = Spec(f"__shared__::FlowMatrixSingular.FlowIndex"),
         TestMode = "Scoreboard",
         ...
         Patlist = test_parms.get("Patlist", 'IPC::'f"fun_cdie_{subflow.lower()}_{test_type.lower()}_{hptp.lower()}_list"),
         BaseNumbers = None if "SCR" in flow else -44,
         EndVoltageLimits = Spec(f'__shared__::FlowMatrixSingular.CR_VMAX_VALUE+","+__shared__::FlowMatrixSingular.CR_VMAX_VALUE+","+__shared__::FlowMatrixSingular.CR_VMAX_VALUE+","+__shared__::FlowMatrixSingular.CR_VMAX_VALUE'),
         StartVoltages = Spec(f'__shared__::FlowMatrixSingular.CR_VMAX_VALUE+","+__shared__::FlowMatrixSingular.CR_VMAX_VALUE+","+__shared__::FlowMatrixSingular.CR_VMAX_VALUE+","+__shared__::FlowMatrixSingular.CR_VMAX_VALUE'),
         #LimitGuardband = Spec(f'toString(__shared__::GBVars.LimitGuardband)'),
         LimitGuardband = "" if test_parms["IS_EDC"] else Spec(f'FUN_CORE_{sku}_Rules.If_PHMHOT("",toString(__shared__::GBVars.LimitGuardband))'),
         StepSize = Spec(f'toDouble(__shared__::FlowMatrixSingular.CR_SEARCH_RESOLUTION)'),
         PinMap = test_parms.get("PinMap", Spec(f'FUN_CORE_{sku}_Specs.PinMap_FREQ_NONMISR')),
...
def get_test_vmaxf5M2M3(flow, corner, FlowMatrix, corner_id, subflow, hptp, content_list):
   ...
   for test_type, test_parms in content_list.items():
      test_list_vmaxflowf5M2M3.append(NativeMultiTrial(name=f'SBFT_CORE_VMAX_K_{subflow}_X_CR_{FlowMatrix}_{test_type}_M2M3',
		 ...
		 trialvar = "CPU_TRIALS::FlowDomain.CORE_TOP",
		 _comment='VMAX F5_F7 VminTC test with MTT',
		 template=VminTC(name=f'"SBFT_CORE_VMAX_K_{subflow}_X_CR_" + ' + Spec(f"__shared__::Corners.CR_{corner_id}") + '+ "_" +' + Spec(f"__shared__::FreqInMHZ.CR_{corner_id}") + f' + "_{test_type}_M2M3"',
         BypassPort = 1,
         ExecutionMode = "Search" if "SCR" in flow else "SearchWithScoreboard",
         FlowIndex = Spec(f"__shared__::FlowMatrixSingular.FlowIndex"),
         TestMode = "Scoreboard",
         ...
         Patlist = test_parms.get("Patlist", 'IPC::'f"fun_cdie_{subflow.lower()}_{test_type.lower()}_{hptp.lower()}_list"),
         BaseNumbers = None if "SCR" in flow else -44,
         EndVoltageLimits = Spec(f'__shared__::FlowMatrixSingular.CR_VMAX_VALUE+","+__shared__::FlowMatrixSingular.CR_VMAX_VALUE+",0.8,0.8"'),
         StartVoltages = Spec(f'__shared__::FlowMatrixSingular.CR_VMAX_VALUE+","+__shared__::FlowMatrixSingular.CR_VMAX_VALUE+",0.8,0.8"'),
         #LimitGuardband = Spec(f'toString(__shared__::GBVars.LimitGuardband)'),
         LimitGuardband = "" if test_parms["IS_EDC"] else Spec(f'FUN_CORE_{sku}_Rules.If_PHMHOT("",toString(__shared__::GBVars.LimitGuardband))'),
         StepSize = Spec(f'toDouble(__shared__::FlowMatrixSingular.CR_SEARCH_RESOLUTION)'),
         PinMap = test_parms.get("PinMap", Spec(f'FUN_CORE_{sku}_Specs.PinMap_FREQ_NONMISR')),
         ...
         DtsConfiguration = test_parms.get("DtsConfiguration", Spec(f'__shared__::TpRule.If_DS0_DS1_M(FUN_CORE_{sku}_Specs.dtsconfig_s28cn2p, FUN_CORE_{sku}_Specs.dtsconfig_s52c, FUN_CORE_{sku}_Specs.dtsconfig_hx28c, FUN_CORE_{sku}_Specs.dtsconfig_hx28c)')),
         VoltageConverter = test_parms.get("VoltageConverter", Spec(f'"--overrides CORE3:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE2:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+ " --dlvrpins VCCIA --expressions "' + f' + DROPOUT.CR_F5')),
         SetPointsPreInstance = test_parms.get("SetPointsPreInstance", TrialParamSpec(f'PSPRE.CR_{corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FreqValues.CR_{corner_id}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F1_FREQ")+f'+"GHz,CORE:nblctrl_core_l2:nbloff,MCfun:funcore_corefreq0:0.8GHz,MCfun:funcore_corefreq1:0.8GHz,MCfun:DBGCNTR:"'+Spec(f"+ __shared__::Corners.CR_{corner_id}"))),
         SetPointsPostInstance = test_parms.get("SetPointsPostInstance", Spec(f'PSPOST.CR_F5+''",CORE:nblctrl_core_l2:nblon"')),
                        ), # Close the braces for the MTT Template
         r0=pFail(setbin=-44, ret=0, trialaction = "Exit"),
         r1=pPass(setbin=-44, ret=1, trialaction = "Exit"),
...
def get_test_listM0M1_LTTC(flow, corner, FlowMatrix, corner_id, subflow, hptp, content_list):
     
   test_list_M0M1_LTTC = []
  
   for test_type, test_parms in content_list.items():
      test_list_M0M1_LTTC.append(NativeMultiTrial(name=f"SBFT_CORE_VMIN_K_{subflow}_X_CR_{FlowMatrix}_X_{test_type}_M0M1", 
         ...
         VoltageConverter = test_parms.get("VoltageConverter", Spec(f'FUN_CORE_{sku}_Specs.VoltageConverter_NBLRail' + f' + DROPOUT.CR_{corner}')),
         FlowIndex = Spec(f"__shared__::FlowMatrixSingular.FlowIndex"),
         SetPointsPreInstance = test_parms.get("SetPointsPreInstance", TrialParamSpec(f'PSPRE.CR_{corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FreqValues.CR_{corner_id}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F1_FREQ")+f'+"GHz,MCfun:DBGCNTR:"'+Spec(f"+ __shared__::Corners.CR_{corner_id}")+f'+",MCfun:ratio_modify:"'+Spec(f"+FUN_CORE_{sku}_Specs.{test_type}_{corner_id}"))),
         SetPointsPostInstance = test_parms.get("SetPointsPostInstance", Spec(f'PSPOST.CR_{corner}')),
                        ), # Close the braces for the MTT Template
         r0=pFail(setbin=-44, ret=0, trialaction = "Exit"),
         r1=pPass(setbin=-44, ret=1, trialaction = "Exit"),
   ...
   return test_list_M0M1_LTTC
####################################################################################

####################################################################################

def get_test_listM2M3_LTTC(flow, corner, FlowMatrix, corner_id, subflow, hptp, content_list):
     
   test_list_M2M3_LTTC = []
  
   for test_type, test_parms in content_list.items():
      test_list_M2M3_LTTC.append(NativeMultiTrial(name=f"SBFT_CORE_VMIN_K_{subflow}_X_CR_{FlowMatrix}_X_{test_type}_M2M3", 
...
def get_init_tck_list(subflow, hptp, content_list):
   ...
   for test_type, test_parms in content_list.items():
        test_list_init_tck.append(PrimePatConfigTestMethod(name=f"SBFT_CORE_PATMOD_K_INIT_X_X_X_X_TCK_{test_type}",
               ...
               ConfigurationFile = Spec(MODULEPATH +' + 'f'"./Modules/FUN/FUN_CORE_{sku}/InputFiles/N2P/FUN_CORE_Generic.PatConfigSetpoints.json"'),
...
def get_init_apextc_list(content_list):
   ...
   for test_type, test_parms in content_list.items():
        test_list_apextc_init.append(RunCallback(name=f"SBFT_CORE_RUNCALLBACK_K_INIT_X_X_X_X_{test_type}",
               #Parameters = Spec(f'__shared__::TpRule.If_DS0_DS1_M(GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "./Modules/FUN/FUN_CORE_CX816/InputFiles/N2P/ApexTC_Input_Config.json", GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "./Modules/FUN/FUN_CORE_CX816/InputFiles/ApexTC_Input_Config.json", GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "./Modules/FUN/FUN_CORE_CX816/InputFiles/ApexTC_Input_Config.json", GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "./Modules/FUN/FUN_CORE_CX816/InputFiles/ApexTC_Input_Config.json")'),
               Parameters = Spec(MODULEPATH +' + 'f'"./Modules/FUN/FUN_CORE_CX816/InputFiles/N2P/ApexTC_Input_Config.json"'),
...
def get_shmoo_list(corner, content_list):
   ...
   for test_type, test_parms in content_list.items():
        test_list_shmoo.append(DDGShmooTC(name=f"SBFT_CORE_SHMOO_E_FMINXCR_X_CR_X_X_{test_type}_{corner}",
                ...
                SetPointsPreInstance = Spec(f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CR_{corner}_FREQ+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F1_FREQ")+f'+"GHz,MCdrv:R1_SET,MCfun:DBGCNTR:{corner},MCfun:ratio_modify:"+FUN_CORE_{sku}_Specs.{test_type}_{corner}'),
                #TimingsTc = Spec(f'__shared__::TpRule.If_DS0_DS1_M("FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core_n2p","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core","FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core")'),
                TimingsTc = "FUN_CORE_CX816::cpu_fun_timing_mts800_tstprtclk400_tck100_fun_core_n2p",
...
for sku in product_skus:                                                    # <<<<<<<< This one
    ...
    if sku == "CX816":
       ...
       #"MLC" : {"Bypass" : -1, "IS_EDC" : False, "SetPoint" : Spec(f'__shared__::TpRule.If_DS0_DS1_M("MLC_Wait_Times_MM_N2P", "MLC_Wait_Times_MM", "MLC_Wait_Times_MM", "MLC_Wait_Times_MM")')},
       "MLC" : {"Bypass" : -1, "IS_EDC" : False, "SetPoint" : "MLC_Wait_Times_MM_N2P"},
       "MLC_LS" : {"Bypass" : -1, "IS_EDC" : False}, #"SetPoint" : "MLC_LS_WTO_FINAL"},
       #"MLC_DRG" : {"Bypass" : -1, "IS_EDC" : False, "SetPoint" : "MLC_DRG_IS_Wait_Times_MM_N2P", "MLC_DRG_Wait_Times_MM", "MLC_DRG_Wait_Times_MM", "MLC_DRG_Wait_Times_MM")')},
       "MLC_DRG" : {"Bypass" : -1, "IS_EDC" : False, "SetPoint" : "MLC_DRG_IS_Wait_Times_MM_N2P"},
       #"MLC_DRG_IMPACTSTUDY" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, 1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : False},
       "MLC_DRG_IMPACTSTUDY" : {"Bypass" : 1, "IS_EDC" : False},
       "SLC" : {"Bypass" : -1, "IS_EDC" : False},
       "SLC_DRG" : {"Bypass" : -1, "IS_EDC" : False, 
       "SetPoint" :"SLC_DRG_IS_Wait_Times_MM_N2P"},
       #"SetPoint" : Spec(f'__shared__::TpRule.If_DS0_DS1_M("SLC_DRG_IS_Wait_Times_MM_N2P", "SLC_DRG_Wait_Times_MM", "SLC_DRG_Wait_Times_MM", "SLC_DRG_Wait_Times_MM")')},
       #"SLC_DRG_IMPACTSTUDY" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, 1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : False}
       ...
       #"MLC_DRG" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, 1, 1, 1)"), "IS_EDC" : False, "SetPoint" : "TCK_Override_V0", "Binning" : 4400},
       "MLC_DRG" : {"Bypass" : -1, "IS_EDC" : False, "SetPoint" : "TCK_Override_V0", "Binning" : 4400},
       #"SLC_DRG" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, 1, 1, 1)"), "IS_EDC" : False, "SetPoint" : "TCK_Override_V0_SLCDRG", "Binning" : 4400},
       "SLC_DRG" : {"Bypass" : -1, "IS_EDC" : False, "SetPoint" : "TCK_Override_V0_SLCDRG", "Binning" : 4400},
       #"MLC_DRG_IS" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, 1, 1, 1)"), "Plist" : "fun_cdie_f1xcr_mlc_drg_hptp800_list_master", "IS_EDC" : False, "SetPoint" : "TCK_Override_V0", "Binning" : 4400},
       "MLC_DRG_IS" : {"Bypass" : 1, "Plist" : "fun_cdie_f1xcr_mlc_drg_hptp800_list_master", "IS_EDC" : False, "SetPoint" : "TCK_Override_V0", "Binning" : 4400},
       #"SLC_DRG_IS" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, 1, 1, 1)"), "Plist" : "fun_cdie_f1xcr_slc_drg_hptp800_list_master", "IS_EDC" : False, "SetPoint" : "TCK_Override_V0_SLCDRG", "Binning" : 4400},
       "SLC_DRG_IS" : {"Bypass" : 1, "Plist" : "fun_cdie_f1xcr_slc_drg_hptp800_list_master", "IS_EDC" : False, "SetPoint" : "TCK_Override_V0_SLCDRG", "Binning" : 4400},
        }

        INIT_DTS_content_list = {
       #"MLC" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, 1, 1, 1)"), "IS_EDC" : False},
       "MLC" : {"Bypass" : -1, "IS_EDC" : False},
        }
    else:
        {
    ...
    PINMAP_COMP = Flow ("FUN_CORE_CX816_INIT_PINMAP", NONMISRPINMAP_INIT_Tests, MISRPINMAP_INIT_Tests)

    INIT_FUSE_Tests = get_init_fuse_list(INIT_SUBFLOW, HPTP, INIT_content_list)
    INIT_TEST_COMP = Flow("FUN_CORE_CX816_INIT_FUSE_PATMOD", INIT_FUSE_Tests)

    INIT_DC_Tests = get_init_debugcounter_list(INIT_SUBFLOW, HPTP, DebugCounter_Init_List)
    INIT_DC_COMP = Flow("FUN_CORE_CX816_INIT_DEBUG_COUNTER", INIT_DC_Tests)

    INIT_WT_Tests = get_init_waittime_list(INIT_SUBFLOW, HPTP, WaiTTime_content_list)
    INIT_WT_COMP = Flow("FUN_CORE_CX816_INIT_WAIT_TIME", INIT_WT_Tests)
    ...
    INIT_RAGN_COMP = Flow("FUN_CORE_CX816_INIT_RAGN_PATMOD", INIT_RAGN_Tests)
 
    INIT_VVAR_Tests = get_init_drg_vvar_list(INIT_SUBFLOW, HPTP, DRG_VVAR_list)
    INIT_VVAR_COMP = Flow("FUN_CORE_CX816_INIT_DRG_VVAR", INIT_VVAR_Tests)

    TCK_INIT_Tests = get_init_tck_list(INIT_SUBFLOW, HPTP, INIT_TCK_content_list)
    INIT_TCK_COMP = Flow("FUN_CORE_CX816_INIT_TCK", TCK_INIT_Tests)

    DTS_INIT_Tests = get_init_dts_list(INIT_SUBFLOW, HPTP, INIT_DTS_content_list)
    #INIT_DTS_COMP = Flow("FUN_CORE_CX816_INIT_DTS", DTS_INIT_Tests)
    ...
    INIT_Subflow = Flow(f"FUN_CORE_{sku}_INIT",
                        ...
                        #Fitem ('SAME', INIT_DTS_COMP, r0=pFail(ret=0), r1=pPass(goto="NEXT")),
                        DTS_INIT_Tests, SLCMASK_INIT,APEXTC_INIT_Tests, DEDC_INIT)
    #################################################################
    #         
    #                       XCRF5 SUBFLOW                      
    #
    ...
    if sku == "CX816":
        ...
        XCRF5_content_list = {
       "MLC" : {"Bypass" : -1, "IS_EDC" : False,
                "DtsConfiguration" : Spec(f'__shared__::TpRule.If_DS0_DS1_M(FUN_CORE_{sku}_Specs.dtsconfig_s28cn2p, FUN_CORE_{sku}_Specs.dtsconfig_s52c, FUN_CORE_{sku}_Specs.dtsconfig_hx28c, FUN_CORE_{sku}_Specs.dtsconfig_hx28c)')},
       "MLC_LS" : {"Bypass" : -1, "IS_EDC" : False,
                   "DtsConfiguration" : Spec(f'__shared__::TpRule.If_DS0_DS1_M(FUN_CORE_{sku}_Specs.dtsconfig_s28cn2p, FUN_CORE_{sku}_Specs.dtsconfig_s52c, FUN_CORE_{sku}_Specs.dtsconfig_hx28c, FUN_CORE_{sku}_Specs.dtsconfig_hx28c)')},
       "MLC_DRG" : {"Bypass" : -1, "IS_EDC" : False},
       "SLC" : {"Bypass" : -1, "IS_EDC" : False,
                "Patlist" : 'IPC::'f"fun_cdie_{XCRF5_SubFlow.lower()}_slc_hptp800_burstoff_list_master",
                "SetPointsPreInstance" : TrialParamSpec(f'PSPRE.CR_{XCRF5_Corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FreqValues.CR_{XCRF5_CornerID}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FreqValues.CCF_{XCRF5_CornerID}")+f'+"GHz,CCF:nblctrl_ccf:ccfnbloff,MCfun:DBGCNTR:{XCRF5_CornerID}"'),
       ...
       "MLC" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, -1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : True, "Binning" : 4450,
                "DtsConfiguration" : Spec(f'__shared__::TpRule.If_DS0_DS1_M(FUN_CORE_{sku}_Specs.dtsconfig_s28cn2p, FUN_CORE_{sku}_Specs.dtsconfig_s52c, FUN_CORE_{sku}_Specs.dtsconfig_hx28c, FUN_CORE_{sku}_Specs.dtsconfig_hx28c)')},
        }
       ...
       "MLC_LS" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, -1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : True, "Binning" : 4450,
                "DtsConfiguration" : Spec(f'__shared__::TpRule.If_DS0_DS1_M(FUN_CORE_{sku}_Specs.dtsconfig_s28cn2p, FUN_CORE_{sku}_Specs.dtsconfig_s52c, FUN_CORE_{sku}_Specs.dtsconfig_hx28c, FUN_CORE_{sku}_Specs.dtsconfig_hx28c)')},
        }
       ...
       "MLC_DRG" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, -1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : True, "Binning" : 4450},
       "MLC_DRG_IMPACTSTUDY" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, 1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : True, "Binning" : 4450}
        }
       ...
       "MLC_DRG_IMPACTSTUDY" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, 1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : True, "Binning" : 4450}
        ...
        ApexTCSLC1100_content_list = {
       "SLC" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, -1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : True,
        ...
        ApexTCSLC0011_content_list = {
       "SLC" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, -1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : True,
                "Patlist" : 'IPC::'f"fun_cdie_{XCRF5_SubFlow.lower()}_fmax_slc_hptp800_burstoff_list",
                "SetPointsPreInstance" : Spec(f'PSPRE.CR_F5+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{APEX_FlowMatrix}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F5_FREQ")+f'+"GHz,CORE:nblctrl_core_l2:nbloff,CCF:nblctrl_ccf:ccfnbloff,MCfun:DBGCNTR:FMAX"'),
                "SetPointsPostInstance" : Spec(f'PSPOST.CR_F5+''",CORE:nblctrl_core_l2:nblon,CCF:nblctrl_ccf:ccfnblon"'),
                "VoltageConverter" : Spec(f'"--overrides CORE3:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE2:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CCF:"+' +Spec(f"__shared__::FlowMatrixSingular.CCF_VMAX_VALUE")+ f'+" --railconfigurations CDIE_CCF_POWERMUX --dlvrpins VCCIA --expressions "' + f' + DROPOUT.CR_F5'),
                "Binning" : 4450},
        }

        ApexTCSLCDRG1100_content_list = {
       "SLC_DRG" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, -1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : True,
                    ...
                    "VoltageConverter" : Spec(f'"--overrides CORE1:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE0:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CCF:"+' +Spec(f"__shared__::FlowMatrixSingular.CCF_VMAX_VALUE")+ f'+" --railconfigurations CDIE_CCF_POWERMUX --dlvrpins VCCIA --expressions "' + f' + DROPOUT.CR_F5'),
                    "Binning" : 4450},
       "SLC_DRG_IMPACTSTUDY" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, 1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : True,
                    "Patlist" : 'IPC::'f"fun_cdie_{XCRF5_SubFlow.lower()}_fmax_slc_drg_impactstudy_hptp800_burstoff_list",
                    "SetPointsPreInstance" : Spec(f'PSPRE.CR_F5+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{APEX_FlowMatrix}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F5_FREQ")+f'+"GHz,CORE:nblctrl_core_l2:nbloff,CCF:nblctrl_ccf:ccfnbloff,MCfun:DBGCNTR:FMAX"'),
                    "SetPointsPostInstance" : Spec(f'PSPOST.CR_F5+''",CORE:nblctrl_core_l2:nblon,CCF:nblctrl_ccf:ccfnblon"'),
                    "VoltageConverter" : Spec(f'"--overrides CORE1:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE0:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CCF:"+' +Spec(f"__shared__::FlowMatrixSingular.CCF_VMAX_VALUE")+ f'+" --railconfigurations CDIE_CCF_POWERMUX --dlvrpins VCCIA --expressions "' + f' + DROPOUT.CR_F5'),
                    "Binning" : 4450}
        }
        ApexTCSLCDRG0011_content_list = {
       "SLC_DRG" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, -1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : True,
                    "Patlist" : 'IPC::'f"fun_cdie_{XCRF5_SubFlow.lower()}_fmax_slc_drg_hptp800_burstoff_list",
                    "SetPointsPreInstance" : Spec(f'PSPRE.CR_F5+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{APEX_FlowMatrix}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F5_FREQ")+f'+"GHz,CORE:nblctrl_core_l2:nbloff,CCF:nblctrl_ccf:ccfnbloff,MCfun:DBGCNTR:FMAX"'),
                    "SetPointsPostInstance" : Spec(f'PSPOST.CR_F5+''",CORE:nblctrl_core_l2:nblon,CCF:nblctrl_ccf:ccfnblon"'),
      ...
      "SLC" : {"Bypass" : 1, "IS_EDC" : False, "Binning" : 4450,
                "Patlist" : 'IPC::'f"fun_cdie_{XCRF5_SubFlow.lower()}_slc_hptp800_burstoff_list_master",
                "SetPointsPreInstance" : TrialParamSpec(f'PSPRE.CR_{XCRF5_Corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FreqValues.CR_{XCRF5_CornerID}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FreqValues.CCF_{XCRF5_CornerID}")+f'+"GHz,CCF:nblctrl_ccf:ccfnbloff,MCfun:funcore_corefreq0:0.8GHz,MCfun:funcore_corefreq1:0.8GHz,MCfun:DBGCNTR:"'+Spec(f"+ __shared__::Corners.CR_{XCRF5_CornerID}")),
                "SetPointsPostInstance" : Spec(f'PSPOST.CR_{XCRF5_Corner}+''",CCF:nblctrl_ccf:ccfnblon"'),
                "VoltageConverter" : Spec(f'"--overrides CCF:"+' +Spec(f"__shared__::FlowMatrixSingular.CCF_VMAX_VALUE")+ f' + ' +Spec(f'FUN_CORE_{sku}_Specs.VoltageConverter_NBLRailCCF') + f' + DROPOUT.CR_{XCRF5_Corner}')}
       }
       ...
       "SLC_DRG" : {"Bypass" : -1, "IS_EDC" : False, "Binning" : 4450,
                    ...
                    "SetPointsPostInstance" : Spec(f'PSPOST.CR_{XCRF5_Corner}+''",CCF:nblctrl_ccf:ccfnblon"'),
                    "VoltageConverter" : Spec(f'"--overrides CCF:"+' +Spec(f"__shared__::FlowMatrixSingular.CCF_VMAX_VALUE")+ f' + ' +Spec(f'FUN_CORE_{sku}_Specs.VoltageConverter_NBLRailCCF') + f' + DROPOUT.CR_{XCRF5_Corner}')},
       "SLC_DRG_IMPACTSTUDY" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, 1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : True, "Binning" : 4450,
                    "Patlist" : 'IPC::'f"fun_cdie_{XCRF5_SubFlow.lower()}_slc_drg_impactstudy_hptp800_burstoff_list_master",
                    "SetPointsPreInstance" : TrialParamSpec(f'PSPRE.CR_{XCRF5_Corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FreqValues.CR_{XCRF5_CornerID}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FreqValues.CCF_{XCRF5_CornerID}")+f'+"GHz,CCF:nblctrl_ccf:ccfnbloff,MCfun:DBGCNTR:"'+Spec(f"+ __shared__::Corners.CR_{XCRF5_CornerID}")),
                    "SetPointsPostInstance" : Spec(f'PSPOST.CR_{XCRF5_Corner}+''",CCF:nblctrl_ccf:ccfnblon"'),
                    "VoltageConverter" : Spec(f'"--overrides CCF:"+' +Spec(f"__shared__::FlowMatrixSingular.CCF_VMAX_VALUE")+ f' + ' +Spec(f'FUN_CORE_{sku}_Specs.VoltageConverter_NBLRailCCF') + f' + DROPOUT.CR_{XCRF5_Corner}'), 
                    "FailCaptureCount" : Spec(f'FUN_CORE_{sku}_Specs.FailCaptureCount_DRG_IS'), 
                    "FeatureSwitchSettings" : Spec(f'FUN_CORE_{sku}_Specs.FeatureSwitchSettings_DRG_IS')}
      ...
      #"DRG" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, 1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : True},
    ...
    APEXMLC_1100_Tests = get_test_apextc_1100(APEX_Corner, APEX_FlowMatrix, XCRF5_SubFlow, HPTP, ApexTCMLC1100_content_list)
    APEXMLC_0011_Tests = get_test_apextc_0011(APEX_Corner, APEX_FlowMatrix, XCRF5_SubFlow, HPTP, ApexTCMLC0011_content_list)
    FMAX_MLC = Flow("FMAX_MLC", APEXMLC_1100_Tests, APEXMLC_0011_Tests)

    APEXMLCLS_1100_Tests = get_test_apextc_1100(APEX_Corner, APEX_FlowMatrix, XCRF5_SubFlow, HPTP, ApexTCMLCLS1100_content_list)
    APEXMLCLS_0011_Tests = get_test_apextc_0011(APEX_Corner, APEX_FlowMatrix, XCRF5_SubFlow, HPTP, ApexTCMLCLS0011_content_list)
    FMAX_MLCLS = Flow("FMAX_MLCLS", APEXMLCLS_1100_Tests, APEXMLCLS_0011_Tests)

    APEXMLCDRG_1100_Tests = get_test_apextc_1100(APEX_Corner, APEX_FlowMatrix, XCRF5_SubFlow, HPTP, ApexTCMLCDRG1100_content_list)
    APEXMLCDRG_0011_Tests = get_test_apextc_0011(APEX_Corner, APEX_FlowMatrix, XCRF5_SubFlow, HPTP, ApexTCMLCDRG0011_content_list)
    FMAX_MLCDRG = Flow("FMAX_MLCDRG", APEXMLCDRG_1100_Tests, APEXMLCDRG_0011_Tests)

    APEXSLC_1100_Tests = get_test_apextc_1100(APEX_Corner, APEX_FlowMatrix, XCRF5_SubFlow, HPTP, ApexTCSLC1100_content_list)
    APEXSLC_0011_Tests = get_test_apextc_0011(APEX_Corner, APEX_FlowMatrix, XCRF5_SubFlow, HPTP, ApexTCSLC0011_content_list)
    FMAX_SLC = Flow("FMAX_SLC", APEXSLC_1100_Tests, APEXSLC_0011_Tests)

    APEXSLCDRG_1100_Tests = get_test_apextc_1100(APEX_Corner, APEX_FlowMatrix, XCRF5_SubFlow, HPTP, ApexTCSLCDRG1100_content_list)
    APEXSLCDRG_0011_Tests = get_test_apextc_0011(APEX_Corner, APEX_FlowMatrix, XCRF5_SubFlow, HPTP, ApexTCSLCDRG0011_content_list)
    FMAX_SLCDRG = Flow("FMAX_SLCDRG", APEXSLCDRG_1100_Tests, APEXSLCDRG_0011_Tests)

    APEX_COMP = Flow("FUN_CORE_CX816_FMAX",
                     Fitem ('SAME', FMAX_MLC, r0=pFail(goto="NEXT" ), r1=pPass(goto="NEXT")),
                     Fitem ('SAME', FMAX_MLCLS, r0=pFail(goto="NEXT" ), r1=pPass(goto="NEXT")),
                     Fitem ('SAME', FMAX_MLCDRG, r0=pFail(goto="NEXT" ), r1=pPass(goto="NEXT")),
                     Fitem ('SAME', FMAX_SLC, r0=pFail(goto="NEXT" ), r1=pPass(goto="NEXT")),
                     Fitem ('SAME', FMAX_SLCDRG, r0=pFail(goto="NEXT" ), r1=pPass(goto="NEXT")))
    ...
    if sku == "CX816":
       ...
       "MLC_DRG" : {"Bypass" : -1, "IS_EDC" : False,
                    "EndVoltageLimits" : Spec(f"__shared__::TpRule.If_CHOT(__shared__::FlowMatrixSingular.CR_LFM_VMIN_RAIN_KILL,__shared__::FlowMatrixSingular.CR_HIGH_SEARCH_VALUE)")},
       "MLC_DRG_IMPACTSTUDY" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, 1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : True, 
                                "FailCaptureCount" : Spec(f'FUN_CORE_{sku}_Specs.FailCaptureCount_DRG_IS'), 
                                "FeatureSwitchSettings" : Spec(f'FUN_CORE_{sku}_Specs.FeatureSwitchSettings_DRG_IS'),
                                "EndVoltageLimits" : Spec(f"__shared__::TpRule.If_CHOT(__shared__::FlowMatrixSingular.CR_LFM_VMIN_RAIN_KILL,__shared__::FlowMatrixSingular.CR_HIGH_SEARCH_VALUE)")},
       "MLC_LS" : {"Bypass" : -1, "IS_EDC" : False,
       ...
       "SLC" : {"Bypass" : -1, "IS_EDC" : False,
        ...
        XCRF1_misr_list = {
       "MLC_LS_MISR" : {"Bypass" : 1, "IS_EDC" : True, "Binning" : 4450},
        }
    else:
        {
            }
    ...
    if sku == "CX816":
       ...
       "SLC" : {"Bypass" : -1, "IS_EDC" : False,
        ...
        XCRF3_misr_list = {
       "MLC_LS_MISR" : {"Bypass" : 1, "IS_EDC" : True, "Binning" : 4450, "EndVoltageLimits" : Spec(f"__shared__::FlowMatrixSingular.CR_HIGH_SEARCH_VALUE")},
        }
    else:
        {
            }
    ...
    if sku == "CX816":
       ...
       "SLC_DRG_IMPACTSTUDY" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, 1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : True,
                    "DtsConfiguration" : Spec(f'__shared__::TpRule.If_DS0_DS1_M(FUN_CORE_{sku}_Specs.dtsconfig_s28cn2p, FUN_CORE_{sku}_Specs.dtsconfig_s52c, FUN_CORE_{sku}_Specs.dtsconfig_hx28c, FUN_CORE_{sku}_Specs.dtsconfig_hx28c)'),
                    "Patlist" : 'IPC::'f"fun_cdie_{XCRF4_Subflow.lower()}_slc_drg_impactstudy_hptp800_burstoff_list_master",
                    "FailCaptureCount" : Spec(f'FUN_CORE_{sku}_Specs.FailCaptureCount_DRG_IS'), 
                    "FeatureSwitchSettings" : Spec(f'FUN_CORE_{sku}_Specs.FeatureSwitchSettings_DRG_IS'),
                    "SetPointsPreInstance" : Spec(f'PSPRE.CR_{XCRF4_Corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{XCRF4_FlowMatrix}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_{XCRF4_Corner}_FREQ")+f'+"GHz,CCF:nblctrl_ccf:ccfnbloff,MCfun:DBGCNTR:{XCRF4_Corner},MCfun:ratio_modify:"+FUN_CORE_{sku}_Specs.SLC_DRG_{XCRF4_Corner}'),
                    "SetPointsPostInstance" : Spec(f'PSPOST.CR_{XCRF4_Corner}+''",CCF:nblctrl_ccf:ccfnblon"'),
    ...
    XCRF4M0M1_MLC_Tests = get_test_list_f4M0M1(XCRF4_Flow, XCRF4_Corner, XCRF4_CornerID, XCRF4_FlowMatrix, XCRF4_Subflow, HPTP, XCRF4_MLC_content_list)
    XCRF4M2M3_MLC_Tests = get_test_list_f4M2M3(XCRF4_Flow, XCRF4_Corner, XCRF4_CornerID, XCRF4_FlowMatrix, XCRF4_Subflow, HPTP, XCRF4_MLC_content_list)
    F4XCRMLC = Flow("F4XCR_SBFT_MLC", XCRF4M0M1_MLC_Tests, XCRF4M2M3_MLC_Tests)

    XCRF4M0M1_MLC_LS_Tests = get_test_list_f4M0M1(XCRF4_Flow, XCRF4_Corner, XCRF4_CornerID, XCRF4_FlowMatrix, XCRF4_Subflow, HPTP, XCRF4_MLC_LS_content_list)
    XCRF4M2M3_MLC_LS_Tests = get_test_list_f4M2M3(XCRF4_Flow, XCRF4_Corner, XCRF4_CornerID, XCRF4_FlowMatrix, XCRF4_Subflow, HPTP, XCRF4_MLC_LS_content_list)
    F4XCRMLCLS = Flow("F4XCR_SBFT_MLCLS", XCRF4M0M1_MLC_LS_Tests, XCRF4M2M3_MLC_LS_Tests)

    XCRF4M0M1_MLC_DRG_Tests = get_test_list_f4M0M1(XCRF4_Flow, XCRF4_Corner, XCRF4_CornerID, XCRF4_FlowMatrix, XCRF4_Subflow, HPTP, XCRF4_MLC_DRG_content_list)
    XCRF4M2M3_MLC_DRG_Tests = get_test_list_f4M2M3(XCRF4_Flow, XCRF4_Corner, XCRF4_CornerID, XCRF4_FlowMatrix, XCRF4_Subflow, HPTP, XCRF4_MLC_DRG_content_list)
    F4XCRMLCDRG = Flow("F4XCR_SBFT_MLCDRG", XCRF4M0M1_MLC_DRG_Tests, XCRF4M2M3_MLC_DRG_Tests)

    XCRF4M0M1_SLC_Tests = get_test_list_f4M0M1(XCRF4_Flow, XCRF4_Corner, XCRF4_CornerID, XCRF4_FlowMatrix, XCRF4_Subflow, HPTP, XCRF4_SLC_content_list)
    XCRF4M2M3_SLC_Tests = get_test_list_f4M2M3(XCRF4_Flow, XCRF4_Corner, XCRF4_CornerID, XCRF4_FlowMatrix, XCRF4_Subflow, HPTP, XCRF4_SLC_content_list)
    F4XCRSLC = Flow("F4XCR_SBFT_SLC", XCRF4M0M1_SLC_Tests, XCRF4M2M3_SLC_Tests)

    XCRF4M0M1_SLC_DRG_Tests = get_test_list_f4M0M1(XCRF4_Flow, XCRF4_Corner, XCRF4_CornerID, XCRF4_FlowMatrix, XCRF4_Subflow, HPTP, XCRF4_SLC_DRG_content_list)
    XCRF4M2M3_SLC_DRG_Tests = get_test_list_f4M2M3(XCRF4_Flow, XCRF4_Corner, XCRF4_CornerID, XCRF4_FlowMatrix, XCRF4_Subflow, HPTP, XCRF4_SLC_DRG_content_list)
    ...
    if sku == "CX816":
       ...
       "SLC_DRG" : {"Bypass" : 1, "IS_EDC" : True,
                    ...
                    "SetPointsPreInstance" : Spec(f'PSPRE.CR_{XCRLOF4_Corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{XCRLOF4_FlowMatrix}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_{XCRLOF4_Corner}_FREQ")+f'+"GHz,CCF:nblctrl_ccf:ccfnbloff,MCfun:DBGCNTR:{XCRLOF4_Corner}"'),
    ...
    if sku == "CX816":
       ...
       "MLC" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, 1, -1, 1)"), "IS_EDC" : False,
       "SetPointsPreInstance" : Spec(f'PSPRE.CR_{FMIN_Corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{FMIN_FlowMatrix}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_{FMIN_Corner}")+f'+"GHz,MCfun:ratio_modify:"+FUN_CORE_{sku}_Specs.MLC_FMIN+",MCfun:DBGCNTR:FMIN,"+'+Spec(f'FUN_CORE_{sku}_Specs.MCfun_FMIN_MASK_CR'))},
       }
        FMIN_MLCLS_content_list = {
       "MLC_LS" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, 1, -1, 1)"), "IS_EDC" : False,
       "SetPointsPreInstance" : Spec(f'PSPRE.CR_{FMIN_Corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{FMIN_FlowMatrix}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_{FMIN_Corner}")+f'+"GHz,MCfun:ratio_modify:"+FUN_CORE_{sku}_Specs.MLC_LS_FMIN+",MCfun:DBGCNTR:FMIN,"+'+Spec(f'FUN_CORE_{sku}_Specs.MCfun_FMIN_MASK_CR'))},
       }
        FMIN_MLCDRG_content_list = {
       "MLC_DRG" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, 1, -1, 1)"), "IS_EDC" : False,
                    "SetPointsPreInstance" : Spec(f'PSPRE.CR_{FMIN_Corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{FMIN_FlowMatrix}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_{FMIN_Corner}")+f'+"GHz,MCfun:ratio_modify:"+FUN_CORE_{sku}_Specs.MLC_DRG_FMIN+",MCfun:DBGCNTR:FMIN,"+'+Spec(f'FUN_CORE_{sku}_Specs.MCfun_FMIN_MASK_CR'))},
       "MLC_DRG_IMPACTSTUDY" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, 1, BYPASS_PARAMETER.APEXTC_BYPASS, 1)"), "IS_EDC" : True, 
                                "FailCaptureCount" : Spec(f'FUN_CORE_{sku}_Specs.FailCaptureCount_DRG_IS'), 
                                "FeatureSwitchSettings" : Spec(f'FUN_CORE_{sku}_Specs.FeatureSwitchSettings_DRG_IS'),
                                "SetPointsPreInstance" : Spec(f'PSPRE.CR_{FMIN_Corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{FMIN_FlowMatrix}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_{FMIN_Corner}")+f'+"GHz,MCfun:ratio_modify:"+FUN_CORE_{sku}_Specs.MLC_DRG_FMIN+",MCfun:DBGCNTR:FMIN,"+'+Spec(f'FUN_CORE_{sku}_Specs.MCfun_FMIN_MASK_CR'))},
       ...
       "SLC" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, 1, -1, 1)"), "IS_EDC" : False,
                "Patlist" : 'IPC::'f"fun_cdie_{FMIN_Subflow.lower()}_slc_hptp800_burstoff_list",
       ...
       "SLC_DRG" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, 1, -1, 1)"), "IS_EDC" : False,
                    "Patlist" : 'IPC::'f"fun_cdie_{FMIN_Subflow.lower()}_slc_drg_hptp800_burstoff_list",
    ...
    SHMOO_COMPF1 = Flow("FUN_CORE_CX816_SHMOO_F1", SHMOO_TestsF1)
    SHMOO_COMPF2 = Flow("FUN_CORE_CX816_SHMOO_F2", SHMOO_TestsF2)
    SHMOO_COMPF3 = Flow("FUN_CORE_CX816_SHMOO_F3", SHMOO_TestsF3)
    SHMOO_COMPF4 = Flow("FUN_CORE_CX816_SHMOO_F4", SHMOO_TestsF4)
    SHMOO_COMPF5 = Flow("FUN_CORE_CX816_SHMOO_F5", SHMOO_TestsF5)
    SHMOO_COMPF6 = Flow("FUN_CORE_CX816_SHMOO_F6", SHMOO_TestsF6)
    SHMOO_COMPF7 = Flow("FUN_CORE_CX816_SHMOO_F7", SHMOO_TestsF7)

    SHMOO_TEST = Flow("FUN_CORE_CX816_SHMOO",
    ...
    if sku == "CX816":
       ...
       "SLC" : {"Bypass" :  -1, "IS_EDC" : True,
                ...
                "SetPointsPreInstance" : Spec(f'PSPRE.CR_F5+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{VMAXF5_FlowMatrix}_FREQ+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F5_FREQ")+f'+"GHz,CORE:nblctrl_core_l2:nbloff,CCF:nblctrl_ccf:ccfnbloff"'),
                "SetPointsPostInstance" : Spec(f'PSPOST.CR_F5+''",CORE:nblctrl_core_l2:nblon,CCF:nblctrl_ccf:ccfnblon"'),
                "VoltageConverter" : Spec(f'"--overrides CORE3:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE2:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE1:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE0:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CCF:"+' +Spec(f"__shared__::FlowMatrixSingular.CCF_VMAX_VALUE")+ f'+" --railconfigurations CDIE_CCF_POWERMUX --dlvrpins VCCIA --expressions "' + f' + DROPOUT.CR_F5')},
       "SLC_DRG" : {"Bypass" :  -1, "IS_EDC" : True,
        ...
        VMAXF1_content_list = {
       "MLC" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, 1, -1, 1)"), "IS_EDC" : False,
                "SetPointsPreInstance" : Spec(f'PSPRE.CR_F1+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{VMAXF1_FlowMatrix}_FREQ+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F1_FREQ")+f'+"GHz,CORE:nblctrl_core_l2:nbloff,MCfun:DBGCNTR:F1,MCfun:ratio_modify:"+FUN_CORE_{sku}_Specs.MLC_F1'),
                "SetPointsPostInstance" : Spec(f'PSPOST.CR_F1+''",CORE:nblctrl_core_l2:nblon"'),
                "VoltageConverter" : Spec(f'"--overrides CORE3:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE2:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE1:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE0:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+ " --dlvrpins VCCIA --expressions "' + f' + DROPOUT.CR_F1')},
       "MLC_LS" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, 1, -1, 1)"), "IS_EDC" : False,
                "SetPointsPreInstance" : Spec(f'PSPRE.CR_F1+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{VMAXF1_FlowMatrix}_FREQ+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F1_FREQ")+f'+"GHz,CORE:nblctrl_core_l2:nbloff,MCfun:DBGCNTR:F1,MCfun:ratio_modify:"+FUN_CORE_{sku}_Specs.MLC_LS_F1'),
                "SetPointsPostInstance" : Spec(f'PSPOST.CR_F1+''",CORE:nblctrl_core_l2:nblon"'),
                "VoltageConverter" : Spec(f'"--overrides CORE3:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE2:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE1:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE0:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+ " --dlvrpins VCCIA --expressions "' + f' + DROPOUT.CR_F1')},
       "MLC_DRG" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, 1, -1, 1)"), "IS_EDC" : False,
                "SetPointsPreInstance" : Spec(f'PSPRE.CR_F1+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.{VMAXF1_FlowMatrix}_FREQ+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FlowMatrixSingular.CCF_F1_FREQ")+f'+"GHz,CORE:nblctrl_core_l2:nbloff,MCfun:DBGCNTR:F1,MCfun:ratio_modify:"+FUN_CORE_{sku}_Specs.MLC_DRG_F1'),
                "SetPointsPostInstance" : Spec(f'PSPOST.CR_F1+''",CORE:nblctrl_core_l2:nblon"'),
                "VoltageConverter" : Spec(f'"--overrides CORE3:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE2:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE1:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE0:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+ " --dlvrpins VCCIA --expressions "' + f' + DROPOUT.CR_F1')},
       "SLC" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, 1, -1, 1)"), "IS_EDC" : False,
                "Patlist" : 'IPC::'f"fun_cdie_{VMAX_Subflow.lower()}_slc_hptp800_burstoff_list",
       ...
       "SLC" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, 1, -1, 1)"), "IS_EDC" : False,
        ...
        VMAXF5_SLC_DRG_content_M0M1_list = {
       "SLC_DRG" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(-1, 1, -1, 1)"), "IS_EDC" : True,
                    "Patlist" : 'IPC::'f"fun_cdie_{VMAX_Subflow.lower()}_slc_drg_hptp800_burstoff_list",
        ...
        VMAXF5_SLC_content_M2M3_list = {
       "SLC" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, 1, -1, 1)"), "IS_EDC" : False,
                "Patlist" : 'IPC::'f"fun_cdie_{VMAX_Subflow.lower()}_slc_hptp800_burstoff_list",
                "SetPointsPreInstance" : TrialParamSpec(f'PSPRE.CR_{VMAXXCRF5_Corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FreqValues.CR_{VMAXXCRF5_CornerID}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FreqValues.CCF_{VMAXXCRF5_CornerID}")+f'+"GHz,CORE:nblctrl_core_l2:nbloff,CCF:nblctrl_ccf:ccfnbloff,MCfun:funcore_corefreq0:0.8GHz,MCfun:funcore_corefreq1:0.8GHz,MCfun:DBGCNTR:"'+Spec(f"+ __shared__::Corners.CR_{VMAXXCRF5_CornerID}")),
                "SetPointsPostInstance" : Spec(f'PSPOST.CR_F5+''",CORE:nblctrl_core_l2:nblon,CCF:nblctrl_ccf:ccfnblon"'),
                "VoltageConverter" : Spec(f'"--overrides CORE3:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CORE2:"+' +Spec(f"__shared__::FlowMatrixSingular.CR_VMAX_VALUE")+ f'+",CCF:"+' +Spec(f"__shared__::FlowMatrixSingular.CCF_VMAX_VALUE")+ f'+" --railconfigurations CDIE_CCF_POWERMUX --dlvrpins VCCIA --expressions "' + f' + DROPOUT.CR_F5')},
       }
        VMAXF5_SLC_DRG_content_M2M3_list = {
       "SLC_DRG" : {"Bypass" : Spec(f"__shared__::TpRule.If_DS0_DS1_M(1, 1, -1, 1)"), "IS_EDC" : True,
                    "Patlist" : 'IPC::'f"fun_cdie_{VMAX_Subflow.lower()}_slc_drg_hptp800_burstoff_list",
                    "SetPointsPreInstance" : TrialParamSpec(f'PSPRE.CR_{VMAXXCRF5_Corner}+' f'","+' f'"MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.corefreq+''":"')+Spec(f"+ __shared__::FreqValues.CR_{VMAXXCRF5_CornerID}+")+'"GHz,MCdrv:"+'+Spec(f'FUN_CORE_{sku}_Specs.ringfreq+''":"')+Spec(f"+ __shared__::FreqValues.CCF_{VMAXXCRF5_CornerID}")+f'+"GHz,CORE:nblctrl_core_l2:nbloff,CCF:nblctrl_ccf:ccfnbloff,MCfun:funcore_corefreq0:0.8GHz,MCfun:funcore_corefreq1:0.8GHz,MCfun:DBGCNTR:"'+Spec(f"+ __shared__::Corners.CR_{VMAXXCRF5_CornerID}")),
                    "SetPointsPostInstance" : Spec(f'PSPOST.CR_F5+''",CORE:nblctrl_core_l2:nblon,CCF:nblctrl_ccf:ccfnblon"'),
    ...
    VMAXF5M0M1_SLC_Tests = get_test_vmaxf5M0M1(VMAX_Flow, VMAXXCRF5_Corner, VMAXF5_FlowMatrix, VMAXXCRF5_CornerID, VMAX_Subflow, HPTP, VMAXF5_SLC_content_M0M1_list)
    VMAXF5M2M3_SLC_Tests = get_test_vmaxf5M2M3(VMAX_Flow, VMAXXCRF5_Corner, VMAXF5_FlowMatrix, VMAXXCRF5_CornerID, VMAX_Subflow, HPTP, VMAXF5_SLC_content_M2M3_list)

    VMAXF5M0M1_SLC_DRG_Tests = get_test_vmaxf5M0M1(VMAX_Flow, VMAXXCRF5_Corner, VMAXF5_FlowMatrix, VMAXXCRF5_CornerID, VMAX_Subflow, HPTP, VMAXF5_SLC_DRG_content_M0M1_list)
    VMAXF5M2M3_SLC_DRG_Tests = get_test_vmaxf5M2M3(VMAX_Flow, VMAXXCRF5_Corner, VMAXF5_FlowMatrix, VMAXXCRF5_CornerID, VMAX_Subflow, HPTP, VMAXF5_SLC_DRG_content_M2M3_list)

    
    VMAXF5_MLC_COMP = Flow("FUN_CORE_CX816_VMAXXCR_F5_MLC", VMAXF5M0M1_MLC_Tests, VMAXF5M2M3_MLC_Tests)
    VMAXF5_MLC_LS_COMP = Flow("FUN_CORE_CX816_VMAXXCR_F5_MLC_LS", VMAXF5M0M1_MLC_LS_Tests, VMAXF5M2M3_MLC_LS_Tests)
    VMAXF5_MLC_DRG_COMP = Flow("FUN_CORE_CX816_VMAXXCR_F5_MLC_DRG", VMAXF5M0M1_MLC_DRG_Tests, VMAXF5M2M3_MLC_DRG_Tests)
    VMAXF5_SLC_COMP = Flow("FUN_CORE_CX816_VMAXXCR_F5_SLC", VMAXF5M0M1_SLC_Tests, VMAXF5M2M3_SLC_Tests)
    VMAXF5_SLC_DRG_COMP = Flow("FUN_CORE_CX816_VMAXXCR_F5_SLC_DRG", VMAXF5M0M1_SLC_DRG_Tests, VMAXF5M2M3_SLC_DRG_Tests)

    #VMAXF5_COMP = Flow("FUN_CORE_CX816_VMAXXCR_F5", VMAXF5_Tests)
    VMAXF5_COMP = Flow("FUN_CORE_CX816_VMAXXCR_F5",
                       Fitem ('SAME', VMAXF5_MLC_COMP, r0=pFail(ret=0), r1=pPass(goto="NEXT")),
                          Fitem ('SAME', VMAXF5_MLC_LS_COMP, r0=pFail(ret=0), r1=pPass(goto="NEXT")),
                            Fitem ('SAME', VMAXF5_MLC_DRG_COMP, r0=pFail(goto="NEXT"), r1=pPass(goto="NEXT")),
                            Fitem ('SAME', VMAXF5_SLC_COMP, r0=pFail(ret=0), r1=pPass(goto="NEXT")),
                            Fitem ('SAME', VMAXF5_SLC_DRG_COMP, r0=pFail(goto="NEXT"), r1=pPass(goto="NEXT")))

    VMAXF1_COMP = Flow("FUN_CORE_CX816_VMAXXCR_F1", VMAXF1_Tests)
    ...
    VMAXCRLOF5_COMP = Flow("FUN_CORE_CX816_VMAXXCRLO_F5", VMAXXCRLOF5_Tests)
    VMAXCRLOF1_COMP = Flow("FUN_CORE_CX816_VMAXXCRLO_F1", VMAXXCRLOF1_Tests)
    ...
    if sku == "CX816":
        LTTC_XCRF5M0M1_MLC_DRG_content_list = {
       "MLC_DRG" : {"Bypass" : -1, "IS_EDC" : True, "Binning" : 9444,}
       }

        LTTC_XCRF5M2M3_MLC_DRG_content_list = {
       "MLC_DRG" : {"Bypass" : -1, "IS_EDC" : True, "Binning" : 9444,}
       }
    else:
        {
    ...
    LTTC_XCRF5M0M1_MLCDRG_Tests = get_test_listM0M1_LTTC(LTTC_XCRF5_Flow, LTTC_XCRF5_Corner, LTTC_XCRF5_FlowMatrix, LTTC_XCRF5_CornerID, LTTC_XCRF5_SubFlow, HPTP, LTTC_XCRF5M0M1_MLC_DRG_content_list)
    LTTC_XCRF5M2M3_MLCDRG_Tests = get_test_listM2M3_LTTC(LTTC_XCRF5_Flow, LTTC_XCRF5_Corner, LTTC_XCRF5_FlowMatrix, LTTC_XCRF5_CornerID, LTTC_XCRF5_SubFlow, HPTP, LTTC_XCRF5M2M3_MLC_DRG_content_list)
    LTTC_F5XCRMLCDRG = Flow("LTTCCPU_F5_SBFT_MLCDRG", LTTC_XCRF5M0M1_MLCDRG_Tests, LTTC_XCRF5M2M3_MLCDRG_Tests)

    LTTC_XCRF5_Subflow = Flow(f"FUN_CORE_{sku}_LTTCCPU", 
                         Fitem ('SAME', LTTC_F5XCRMLCDRG, r0=pFail(ret=0),r1=pPass(goto="NEXT")))