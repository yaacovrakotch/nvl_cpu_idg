...
resources_file = Spec('GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "/Modules/ARR/ARR_COMMON_CKX/InputFiles/NVL_ArrayMap_ATOM.json"') #"~HDMT_TPL_DIR/Modules/ARR_COMMON_CXX/InputFiles/ARL_ArrayMap_resource.json",
repairtofuse_file = Spec('GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "/Modules/ARR/ARR_COMMON_CKX/InputFiles/NVL_Repair_to_fuse_ATOM.json"') #"~HDMT_TPL_DIR/Modules/ARR_COMMON_CXX/InputFiles/ARL_Repair_to_fuse.json",
arraydef_file = Spec('GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "/Modules/ARR/ARR_COMMON_CKX/InputFiles/NVL_ArrayDefinition_ATOM.json"')
