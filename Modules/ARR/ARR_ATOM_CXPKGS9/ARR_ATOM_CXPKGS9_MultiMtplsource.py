...
def get_VminTC_pt_vmax(testname, content, subflow, freqcorner): 
    bypass = content['bypass']
    kill = content['kill']
    template = content['template']
    flowmatrix = content['flowmatrix']
    ...
    return VminTC(
        ...
        Patlist="IPC::arr_cdie_vmaxxat_pbist_atom_all_all_vatom_vmax_all_f1_hptp800_class_list",
        PatternNameCounterIndexes="9,10,11,12,13,14,15",
        BaseNumbers=AUTO,
        ScoreboardEdgeTicks=0,
        MaxFailsNum=0,
        SetPointsPlistParamName="Patlist",
        SetPointsPreInstance=Spec(f'"MCdrv:atomfreq_0:"+' + Spec(f"__shared__::FlowMatrixSingular.{flowmatrix}+") + '"GHz,MCdrv:corefreq:"+' + Spec(f"__shared__::FlowMatrixSingular.{flowmatrix}+") + '"GHz,MCdrv:ringfreq_0:"+' + Spec(f"__shared__::FlowMatrixSingular.{flowmatrix}+") + '"GHz,MCAarr:ratio_modify:"+' + Spec(f"__shared__::FlowMatrixSingular.{flowmatrix}+") + '"GHz,CDIE_ATOM:nblctrl_cdie_atom_l2:nbloff"'),
        ...
        VoltageTargets=f'{voltage_target}',
        # VoltageConverter = voltageconverter if voltageconverter else None,
        VoltageConverter=Spec(f'"--railconfigurations CDIE_ATOM_POWERMUXM0 CDIE_ATOM_POWERMUXM1 CDIE_ATOM_POWERMUXM2 CDIE_ATOM_POWERMUXM3 --dlvrpins VCCIA --expressions "' + f' + DROPOUT.AT_{freqcorner}'),
        PinMap=ifEmpty(f'{pinmap}'),
        RecoveryMode=recoverymode,
        ...
        FeatureSwitchSettings= 'disable_masked_targets,fivr_mode_on,print_per_target_increments,print_scoreboard_counters'
    )

def get_VminTC_pt_vmaxf5(testname, content, subflow, freqcorner): 
    bypass = content['bypass']
    kill = content['kill']
    template = content['template']
    flowmatrix = content['flowmatrix']
    ...
    return VminTC(
        ...
        ForwardingMode=ifEmpty(f'{ForwardingMode}'),
        LevelsTc="CPU_IP_BASE::cpu_all_bf_x_x_ipc_lvl_min",
        Patlist="IPC::arr_cdie_vmaxxat_pbist_atom_all_all_vatom_vmax_all_f5_hptp800_class_list",
        PatternNameCounterIndexes="9,10,11,12,13,14,15",
        BaseNumbers=AUTO,
        ScoreboardEdgeTicks=0,
        MaxFailsNum=0,
        ...
        PinMap=ifEmpty(f'{pinmap}'),
        RecoveryMode=recoverymode,
        RecoveryOptions=Spec(f'__shared__::Recovery.MTT_recovery_opt_AT'),
        FivrCondition='NOM',
        RecoveryTrackingIncoming='ACRM3_B,ACRM2_B,ACRM1_B,ACRM0_B,ACRM3,ACRM2,ACRM1,ACRM0',
        RecoveryTrackingOutgoing='ACRM3_B,ACRM2_B,ACRM1_B,ACRM0_B,ACRM3,ACRM2,ACRM1,ACRM0',
		SetPointsPostInstance = "CDIE_ATOM:nblctrl_cdie_atom_l2:nblon",
...
def get_VminTC_multitrial_singlevmin_F5_vmax(testname,content,subflow,freqcorner): 
	bypass = content['bypass']
	kill = content['kill']
	template = content['template']
	flowmatrix = content['flowmatrix']
	...
	return NativeMultiTrial(
			...
			LevelsTc = f'{level}',
			LimitGuardband = ifEmpty(f'{LimitGuardband}'),
			Patlist = 'IPC::'f"arr_cdie_{subflow.lower()}_pbist_atom_all_all_vatom_reducedks_all_{freqcorner.lower()}_hptp800_class_master",
			PatternNameCounterIndexes = "9,10,11,12,13,14,15",
...
def get_VminTC_pt(testname, content, subflow, freqcorner): 
    ...
    return VminTC(
        ...
        ForwardingMode=ifEmpty(f'{ForwardingMode}'),
        LevelsTc= "CPU_IP_BASE::cpu_all_bf_x_x_ipc_lvl_min",
        Patlist="IPC::arr_cdie_begincpunom_pbist_atom_all_all_vatom_ks_all_f3_hptp800_class_list",
        PatternNameCounterIndexes="9,10,11,12,13,14,15",
        BaseNumbers=AUTO,
        ScoreboardEdgeTicks=0,
        MaxFailsNum=0,
...
def get_VminTC_pt_endcpu_tag(testname, content, subflow, freqcorner): 
    bypass = content['bypass']
    kill = content['kill']
    template = content['template']
    flowmatrix = content['flowmatrix']
    ...
    return VminTC(
        ...
        ForwardingMode=ifEmpty(f'{ForwardingMode}'),
        LevelsTc=f'{level}',
        Patlist=f'IPC::'f"arr_cdie_endcpu_pbist_atom_directdsdb_ssa_vatom_reducedks_cofreq_l2_tag_fx_hptp800_class_list",
        PatternNameCounterIndexes="9,10,11,12,13,14,15",
        BaseNumbers=AUTO,
        ScoreboardEdgeTicks=0,
        MaxFailsNum=0,
        ...
        VoltageTargets=f'{voltage_target}',
        # VoltageConverter = voltageconverter if voltageconverter else None,
        VoltageConverter=Spec(f'"--railconfigurations CDIE_ATOM_POWERMUXM0 CDIE_ATOM_POWERMUXM1 CDIE_ATOM_POWERMUXM2 CDIE_ATOM_POWERMUXM3 --dlvrpins VCCIA"'),
        PinMap=ifEmpty(f'{pinmap}'),
        ...
        RecoveryTrackingIncoming='ACRM3_B,ACRM2_B,ACRM1_B,ACRM0_B,ACRM3,ACRM2,ACRM1,ACRM0',
        RecoveryTrackingOutgoing='ACRM3_B,ACRM2_B,ACRM1_B,ACRM0_B,ACRM3,ACRM2,ACRM1,ACRM0',
		EndVoltageLimits = "0.715",
		StartVoltages = "0.715",
		SetPointsPostInstance = "CDIE_ATOM:nblctrl_cdie_atom_l2:nblon",
        FeatureSwitchSettings= 'disable_masked_targets,fivr_mode_on,print_per_target_increments,print_scoreboard_counters'
    )

def get_VminTC_pt_endcpu_data(testname, content, subflow, freqcorner): 
    bypass = content['bypass']
    kill = content['kill']
    template = content['template']
    flowmatrix = content['flowmatrix']
    ...
    return VminTC(
        ...
        ForwardingMode=ifEmpty(f'{ForwardingMode}'),
        LevelsTc=f'{level}',
        Patlist=f'IPC::'f"arr_cdie_endcpu_pbist_atom_directdsdb_ssa_vatom_reducedks_cofreq_l2_data_fx_hptp800_class_list",
        PatternNameCounterIndexes="9,10,11,12,13,14,15",
        BaseNumbers=AUTO,
        ScoreboardEdgeTicks=0,
        MaxFailsNum=0,
...
def get_VminTC_multitrial_singlevmin_fmin(testname,content,subflow,freqcorner): 
	bypass = content['bypass']
	kill = content['kill']
	template = content['template']
	flowmatrix = content['flowmatrix']
	...
	return NativeMultiTrial(
			...
			exitaction="Continue" if kill==1 else "Restore",
			_comment='Sample VminTC test with MTT',
			template=VminTC(name=f'"ARR_{IP}_VMIN_K_{subflow}_HITO_VCCIA_{freqcorner}_" + {prefix_for_flowmatrix}.{flowmatrix}_MHz + "_{testname.upper()}"' if kill==1 else f'"ARR_{IP}_E_{subflow}_HITO_VCCIA_{freqcorner}_" + {prefix_for_flowmatrix}.{flowmatrix} + "_{testname.upper()}"',
			BypassPort = bypass,
			CornerIdentifiers =  TrialParamSpec(f'"AT3@F1,AT2@F1,AT1@F1,AT0@F1"'),
			DtsConfiguration = ifEmpty(f'{dts}'),
			EndVoltageLimits = "ATOMM3_F1_VMIN,ATOMM2_F1_VMIN,ATOMM1_F1_VMIN,ATOMM0_F1_VMIN",
			ExecutionMode = ifEmpty(f'{ExecutionMode}'),
			FlowIndex = Spec("__shared__::FlowMatrix.FlowIndex"),
			#FlowIndexCallbackName = ifEmpty(f'{FlowIndexCallbackName}'),
			ForwardingMode = ifEmpty(f'{ForwardingMode}'),
			LevelsTc = f'{level}',
			LimitGuardband = Spec(f'__shared__::GBVars.FminLimitGuardband'),
			Patlist = "IPC::arr_cdie_fminxat_pbist_atom_all_all_vatom_reducedks_srh_all_fmin_hptp800_class_list",
			PatternNameCounterIndexes = "9,10,11,12,13,14,15",
			BaseNumbers = AUTO, # if 'srh' not in template else None,
			ScoreboardEdgeTicks = Spec(f'{ScoreboardEdgeTicks}') if ScoreboardEdgeTicks else None,
			MaxFailsNum = Spec(f'{MaxFailsNum}') if MaxFailsNum else None,
			...
			StartVoltages = "ATOMM3_F1_VMIN,ATOMM2_F1_VMIN,ATOMM1_F1_VMIN,ATOMM0_F1_VMIN",
			StepSize = Spec(f'toDouble(__shared__::FlowMatrixSingular.AT_SEARCH_RESOLUTION)'),
			TestMode = ifEmpty(f'{TestMode}'), 
			TimingsTc = "IPC::CPU_IP_BASE::cpu_fun_timing_mts400_tstprtclk200_tck50",
			VoltagesOffset = ifEmpty(f'{VoltagesOffset}'),
			VoltageTargets = f'{voltage_target}',
			#VoltageConverter = Spec(voltageconverter) if voltageconverter else None,
			VoltageConverter = Spec(f'"--railconfigurations CDIE_ATOM_POWERMUXM0 CDIE_ATOM_POWERMUXM1 CDIE_ATOM_POWERMUXM2 CDIE_ATOM_POWERMUXM3 CDIE_L2_NBLCTRL0 CDIE_L2_NBLCTRL1 CDIE_L2_NBLCTRL2 CDIE_L2_NBLCTRL3 --dlvrpins VCCIA --expressions "' + f' + DROPOUT.AT_{freqcorner}'),
...
def get_VminTC_multitrial_singlevmin_fmin_FF(testname,content,subflow,freqcorner): 
	bypass = content['bypass']
	kill = content['kill']
	template = content['template']
	flowmatrix = content['flowmatrix']
...
def get_VminTC_multitrial_singlevmin(testname,content,subflow,freqcorner): 
	...
	return NativeMultiTrial(
			...
			template=VminTC(name=f'"ARR_{IP}_VMIN_K_{subflow}_HITO_VCCIA_{freqcorner}_" + {prefix_for_flowmatrix}.{flowmatrix}_MHz + "_{testname.upper()}"' if kill==1 else f'"ARR_{IP}_E_{subflow}_HITO_VCCIA_{freqcorner}_" + {prefix_for_flowmatrix}.{flowmatrix} + "_{testname.upper()}"',
			BypassPort = bypass,
			CornerIdentifiers =  TrialParamSpec(f'"AT3@{freqcorner},AT2@{freqcorner},AT1@{freqcorner},AT0@{freqcorner}"'),
			DtsConfiguration = ifEmpty(f'{dts}'),
			EndVoltageLimits = Spec(f'__shared__::FlowMatrixSingular.AT_HIGH_SEARCH_VALUE'), #+","+__shared__::FlowMatrix.AT_HIGH_SEARCH_VALUE'),
			ExecutionMode = ifEmpty(f'{ExecutionMode}'),
			FlowIndex = Spec("__shared__::FlowMatrixSingular.FlowIndex"),
...
def get_DedcLoadConfigTC_test():
	return RunCallback(
		...
		BypassPort = 1,
		Parameters = "--decoder FailDataDecoder --file ./Modules/ARR/ARR_ATOM_CXPKGS9/InputFiles/DieRecoveryPinMaps_NVL_ARRATOM_52C.json",
		LogLevel = "Disabled",
...
def get_DedcLoadConfigTC_test1():
	return RunCallback(
		...
		BypassPort = 1,
		Parameters = "--decoder FailDataDecoder --file ./Modules/ARR/ARR_ATOM_CXPKGS9/InputFiles/ApexTC_Input_Config.json",
		LogLevel = "Disabled",
...
def get_PrimePatConfigTestMethod_test():
	return PrimePatConfigTestMethod(
				...
				BypassPort = 1,
				ConfigurationFile = 'GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "/Modules/ARR/ARR_ATOM_CXPKGS9/InputFiles/APPLY_ATOM_RWA.FuseConfigSetPoints.json"',
...
def get_test_list(contentlist,subflow,freqcorner):
	...
	for test in contentlist:
		...
		elif contentlist[test]['template'] == 'VminTC_pt_vmax':
			testlist.append(get_VminTC_pt_vmax(test,contentlist[test],subflow,freqcorner))
		
		elif contentlist[test]['template'] == 'VminTC_pt_vmaxf5':
			testlist.append(get_VminTC_pt_vmaxf5(test,contentlist[test],subflow,freqcorner))

		elif contentlist[test]['template'] == 'VminTC_MTT_singleVmin_F5_vmax' or contentlist[test]['template'] == 'VminTC_chk' or contentlist[test]['template'] == 'VminTC_max': # vmin_srh,vmin_chk,vmin_max
			testlist.append(get_VminTC_multitrial_singlevmin_F5_vmax(test,contentlist[test],subflow,freqcorner))
		
		elif contentlist[test]['template'] == 'VminTC_p_endcpu_l2tag':
			testlist.append(get_VminTC_pt_endcpu_tag(test,contentlist[test],subflow,freqcorner))
		
		elif contentlist[test]['template'] == 'VminTC_p_endcpu_l2data':
			testlist.append(get_VminTC_pt_endcpu_data(test,contentlist[test],subflow,freqcorner))
		...
		elif contentlist[test]['template'] == 'VminTC_MTT_singleVmin_fmin' or contentlist[test]['template'] == 'VminTC_chk' or contentlist[test]['template'] == 'VminTC_max': # vmin_srh,vmin_chk,vmin_max
			testlist.append(get_VminTC_multitrial_singlevmin_fmin(test,contentlist[test],subflow,freqcorner))

		elif contentlist[test]['template'] == 'VminTC_MTT_singleVmin_fmin_ff' or contentlist[test]['template'] == 'VminTC_chk' or contentlist[test]['template'] == 'VminTC_max': # vmin_srh,vmin_chk,vmin_max
			testlist.append(get_VminTC_multitrial_singlevmin_fmin_FF(test,contentlist[test],subflow,freqcorner))
...
packages = {'S52C':{'plist':{"I:\\hdmxpats\\nvl_cpu\\MCAarr\\RevTC52XA0.0\\p0\\plb\\arr_cdie_begincpunom_pbist_atom_ks_ttr_hptp800_class.plist", 
	                          "I:\\hdmxpats\\nvl_cpu\\MCAarr\\RevTC52XA0.0\\p0\\plb\\arr_cdie_f2xat_pbist_atom_ks_ttr_f2_hptp800_class.plist",
							  "I:\\hdmxpats\\nvl_cpu\\MCAarr\\RevTC52XA0.0\\p0\\plb\\arr_cdie_f3xat_pbist_atom_ks_ttr_f3_hptp800_class.plist",
							  "I:\\hdmxpats\\nvl_cpu\\MCAarr\\RevTC52XA0.0\\p0\\plb\\arr_cdie_vmaxxat_pbist_atom_vmaxf1_ttr_hptp800_class.plist",
							  "I:\\hdmxpats\\nvl_cpu\\MCAarr\\RevTC52XA0.0\\p0\\plb\\arr_cdie_x_pbist_atom_all_vatom_hry_all_f1_tito_class.plist",
							  "I:\\hdmxpats\\nvl_cpu\\MCAarr\\RevTC52XA0.0\\p0\\plb\\arr_cdie_f4xat_pbist_atom_ks_ttr_f4_hptp800_class.plist",
							  "I:\\hdmxpats\\nvl_cpu\\MCAarr\\RevTC52XA0.0\\p0\\plb\\arr_cdie_f5xat_pbist_atom_ks_ttr_f5_hptp800_class.plist",
							 # "I:\\hdmxpats\\nvl_cpu\\MCAarr\\RevTCI8GA0.0\\p0\\plb\\arr_cdie_fbatxsn_pbist_atom_ks_ttr_fbat_hptp800_class.plist",
							  "I:\\hdmxpats\\nvl_cpu\\MCAarr\\RevTC52XA0.0\\p0\\plb\\arr_cdie_f1xat_pbist_atom_ks_ttr_f1_hptp800_class.plist",
							  "I:\\hdmxpats\\nvl_cpu\\MCAarr\\RevTC52XA0.0\\p0\\plb\\arr_cdie_x_pbist_atom_all_vatom_raster_f1_tito_class.plist",
							  "I:\\hdmxpats\\nvl_cpu\\MCAarr\\RevTC52XA0.0\\p0\\plb\\arr_cdie_vmaxxat_pbist_atom_vmaxf5_ttr_hptp800_class.plist", 
							  "I:\\hdmxpats\\nvl_cpu\\MCAarr\\RevTC52XA0.0\\p0\\plb\\arr_cdie_fminxat_pbist_atom_ks_ttr_fmin_hptp800_class.plist",
							  "I:\\hdmxpats\\nvl_cpu\\MCAarr\\RevTC52XA0.0\\p0\\plb\\arr_cdie_endcpunom_pbist_atom_l2_vatom_ret_f1_hptp800_class.plist",
							  "I:\\hdmxpats\\nvl_cpu\\MCAarr\\RevTC52XA0.0\\p0\\plb\\arr_cdie_endcpu_pbist_atom_ks_ttr_fx_hptp800_class.plist",
							  "I:\\hdmxpats\\nvl_cpu\\MCAarr\\RevTC52XA0.0\\p0\\plb\\arr_cdie_f5xat_pbist_atom_ks_ttr_f5_hptp800_class_mec.plist"},'bom':'CLASS_NVL_S52C','alephfiles': ["InputFiles\merged_arr_cdie_f1xat_pbist_atom_ks_ttr_f1_hptp800_class_PatConfigSetpoints.json", "InputFiles\merged_arr_cdie_f1xat_pbist_atom_ks_ttr_f1_hptp800_class_patmod.json","InputFiles\arw_raster_atom.patmod.json","InputFiles\APPLY_ATOM_RWA.fuseconfig.json","InputFiles\AtomArray.patmod.json"]}}
...
timing = "IPC::ARR_ATOM_CXPKGS9::cpu_fun_timing_mts800_tstprtclk400_tck100_arratom"
...
package_to_mod_mapping = {'PKGS9':{'S28C','S52C'}}
...
for sku in package_to_mod_mapping:
	...
	resources_file = Spec('GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "/Modules/ARR/ARR_ATOM_CXPKGS9/InputFiles/NVL_ArrayMap_ATOM.json"') #"~HDMT_TPL_DIR/Modules/ARR_COMMON_CXX/InputFiles/ARL_ArrayMap_resource.json",
	repairtofuse_file = Spec('GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "/Modules/ARR/ARR_ATOM_CXPKGS9/InputFiles/NVL_Repair_to_fuse_ATOM.json"') #"~HDMT_TPL_DIR/Modules/ARR_COMMON_CXX/InputFiles/ARL_Repair_to_fuse.json",
	arraydef_file = Spec('GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "/Modules/ARR/ARR_ATOM_CXPKGS9/InputFiles/NVL_ArrayDefinition_ATOM.json"')
	...
	def create_PATMOD_test(input_dict):
			sample_test=PrimePatConfigTestMethod(name = f"{input_dict['array_type']}_ATOM_PATMOD_E_"+sub_flow+f"_TITO_VCCIA_{input_dict['corner']}_X"+f"_{input_dict['testname']}",
										ConfigurationFile = Spec('GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "/Modules/ARR/ARR_ATOM_CXPKGS9/InputFiles/AtomArray.PatConfigSetpoints.json"'),
	...
	def create_hry_test(input_dict):
			...
			sample_test=PrimeArrayHryTestMethod(name = f"{input_dict['array_type']}_ATOM_HRY_E_"+sub_flow+f"_TITO_VCCIA_{input_dict['corner']}_X"+f"_{input_dict['testname']}",
												...
												ConfigFile = Spec('GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "/Modules/ARR/ARR_ATOM_CXPKGS9/InputFiles/arr_cdie_x_pbist_atom_direct_all_vatom_hry_all_f1_tito_class_list.xml"'),							
	...
	SCREENTEST_SETLOCALVMIN= get_ScreenTC( sub_flow, 1, Spec('GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "/Modules/ARR/ARR_ATOM_CXPKGS9/InputFiles/arr_atomrr_repair.txt"'),"SET_LOCALVMINL2Repair","SETLOCAL_L2_VMINREP")
	SCREENTEST_SETL2RR_VMIN= get_ScreenTC( sub_flow, 1, Spec('GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "/Modules/ARR/ARR_ATOM_CXPKGS9/InputFiles/ScreenTest_L2.txt"'),"SetL2_RasterRepair","SETL2RR_VMINREP")
	...
	SCREENTEST_REVERT_VMINREP= get_ScreenTC( sub_flow, 1, Spec('GetEnvironmentVariable("~HDMT_TP_BASE_DIR") + "/Modules/ARR/ARR_ATOM_CXPKGS9/InputFiles/arr_atomrr_repair.txt"'),"REVERT_VMINL2Repair","REVERT_L2_VMINREP")
	...
	content_list[SKU] = {	"COMBINED"	: {"bypass":1, "kill":1,'template':'VminTC_MTT_singleVmin_F5','supply':POR_VoltageTarget,'flowmatrix':'AT_F5_FREQ','powermux':POR_Pmux,'plist': [IPCluster,arraytype,testtype], 'hermes' : '1'},
							...
							"SSA_l2tag": {"bypass":1, "kill":1,'template':'VminTC_MTT_singleVmin_F5','supply':POR_VoltageTarget,'flowmatrix':'AT_F5_FREQ','powermux':POR_Pmux,'plist': ["directdsdb","ssa",testtype], 'hermes' : '0'},
	...
	# Input
	# Define the test types we want in this subflow and also define Bypass and EDC definitions separately so that we can change them easily in the future.
	content_list[SKU] = {	"COMBINED"	: {"bypass":1, "kill":1,'template':'VminTC_MTT_singleVmin_fmin','supply':POR_VoltageTarget,'flowmatrix':'AT_FMIN','powermux':POR_Pmux,'plist': [IPCluster,arraytype,testtype]},
							"COMBINED_FMIN_FF_SEARCH"	: {"bypass":1, "kill":1,'template':'VminTC_MTT_singleVmin_fmin_ff','supply':POR_VoltageTarget,'flowmatrix':'AT_FMIN','powermux':POR_Pmux,'plist': [IPCluster,arraytype,testtype]},
	                        "SSA"       : {"bypass":1, "kill":1,'template':'VminTC_MTT_singleVmin_fmin','supply':POR_VoltageTarget,'flowmatrix':'AT_FMIN','powermux':POR_Pmux,'plist': ["directdsdb","ssa",testtype]},
							"SSA_l2tag"       : {"bypass":1, "kill":1,'template':'VminTC_MTT_singleVmin_fmin','supply':POR_VoltageTarget,'flowmatrix':'AT_FMIN','powermux':POR_Pmux,'plist': ["directdsdb","ssa",testtype]}}
	#content_list['SX'] = {	"L2dragon"	: {"bypass":1, "kill":1,'template':'VminTC_srh','recovery':1,'supply':'VCCATOM',    'flowmatrix':'SAN_F1_FREQ', 'powermux':POR_Pmux}}
	#content_list['SK'] = {	"L2dragon"	: {"bypass":1, "kill":1,'template':'VminTC_srh','recovery':1,'supply':'VCCATOM',    'flowmatrix':'SAN_F1_FREQ'}}
	...
	Flow(module+sku+"_"+sub_flow, Fitem("SAME", tuple(tests)[0], # edc = False if (content_list[SKU]["COMBINED"]["kill"]==1) else True,
				...
				r4 = pFail(setbin=LSA_Thermal, ret=0) if (content_list[SKU]["COMBINED"]["kill"]==1) else pFail(setbin=AUTO),
				r5 = pFail(setbin=LSA_Reset, ret=0) if (content_list[SKU]["COMBINED"]["kill"]==1) else pFail(setbin=AUTO)),
				Fitem("SAME", tuple(tests)[3], # edc = False if (content_list[SKU]["COMBINED"]["kill"]==1) else True,
				r0 = pFail(setbin=LSABin, ret=0) if (content_list[SKU]["COMBINED_FMIN_FF_SEARCH"]["kill"]==1) else pFail(setbin=AUTO),
				r1 = pPass(ret = 1),
				r2 = pFail(setbin=LSABin, ret=0) if (content_list[SKU]["COMBINED_FMIN_FF_SEARCH"]["kill"]==1) else pFail(setbin=AUTO),
				r3 = pPass(ret = 1),
				r4 = pFail(setbin=LSA_Thermal, ret=0) if (content_list[SKU]["COMBINED_FMIN_FF_SEARCH"]["kill"]==1) else pFail(setbin=AUTO),
				r5 = pFail(setbin=LSA_Reset, ret=0) if (content_list[SKU]["COMBINED_FMIN_FF_SEARCH"]["kill"]==1) else pFail(setbin=AUTO)),
				 Fitem("SAME", tuple(tests)[1],
				r0 = pFail(setbin=SSABin, ret=0) if (content_list[SKU]["SSA"]["kill"]==1) else pFail(setbin=AUTO),
				r1 = pPass(ret = 0),
				r2 = pFail(setbin=SSABin, ret=0) if (content_list[SKU]["SSA"]["kill"]==1) else pFail(setbin=AUTO),
	...
	# Input
	# Define the test types we want in this subflow and also define Bypass and EDC definitions separately so that we can change them easily in the future.
	content_list[SKU] = {	"COMBINED"	: {"bypass":1, "kill":1,'template':'VminTC_pt_vmax','supply':POR_VoltageTarget,'flowmatrix':'AT_F1_FREQ', 'voltageoverride':f'{POR_VoltageTarget}'+":1.1", 'plist': [IPCluster,arraytype,testtype], 'level' : 'nom'},
	                        "SSA"       : {"bypass":1, "kill":1,'template':'VminTC_pt_vmax','supply':POR_VoltageTarget,'flowmatrix':'AT_F1_FREQ', 'voltageoverride':f'{POR_VoltageTarget}'+":1.1", 'plist': ["directdsdb","ssa",testtype], 'level' : 'nom'}}
	...
	freq_corner = "F5"						# Define the test frequency
	# Define the test types we want in this subflow and also define Bypass and EDC definitions separately so that we can change them easily in the future.
	content_list[SKU] = {	"COMBINED"	: {"bypass":1, "kill":1,'template':'VminTC_pt_vmaxf5','supply':POR_VoltageTarget,'flowmatrix':'AT_F5_FREQ', 'voltageoverride':f'{POR_VoltageTarget}'+":1.1", 'plist': [IPCluster,arraytype,testtype], 'level' : 'nom'},
	                        "SSA"       : {"bypass":1, "kill":1,'template':'VminTC_pt_vmaxf5','supply':POR_VoltageTarget,'flowmatrix':'AT_F5_FREQ', 'voltageoverride':f'{POR_VoltageTarget}'+":1.1", 'plist': ["directdsdb","ssa",testtype], 'level' : 'nom'}}
	...
	content_list[SKU] = { "PMUX_CO_FREQ0"  : {"bypass" : 1,
											 ...
											 "param" : '--target AT0 --voltage 0.715 --flow 1 --expression [FREQ] --token CDIE_ATOM0_FREQ', 
											 "callback" : 'CalculateFrequencySwitch', 
											 "postcall" : 'PrintToItuff(--body_type strgval --body_data G.U.S.CDIE_ATOM0_FREQ --tname_suf _CDIEATOM0_CO_FREQ)'},
					  
						"PMUX_CO_FREQ1" : {"bypass" : 1,
											 "kill" : 0, 
											 "template" : 'RunCallback1',
											 "param" : '--target AT0 --voltage 0.715 --flow 1 --expression [FREQ] --token CDIE_ATOM1_FREQ', 
											 "callback" : 'CalculateFrequencySwitch', 
											 "postcall" : 'PrintToItuff(--body_type strgval --body_data G.U.S.CDIE_ATOM0_FREQ --tname_suf _CDIEATOM1_CO_FREQ)'},

						"PMUX_CO_FREQ2" : {"bypass" : 1,
											 "kill" : 0, 
											 "template" : 'RunCallback1',
											 "param" : '--target AT0 --voltage 0.715 --flow 1 --expression [FREQ] --token CDIE_ATOM2_FREQ', 
											 "callback" : 'CalculateFrequencySwitch', 
											 "postcall" : 'PrintToItuff(--body_type strgval --body_data G.U.S.CDIE_ATOM0_FREQ --tname_suf _CDIEATOM2_CO_FREQ)'},

						"PMUX_CO_FREQ3" : {"bypass" : 1,
											 "kill" : 0, 
											 "template" : 'RunCallback1',
											 "param" : '--target AT0 --voltage 0.715 --flow 1 --expression [FREQ] --token CDIE_ATOM3_FREQ', 
											 "callback" : 'CalculateFrequencySwitch', 
											 "postcall" : 'PrintToItuff(--body_type strgval --body_data G.U.S.CDIE_ATOM0_FREQ --tname_suf _CDIEATOM3_CO_FREQ)'},				  
	...
	content_list_co_freq = 	{ "L2_TAG"		: {"bypass":1, "kill":0,'template':'VminTC_p_endcpu_l2tag','supply':POR_VoltageTarget,'flowmatrix':'SAAT_X', 
												'PreInstance' :'ExecutePatConfigSetPoint(G.U.S.CPUATOMPMUX)',
												'voltageoverride':f'{POR_VoltageTarget}'+":0.715",'powermux':POR_Pmux,'plist':["directdsdb","ssa",testtype]},
							  "L2_DATA"		: {"bypass":1, "kill":0,'template':'VminTC_p_endcpu_l2data','supply':POR_VoltageTarget,'flowmatrix':'SAAT_X',
												'PreInstance' :'ExecutePatConfigSetPoint(G.U.S.CPUATOMPMUX)',
												'voltageoverride':f'{POR_VoltageTarget}'+":0.715",'powermux':POR_Pmux,'plist': ["directdsdb","ssa",testtype]}}
