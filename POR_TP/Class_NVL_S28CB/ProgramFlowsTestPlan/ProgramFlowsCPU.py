...
Orig_Ports = 'rm2fm2 rm1fm1 r0f0 r2p1'
LTTC_Skip_S28_B0_PO = 'rm2fm2 rm1fm1 r0f0 r1p1 r2p1'

# To enable LTTC - Please replace the LTTC_Skip_S28_B0_PO with Orig_Ports
...
STARTCPUPATMODSPKG_SubFlow    ARR_COMMON_CKX      {pkg_stdports}
STARTCPUPATMODSPKG_SubFlow    PTH_DLVR_CKPKGS7     {pkg_stdports}
...
BEGINCPUPKG_SubFlow			  ARR_CORE_CKX		rm2fm2 rm1fm1 r0f0 r2p1
BEGINCPUPKG_SubFlow           ARR_UNCORE_CKX     rm2fm2 rm1fm1 r0f0 r2p1
BEGINCPUPKG_SubFlow           SCN_UNCORE_CK816     rm2fm2 rm1fm1 r0f0 r2p1
BEGINCPUPKG_SubFlow           PTH_XIUCHK_CKX     rm2fm2 rm1fm1 r0f0 r2p1

ENDCPUPKG_SubFlow             TPI_FLWFLGS_XXX      rm2fm2 rm1fm1 r0f0 r2p1
ENDCPUPKG_SubFlow             ARR_CORE_CKX     {pkg_stdports}
ENDCPUPKG_SubFlow             ARR_COMMON_CKX     {pkg_stdports}
ENDCPUPKG_SubFlow             TPI_DIERCVRY_CXX     {pkg_stdports}
ENDCPUPKG_SubFlow             PTH_DLVR_CKPKGS7     {pkg_stdports}

ENDCPUVMAXPKG_SubFlow         TPI_FLWFLGS_XXX      rm2fm2 rm1fm1 r0f0 r2p1

LTTCCPUPKG_SubFlow            TPI_FLWFLGS_XXX      {Orig_Ports}
LTTCCPUPKG_SubFlow            ARR_UNCORE_CKX      rm2fm2 rm1fm1 r0f0 r2p1
...
CPUPKGFF_SubFlow              PTH_XIUCHK_CKX     rm2fm2 rm1fm1 r0f0 r2p1
'''
...
#INITCPU_SubFlow          IPC::PTH_DTS_CXPKGS7::PTH_DTS_CXPKGS7_INIT {init_stdports}
#INITCPU_SubFlow          IPC::CLK_BASE_CXXX::CLK_BASE_CXXX_INIT   {init_stdports}
INITCPU_SubFlow          IPC::ARR_CORE_CXX::ARR_CORE_CXX_INIT   {init_stdports}
INITCPU_SubFlow          IPC::ARR_ATOM_CXX::ARR_ATOM_CXX_INIT   {init_stdports}
INITCPU_SubFlow          IPC::ARR_CCF_CXX::ARR_CCF_CXX_INIT   {init_stdports}
INITCPU_SubFlow          IPC::SCN_ATOM_CX816::SCN_ATOM_CX816_INIT   {init_stdports}
INITCPU_SubFlow          IPC::FUN_CORE_CX816::FUN_CORE_CX816_INIT   {init_stdports}
INITCPU_SubFlow          IPC::FUN_ATOM_CX816::FUN_ATOM_CX816_INIT   {init_stdports}
INITCPU_SubFlow          IPC::SCN_CORE_CX816::SCN_CORE_CX816_INIT   {init_stdports}
INITCPU_SubFlow          IPC::SCN_UNCORE_CX816::SCN_UNCORE_CX816_INIT   {init_stdports}
INITCPU_SubFlow          IPC::FUN_CCF_CX816::FUN_CCF_CX816_INIT   {init_stdports}
...
INITCPUPKG_SubFlow   ARR_COMMON_CKX::ARR_COMMON_CKX_INIT        {init_stdports}
INITCPUPKG_SubFlow   SCN_UNCORE_CK816::SCN_UNCORE_CK816_INIT   {init_stdports}
