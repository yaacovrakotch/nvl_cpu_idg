from pymtpl.core import Initialize # type: ignore
from pymtpl.helpers import ProgramFlows  # type: ignore
...
STARTCPUNOM_SubFlow       MIO_HPTP_CXPKGHX     {ipc_stdports}
...
BEGINCPU_SubFlow          SCN_ATOM_CX48       rm2fm2 rm1fm1 r0f20 r2p1
BEGINCPU_SubFlow          SCN_CORE_CX48       rm2fm2 rm1fm1 r0f20 r2p1
BEGINCPU_SubFlow          SCN_UNCORE_CX48     rm2fm2 rm1fm1 r0f20 r2p1
...
F1XCCF_SubFlow            SCN_UNCORE_CX48     rm2fm2 rm1fm1 r0f20 r2p1
F1XCCF_SubFlow            FUN_CCF_CX48        rm2fm2 rm1fm1 r0f20 r2p1
F1XAT_SubFlow             TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F1XAT_SubFlow             ARR_ATOM_CXX         rm2fm2 rm1fm1 r0f20 r2p1
F1XAT_SubFlow             SCN_ATOM_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F1XAT_SubFlow             FUN_ATOM_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F1XATCCF_SubFlow          TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F1XATCCF_SubFlow          FUN_ATOM_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F1XCR_SubFlow             TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F1XCR_SubFlow             ARR_CORE_CXX        rm2fm2 rm1fm1 r0f20 r2p1
F1XCR_SubFlow             SCN_CORE_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F1XCR_SubFlow             FUN_CORE_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F5XCCFLO_SubFlow          TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F5XCCFLO_SubFlow          ARR_CCF_CXX         rm2fm2 rm1fm1 r0f20 r2p1
F5XCCFLO_SubFlow          SCN_UNCORE_CX48     rm2fm2 rm1fm1 r0f20 r2p1
F5XCCFLO_SubFlow          FUN_CCF_CX48        rm2fm2 rm1fm1 r0f20 r2p1
F5XATLO_SubFlow           TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F5XATLO_SubFlow           ARR_ATOM_CXX        rm2fm2 rm1fm1 r0f20 r2p1
F5XATLO_SubFlow           SCN_ATOM_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F5XATLO_SubFlow             FUN_ATOM_CX48      rm2fm2 rm1fm1 r0f20 r2p1
F5XATCCFLO_SubFlow        TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F5XATCCFLO_SubFlow          FUN_ATOM_CX48      rm2fm2 rm1fm1 r0f20 r2p1
F5XCRLO_SubFlow           TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F5XCRLO_SubFlow           ARR_CORE_CXX        rm2fm2 rm1fm1 r0f20 r2p1
F5XCRLO_SubFlow           SCN_CORE_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F5XCRLO_SubFlow           FUN_CORE_CX48       rm2fm2 rm1fm1 r0f20 r2p1
...
F5XCR_SubFlow             FUN_CORE_CX48      rm2fm2 rm1fm1 r0f20 r2p1
...
VMAXXCR_SubFlow           FUN_CORE_CX48      rm2fm2 rm1fm1 r0f20 r2p1
...
F4XCR_SubFlow             FUN_CORE_CX48      rm2fm2 rm1fm1 r0f20 r2p1
...
VMAXXCCFLO_SubFlow        SCN_UNCORE_CX48     rm2fm2 rm1fm1 r0f20 r2p1
VMAXXCCFLO_SubFlow        FUN_CCF_CX48        rm2fm2 rm1fm1 r0f20 r2p1
VMAXXATLO_SubFlow         TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
VMAXXATLO_SubFlow         ARR_ATOM_CXX        rm2fm2 rm1fm1 r0f20 r2p1
VMAXXATLO_SubFlow         SCN_ATOM_CX48       rm2fm2 rm1fm1 r0f20 r2p1
VMAXXATLO_SubFlow           FUN_ATOM_CX48      rm2fm2 rm1fm1 r0f20 r2p1
VMAXXATCCFLO_SubFlow      TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
VMAXXATCCFLO_SubFlow        FUN_ATOM_CX48      rm2fm2 rm1fm1 r0f20 r2p1
VMAXXCRLO_SubFlow         TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
VMAXXCRLO_SubFlow         ARR_CORE_CXX        rm2fm2 rm1fm1 r0f20 r2p1
VMAXXCRLO_SubFlow         SCN_CORE_CX48      rm2fm2 rm1fm1 r0f20 r2p1
VMAXXCRLO_SubFlow         FUN_CORE_CX48      rm2fm2 rm1fm1 r0f20 r2p1

F3XCCF_SubFlow            TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F3XCCF_SubFlow            ARR_CCF_CXX         rm2fm2 rm1fm1 r0f20 r2p1
F3XCCF_SubFlow            SCN_UNCORE_CX48     rm2fm2 rm1fm1 r0f20 r2p1
F3XCCF_SubFlow            FUN_CCF_CX48        rm2fm2 rm1fm1 r0f20 r2p1
F3XAT_SubFlow             TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F3XAT_SubFlow             ARR_ATOM_CXX        rm2fm2 rm1fm1 r0f20 r2p1
F3XAT_SubFlow             SCN_ATOM_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F3XAT_SubFlow             FUN_ATOM_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F3XATCCF_SubFlow          TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F3XATCCF_SubFlow          FUN_ATOM_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F3XCR_SubFlow             TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F3XCR_SubFlow              ARR_CORE_CXX       rm2fm2 rm1fm1 r0f20 r2p1
F3XCR_SubFlow             SCN_CORE_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F3XCR_SubFlow             FUN_CORE_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F4XCCFLO_SubFlow          TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F4XCCFLO_SubFlow          ARR_CCF_CXX          rm2fm2 rm1fm1 r0f20 r2p1
F4XCCFLO_SubFlow          SCN_UNCORE_CX48      rm2fm2 rm1fm1 r0f20 r2p1
F4XCCFLO_SubFlow          FUN_CCF_CX48         rm2fm2 rm1fm1 r0f20 r2p1
F4XATLO_SubFlow           TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F4XATLO_SubFlow             ARR_ATOM_CXX      rm2fm2 rm1fm1 r0f20 r2p1
F4XATLO_SubFlow           SCN_ATOM_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F4XATLO_SubFlow             FUN_ATOM_CX48      rm2fm2 rm1fm1 r0f20 r2p1
F4XATCCFLO_SubFlow        TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}  
F4XATCCFLO_SubFlow          FUN_ATOM_CX48      rm2fm2 rm1fm1 r0f20 r2p1
F4XCRLO_SubFlow           TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F4XCRLO_SubFlow           ARR_CORE_CXX        rm2fm2 rm1fm1 r0f20 r2p1
F4XCRLO_SubFlow           SCN_CORE_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F4XCRLO_SubFlow           FUN_CORE_CX48       rm2fm2 rm1fm1 r0f20 r2p1

F2XCCF_SubFlow            TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F2XCCF_SubFlow            ARR_CCF_CXX          rm2fm2 rm1fm1 r0f20 r2p1
F2XCCF_SubFlow            SCN_UNCORE_CX48     rm2fm2 rm1fm1 r0f20 r2p1
F2XCCF_SubFlow            FUN_CCF_CX48        rm2fm2 rm1fm1 r0f20 r2p1
F2XAT_SubFlow             TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F2XAT_SubFlow             ARR_ATOM_CXX        rm2fm2 rm1fm1 r0f20 r2p1
F2XAT_SubFlow             SCN_ATOM_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F2XAT_SubFlow             FUN_ATOM_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F2XATCCF_SubFlow          TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F2XATCCF_SubFlow          FUN_ATOM_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F2XCR_SubFlow             TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
F2XCR_SubFlow             ARR_CORE_CXX        rm2fm2 rm1fm1 r0f20 r2p1
F2XCR_SubFlow             SCN_CORE_CX48       rm2fm2 rm1fm1 r0f20 r2p1
F2XCR_SubFlow             FUN_CORE_CX48       rm2fm2 rm1fm1 r0f20 r2p1
FMINXCCF_SubFlow          TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
FMINXCCF_SubFlow          ARR_CCF_CXX         rm2fm2 rm1fm1 r0f20 r2p1
FMINXCCF_SubFlow          SCN_UNCORE_CX48     rm2fm2 rm1fm1 r0f20 r2p1
FMINXCCF_SubFlow          FUN_CCF_CX48        rm2fm2 rm1fm1 r0f20 r2p1
FMINXAT_SubFlow           TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
FMINXAT_SubFlow           ARR_ATOM_CXX        rm2fm2 rm1fm1 r0f20 r2p1
FMINXAT_SubFlow           SCN_ATOM_CX48       rm2fm2 rm1fm1 r0f20 r2p1
FMINXAT_SubFlow           FUN_ATOM_CX48       rm2fm2 rm1fm1 r0f20 r2p1
FMINXATCCF_SubFlow        TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
FMINXATCCF_SubFlow        FUN_ATOM_CX48       rm2fm2 rm1fm1 r0f20 r2p1
FMINXCR_SubFlow           TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
FMINXCR_SubFlow           ARR_CORE_CXX	      rm2fm2 rm1fm1 r0f20 r2p1
FMINXCR_SubFlow           FUN_CORE_CX48       rm2fm2 rm1fm1 r0f20 r2p1
FMINXCR_SubFlow           SCN_CORE_CX48       rm2fm2 rm1fm1 r0f20 r2p1
...
ENDCPU_SubFlow            FUN_CCF_CX48      rm2fm2 rm1fm1 r0f20 r2p1
...
ENDCPUMAX_SubFlow         SCN_ATOM_CX48      rm2fm2 rm1fm1 r0f20 r2p1
...
LTTCCPU_SubFlow           PTH_BGR_CXPKGS7      {ipcflwflgs_stdports}
LTTCCPU_SubFlow           PTH_DTS_CX48      {ipcflwflgs_stdports}
LTTCCPU_SubFlow           PTH_DLVR_CX48      {ipcflwflgs_stdports}
LTTCCPU_SubFlow           ARR_ATOM_CXX          {ipcflwflgs_stdports}
LTTCCPU_SubFlow           FUN_ATOM_CX48      {ipcflwflgs_stdports}
LTTCCPU_SubFlow           ARR_CCF_CXX          {ipcflwflgs_stdports}
LTTCCPU_SubFlow           ARR_CORE_CXX      {ipc_stdports}
LTTCCPU_SubFlow           SCN_UNCORE_CX48     {ipcflwflgs_stdports}


LTTCCPUMAX_SubFlow           TPI_FLWFLGS_CXX      {ipcflwflgs_stdports}
LTTCCPUMAX_SubFlow           SCN_ATOM_CX48      {ipcflwflgs_stdports}
...
SPEEDPRL1CPU_SubFlow   PTH_DLVR_CXPKGS7     rm2fm2 rm1fm1 r0f20 r20f20
