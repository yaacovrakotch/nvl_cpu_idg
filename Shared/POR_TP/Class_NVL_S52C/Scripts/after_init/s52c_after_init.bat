...
%SSCEXEPATH%\SingleScriptCmd.exe setInstanceParam "IPH::PTH_DTS_HXPKGS7::DTS_X_SCREEN_K_STARTANA0HUB_X_X_X_X_DTSCALC" "BypassPort" 1
%SSCEXEPATH%\SingleScriptCmd.exe setInstanceParam "IPC::PTH_BGR_CXPKGS9::BGR_X_ANADC_K_STARTANA0CPU_X_X_X_X_BGR_ANAPRB_POST" "BypassPort" 1
