import sys
import os
sys.path.append('../../../POR_TP/Class_NVL_S52C/ProgramFlowsTestPlan')
try:
...
START_SubFlow                 TPI_SHOPS_XKPKGDT                                     rm2fm2 rm1fm1 r0f2 r2fm2
...
BEGIN_SubFlow                 MIO_D2D_XKPKGSB          rm2fm2 rm1fm1 r0f4
...
LTTCCOMMON_SubFlow            MIO_D2D_XKPKGSB          {flwflgs_stdports}
