import sys
import os
sys.path.append('../../../POR_TP/Class_NVL_S28CB/ProgramFlowsTestPlan')
try:
...
BEGIN_SubFlow                 MIO_D2D_XXX          rm2fm2 rm1fm1 r0f4
...
LTTCCOMMON_SubFlow            MIO_D2D_XXX          {flwflgs_stdports}
