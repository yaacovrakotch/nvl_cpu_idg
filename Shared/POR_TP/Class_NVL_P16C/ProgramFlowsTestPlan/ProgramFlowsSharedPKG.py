import sys
import os
sys.path.append('../../../POR_TP/Class_NVL_P16C/ProgramFlowsTestPlan')
try:
...
BEGIN_SubFlow                 MIO_D2D_XKPKGP          rm2fm2 rm1fm1 r0f4
...
LTTCCOMMON_SubFlow            MIO_D2D_XKPKGP          {flwflgs_stdports}
