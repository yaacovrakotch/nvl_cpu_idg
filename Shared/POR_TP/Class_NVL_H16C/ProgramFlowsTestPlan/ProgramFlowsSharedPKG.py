import sys
import os
sys.path.append('../../../POR_TP/Class_NVL_H16C/ProgramFlowsTestPlan')
try:
...
BEGIN_SubFlow                 MIO_D2D_XKPKGH          rm2fm2 rm1fm1 r0f4
...
LTTCCOMMON_SubFlow            MIO_D2D_XKPKGH          {flwflgs_stdports}
