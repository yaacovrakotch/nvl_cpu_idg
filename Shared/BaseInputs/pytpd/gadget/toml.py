...
JDR combined this into single file:
step1: Concat the following in order: tz.py encoder.py decoder.py ordered.py
step2: No need for __init__.y
step3: Move the imports to top
step4: remove python3 checks
"""
