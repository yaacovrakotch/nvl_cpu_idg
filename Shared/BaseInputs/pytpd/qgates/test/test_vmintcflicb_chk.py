...
"""
unittest for vmintcflicb_chk.py
...
from qgates.vmintcflicb_chk import *  # replace this with your checker py.
...
class TestVminTCFlicb(TestCase):

    def test_error189_a(self):
...
'''
            ...
            expect = [{'id': 189,
                       'message': 'Test:CA2TF_ATOM_VMAX_K_CATF6_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY_1501 '
                                  'missing/incorrect required data=CheckFlow(RING) on '
                                  'param=FlowIndexCallbackName; bypass=False',
                       'module': 'ARR'}]
            self.assertEqual(obj.result, expect)
            self.assertEqual(len(obj.passed), 0)
...
'''
            File('TPL/Modules/ARR/array.mtpl').touch(arr_mtpl, mkdir=True, newfile=True)
            tpobj = TestProgram(envfile).init()
            print("Running test_all_fail_189c...")
            obj = VminTCFICB(tpobj)
            obj.main()
            pprint(obj.result)
            expect = []
...
'''
            File('TPL/Modules/ARR/array.mtpl').touch(arr_mtpl, mkdir=True, newfile=True)
            tpobj = TestProgram(envfile).init()
            print("Running test_new_error2...")
            obj = VminTCFICB(tpobj)
            obj.main()
            pprint(obj.result)
            expect = [{'id': 189,
                       'message': 'Test:CA2TF_ATOM_VMAX_K_CATF6_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY_1501 '
                                  'missing/incorrect required data=CheckFlow(CORE) on '
                                  'param=FlowIndexCallbackName; bypass=False',
                       'module': 'ARR'},
                      {'id': 189,
                       'message': 'Test:CA2TF_ATOM_VMAX_K_CATF6_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY_1502 '
                                  'missing/incorrect required data=CheckFlow(ATOMC) on '
                                  'param=FlowIndexCallbackName; bypass=False',
                       'module': 'ARR'}]
            self.assertEqual(obj.result, expect)
            self.assertEqual(len(obj.passed), 0)

    def test_new_error4(self):
        with TempDir(name=True, chdir=True, delete=True) as tdir:
            tpref = f'{UT_DIR_REPO}/Simple7f'
            shutil.copytree(tpref, f'{tdir}/TPL')
            envfile = f'TPL/POR_TP/TGLH81/EnvironmentFile.env'
            ...
            Test  VminTC CA2TF_ATOM_VMAX_K_CATF6_Y_VATOM
            {
                    user_mode = "DEFAULT_MODE";
            }
            Test VminTC CA2TF_ATOM_VMAX_K_CATF6_X_VATOM_F5_3800_FUSA_VMXX_RECOVERY
            {
                BypassPort = -1;
                TestMode = "SingleVmin";
                LevelsTc = "IP_CPU_BASE::cpu_all_bf_x_x_ipcpu_lvl_stf400_min_lvl";
                ...
                FeatureSwitchSettings = "fivr_mode_on,print_per_target_increments,print_scoreboard_counters,per_pattern_printing";
                #FlowIndex = "1";
                VoltageTargets = "VCCGT";
                CornerIdentifiers = "GT0@F1";
                FlowIndexCallbackName = "CheckFlow(RING)";
            }
            ...
            DUTFlow MAIN1  {
                DUTFlowItem CA2TF_ATOM_VMAX_K_CATF6_X_VATOM_F5_3800_FUSA_VMXX_RECOVERY CA2TF_ATOM_VMAX_K_CATF6_X_VATOM_F5_3800_FUSA_VMXX_RECOVERY
                {
                    Result -2
                    {
                        Property PassFail = "Fail";
                    ...
                    DUTFlowItem SetFlowInfo_CA2TF_ATOM_VMAX_K_MAXAT_X_VATOM_F6_AT_F6_FREQ_FUSA_RECOVERY_P5_Flow1 SetFlowInfo_ATOMC_Flow1
                {
                    ...
                    DUTFlowItem ini1a CA2TF_ATOM_VMAX_K_CATF6_Y_VATOM
                {
                    Result -2
                    {
                        Property PassFail = "Fail";
            ...
            DUTFlow INIT1  {
                    DUTFlowItem ini1 CA2TF_ATOM_VMAX_K_CATF6_Y_VATOM {
                            Result 0 {
             SetBin SoftBins.b90757505_fail_some_softbin_SHARED_BIN;
                                    Return 0;
                            }
...
'''
            File('TPL/Modules/ARR/array.mtpl').touch(arr_mtpl, mkdir=True, newfile=True)
            tpobj = TestProgram(envfile).init()
            print("Running test_new_error4...")
            obj = VminTCFICB(tpobj)
            obj.main()
            pprint(obj.result)
            expect = [{'id': 189,
                       'message': 'Test:CA2TF_ATOM_VMAX_K_CATF6_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY_1502 '
                                  'missing/incorrect required data=CheckFlow(SOC) on '
                                  'param=FlowIndexCallbackName; bypass=False',
                       'module': 'ARR'}]
            self.assertEqual(obj.result, expect)
            self.assertEqual(len(obj.passed), 0)

    def test_new_error3(self):
        with TempDir(name=True, chdir=True, delete=True) as tdir:
            tpref = f'{UT_DIR_REPO}/Simple7f'
            shutil.copytree(tpref, f'{tdir}/TPL')
            envfile = f'TPL/POR_TP/TGLH81/EnvironmentFile.env'
...
'''
            File('TPL/Modules/ARR/array.mtpl').touch(arr_mtpl, mkdir=True, newfile=True)
            tpobj = TestProgram(envfile).init()
            print("Running test_new_error3...")
            obj = VminTCFICB(tpobj)
            obj.main()
            pprint(obj.result)
            expect = [{'id': 189,
                       'message': 'Test:CA2TF_ATOM_VMAX_K_CATF6_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY_1501 '
                                  'missing/incorrect required data=CheckFlow(GT) on '
                                  'param=FlowIndexCallbackName; bypass=False',
                       'module': 'ARR'},
                      {'id': 189,
                       'message': 'Test:CA2TF_ATOM_VMAX_K_CATF6_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY_1502 '
    ...
    def test_new_error(self):
        with TempDir(name=True, chdir=True, delete=True) as tdir:
            ...
            Test VminTC CA2TF_ATOM_VMAX_K_CATF6_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY
            {
                BypassPort = -1;
                TestMode = "SingleVmin";
                LevelsTc = "IP_CPU_BASE::cpu_all_bf_x_x_ipcpu_lvl_stf400_min_lvl";
            ...
            DUTFlow MAIN1  {
                DUTFlowItem CA2TF_ATOM_VMAX_K_CATF6_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY CA2TF_ATOM_VMAX_K_CATF6_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY
                {
                    Result -2
                    {
                        Property PassFail = "Fail";
...
'''
    ...
    def test_error_189_d(self):
        with TempDir(name=True, chdir=True, delete=True) as tdir:
            ...
            Test VminTC CA2TF_ATOM_VMAX_K_VICG_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY_1501
            {
                BypassPort = -1;
                TestMode = "SingleVmin";
                LevelsTc = "IP_CPU_BASE::cpu_all_bf_x_x_ipcpu_lvl_stf400_min_lvl";
            ...
            Test VminTC CA2TF_ATOM_VMAX_K_VICG_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY_1502
            {
                BypassPort = -1;
                TestMode = "SingleVmin";
                LevelsTc = "IP_CPU_BASE::cpu_all_bf_x_x_ipcpu_lvl_stf400_min_lvl";
            ...
            DUTFlow MAIN1  {
                DUTFlowItem CA2TF_ATOM_VMAX_K_VICG_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY_1501 CA2TF_ATOM_VMAX_K_VICG_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY_1501
                {
                    Result -2
                    {
                        Property PassFail = "Fail";
                    ...
                    Result 1
                    {
                        Property PassFail = "Pass";
                        #GoTo SetFlowInfo_CA2TF_ATOM_VMAX_K_MAXAT_X_VATOM_F6_AT_F6_FREQ_FUSA_RECOVERY_P5_Flow1;
                        GoTo CA2TF_ATOM_VMAX_K_VICG_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY_1502;
                    }
                    Result 2
                    {
                        Property PassFail = "Fail";
                ...
                DUTFlowItem CA2TF_ATOM_VMAX_K_VICG_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY_1502 CA2TF_ATOM_VMAX_K_VICG_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY_1502
                {
                    Result -2
                    {
                        Property PassFail = "Fail";
...
'''
            File('TPL/Modules/ARR/array.mtpl').touch(arr_mtpl, mkdir=True, newfile=True)
            tpobj = TestProgram(envfile).init()
            print("Running test_all_fail_189d...")
            obj = VminTCFICB(tpobj)
            obj.main()
            pprint(obj.result)
            expect = []
