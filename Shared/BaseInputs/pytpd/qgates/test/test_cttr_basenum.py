...
from qgates.cttr_basenum import *        # replace this with your checker py.
...
class TestInstName(TestCase):
    ...
    def test_fail_case_200_201(self):
...
'''
            ...
            obj = CttrBaseNum(tpobj)
            obj.main()
#           pprint(obj.result)
            expect = [{'id': 200,
                      'message': 'Base#:1207 in CHK '
                                 'test:CA2TF_ATOM_VMAX_K_CATF6_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY_1501 '
                                 'is not eq to 5 digits',
                       'module': 'ARR'},
                      {'id': 201,
                      'message': 'EdgeTick:None in CHK '
                                 'test:CA2TF_ATOM_VMAX_K_CATF6_X_VATOM_F5_3800_FUSA_VMAX_RECOVERY_1501 '
                                 'is not eq to 3',
                       'module': 'ARR'}]
