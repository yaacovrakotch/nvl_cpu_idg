...
from qgates.ipmin_lvl import *        # replace this with your checker py.
...
class TestInstName(TestCase):
    ...
    def test_fail_case_154_ipcpu_ippchlvl(self):
...
'''
            ...
            print("Running test_fail_case_154_ipcpu_ippchlvl...")
            obj = IPMinLvl(tpobj)
            obj.main()
            # pprint(obj.result)
            expect = [{'id': 154,
                       'message': 'IP_CPU '
                                  ...
                                  'subflow=CATF6 & '
                                  'lvl=IP_PCH_BASE::gcd_all_bf_x_x_ippch_lvl_min_lvl IP_ combo '
                                  'error. Not using IP_CPU levels',
                       'module': 'ARR'}]
