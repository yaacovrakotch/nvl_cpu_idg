...
from qgates.max_no_downbin import *        # replace this with your checker py.
...
class TestMaxNoDB(TestCase):
    ...
    def test_basic(self):
        ...
        expect = [{'id': 330,
                   'message': 'VMAX test '
                   'CA2TF_ATOM_VMAX_K_MAXAT_X_VATOM_F6_3800_FUSA_VMAX_RECOVERY_1501 '
                   'port0 is downbinning to '
                   'CA2TF_ATOM_VMAX_K_MAXAT_X_VATOM_F6_3800_FUSA_VMAX_RECOVERY_1502.  '
                   'VMAX Downbins are not allowed',
                   'module': 'ARR'},
                  {'id': 330,
                   'message': 'VMAX test '
                   'CA2TF_ATOM_VMAX_K_MAXAT_X_VATOM_F6_3800_FUSA_VMAX_RECOVERY_1501 '
                   'port2 is downbinning to '
                   'CA2TF_ATOM_VMAX_K_MAXAT_X_VATOM_F6_3800_FUSA_VMAX_RECOVERY_1502.  '
                   'VMAX Downbins are not allowed',
                   'module': 'ARR'},
                  {'id': 330,
    ...
    def test_mocked_case2(self):
        with TempDir(name=True, chdir=True, delete=True) as tdir:
            ...
            Test VminTC CA2TF_ATOM_VMAX_K_MAXAT_X_VATOM_F6_3800_FUSA_VMAX_RECOVERY_1501
            {
                BypassPort = -1;
            ...
            DUTFlow MAIN1  {
                DUTFlowItem CA2TF_ATOM_VMAX_K_MAXAT_X_VATOM_F6_3800_FUSA_VMAX_RECOVERY_1501 CA2TF_ATOM_VMAX_K_MAXAT_X_VATOM_F6_3800_FUSA_VMAX_RECOVERY_1501
                {
                    Result -2
                    {
...
'''
    ...
    def test_basic_FUN_CORE_MLC_AVX(self):
        tpobj = TestProgram(f'{UT_DIR_REPO}/Simple7a/POR_TP/TGLH81/EnvironmentFile.env').init()
        print("Running test_basic_FUN_CORE_MLC_AVX...")
        obj = MaxNoDownBin(tpobj)
        obj.main()
        pprint(obj.result)
    ...
    def test_mocked_case3(self):
        ...
        with TempDir(name=True, chdir=True, delete=True) as tdir:
            tpref = f'{UT_DIR_REPO}/Simple7a'
            shutil.copytree(tpref, f'{tdir}/TPL')
            envfile = f'TPL/POR_TP/TGLH81/EnvironmentFile.env'
            arr_mtpl = r'''{
            Version 1.0;
            ProgramStyle = Modular;
            TestPlan FUN_CORE_CXX;
            Import array.usrv;
            ...
            DUTFlow MAIN1  {
                DUTFlowItem CA2TF_ATOM_VMAX_K_MAXAT_X_VATOM_F6_3800_FUSA_VMAX_RECOVERY_1501 CA2TF_ATOM_VMAX_K_MAXAT_X_VATOM_F6_3800_FUSA_VMAX_RECOVERY_1501
                {
                    ...
                    Result 0
                    {
                        Property PassFail = "Fail";
                        IncrementCounters SCN_ATOM_CXX::n15010694_fail_CA2TF_ATOM_VMAX_K_MAXAT_X_VATOM_F6_FUSA_VMAX_RECOVERY_0;
                        GoTo CA2TF_ATOM_VMAX_K_MAXAT_X_VATOM_F6_3800_FUSA_VMAX_RECOVERY_1502;
                    }
                    Result 1
                    {
                        Property PassFail = "Pass";
...
'''
            File('TPL/Modules/FUN_CORE_CXX/FUN.mtpl').touch(arr_mtpl, mkdir=True, newfile=True)
            tpobj = TestProgram(envfile).init()
            # with MockVar(tpobj.mtpl, "iter_flows", Mock(return_value=data)):
            print("Running test_mocked_case3...")
            obj = MaxNoDownBin(tpobj)
            obj.main()
            # pprint(obj.result)
            expect = [{'id': 330,
