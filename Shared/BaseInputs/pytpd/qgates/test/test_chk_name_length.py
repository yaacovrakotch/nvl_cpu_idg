...
"""
Unittest for chk_name_length.py
...
from qgates.chk_name_length import *        # replace this with your checker py.
...
#       pprint(obj.result)
    ...
    def test_mocked_case2(self):
        with TempDir(name=True, chdir=True, delete=True) as tdir:
            ...
            Test VminTC CA2TF_ATOM_VMAX_Y_MAXAT_X_VATOM_V_3800_FUSA_VMAX_RECOVERYAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA_1501
            {
                BypassPort = -1;
            ...
            DUTFlow MAIN1  {
                DUTFlowItem CA2TF_ATOM_VMAX_Y_MAXAT_X_VATOM_V_3800_FUSA_VMAX_RECOVERYAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
                AAAAA_1501 CA2TF_ATOM_VMAX_Y_MAXAT_X_VATOM_V_3800_FUSA_VMAX_RECOVERY
                AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA_1501
                {
                    Result -2
                    {
...
'''
            ...
            expect = [{'id': 132,
                      'message': 'Test: '
                                 'ARR::CA2TF_ATOM_VMAX_Y_MAXAT_X_VATOM_V_3800_FUSA_VMAX_'
                                 'RECOVERYAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA_1501 '
                                 'length:106 is over the allowed limit:100 characters',
                       'module': 'ARR'}]
            self.assertEqual(obj.result, expect)
            self.assertEqual(len(obj.passed), 3)
