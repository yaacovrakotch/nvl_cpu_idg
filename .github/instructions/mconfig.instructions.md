...
# Commit
git add Modules/PTH*/.mconfig
git commit -m "Update pattern patch to p4 for all PTH modules"
```
...
# Commit
git add Modules/CLK*/.mconfig
git commit -m "Update pattern patch to p6 for all CLK modules"
```
...
# Commit
git add Modules/ARR*/.mconfig Modules/SIO*/.mconfig
git commit -m "Update pattern patch to p2 for ARR and SIO modules"
```
